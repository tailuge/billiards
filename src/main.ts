...
import {Color,PerspectiveCamera,DirectionalLight,Scene,
    CanvasTexture,MeshBasicMaterial,PlaneGeometry,Mesh,IcosahedronGeometry,
BufferAttribute,MeshPhongMaterial,WebGLRenderer} from "three"
/*
function component() {
...
*/
			...
			function init() {
				...
				const shadowMaterial = new MeshBasicMaterial( { map: shadowTexture, transparent: true } );
