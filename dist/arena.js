...
`];var Ve=916,We=n=>`v${Math.floor(n/100)}.${String(n%100).padStart(2,"0")}`;var pe=typeof localStorage<"u"&&localStorage.getItem("useProxy")==="true"?"nchanproxy.tailuge.workers.dev":"billiards-network.onrender.com",Ye=typeof window<"u"&&(window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1"),vt=Ye?`ws://${window.location.hostname}:80`:`wss://${pe}`;var J=typeof window<"u"&&window.location.hostname.includes("vercel");var yt=Ye?`http://${window.location.hostname}:8080/`:"https://billiards.tailuge.workers.dev/",xt=(n,e)=>e?Object.entries(e).reduce((t,[i,s])=>t+`&${encodeURIComponent(i)}=${encodeURIComponent(s)}`,n):n,qe=(n,e,t)=>{for(let[i,s]of Object.entries(n)){let r=e?`${e}.${encodeURIComponent(i)}`:encodeURIComponent(i);s&&typeof s=="object"&&!Array.isArray(s)?qe(s,r,t):s!=null&&t.push(`${r}=${encodeURIComponent(s)}`)}return t},Ge=(n,e,t)=>e&&typeof e=="object"?qe(e,t,[]).reduce((i,s)=>i+`&${s}`,n):n;var G=({tableId:n,userId:e,userName:t,ruleType:i,isFirst:s,options:r,bot:a,lod:l,flip:o,custom:h,opponent:u})=>{let c=`${yt}?websocketserver=${vt}&userName=${encodeURIComponent(t)}&userId=${e}&ruletype=${i}`;return a||(c+=`&tableId=${n}`),s&&(c+="&first=true"),a&&(c+=`&bot=${encodeURIComponent(a)}`),l!==void 0&&(c+=`&lod=${l}`),o&&(c+="&flip=true"),c=xt(c,r),c=Ge(c,h,"custom"),u?.userId&&(c+=`&opponent.userId=${encodeURIComponent(u.userId)}&opponent.userName=${encodeURIComponent(u.userName||"")}`,c=Ge(c,u.custom,"opponent.custom")),c};var _t={eightball:"eightball",snooker:"snooker",threecushion:"threecushion",nineball:"nineball",sagu:"sagu"},Qe=n=>{let e=_t[n];return e?d`<img src="assets/${e}.png" alt="${n}" title="${n}" width="18" height="18" style="vertical-align:middle">`:d`🎱`};var Ke=n=>{let e=(n||"user").slice(0,4),t=/Tauri/i.test(navigator.userAgent)?"-t-":"-";return e+t+Math.random().toString(36).slice(2,7)},ue=class extends EventTarget{constructor(){super();let e=new URLSearchParams(window.location.search),t=(e.get("userId")||"").trim(),i=(e.get("userName")||"").trim();J&&(localStorage.removeItem("userId"),localStorage.removeItem("userName"),localStorage.removeItem("custom"));let s=(localStorage.getItem("userId")||"").trim(),r=(localStorage.getItem("userName")||"").trim();if(t.length>2)this.clientId=t,this.isForcedId=!0;else if(window.self!==window.top&&(location.hostname==="localhost"||location.hostname==="127.0.0.1")&&window.name.includes("-"))this.clientId=window.name,this.isForcedId=!0,i||(this.userName=window.name.split("-")[0]);else{let l=i||r||"",o=!l||s.split("-")[0].slice(0,4)===l.slice(0,4);this.clientId=s.length>2&&!s.startsWith("user-")&&o?s:Ke(l),this.isForcedId=!1,this.clientId!==s&&localStorage.setItem("userId",this.clientId)}this.userName=i||this.userName||r||"Anonymous",this.lod=localStorage.getItem("lod")||"2",this.flip=localStorage.getItem("flip")==="true",this.useProxy=localStorage.getItem("useProxy")==="true";try{this.custom=JSON.parse(localStorage.getItem("custom"))||{}}catch{this.custom={}}window.addEventListener("storage",a=>{if(a.key==="custom"){try{this.custom=JSON.parse(a.newValue)||{}}catch{this.custom={}}this.dispatchEvent(new Event("change"))}}),console.log("UserStore identity:",this.userName,this.clientId)}setUseProxy(e){this.useProxy=!!e,localStorage.setItem("useProxy",this.useProxy),this.dispatchEvent(new Event("change")),window.location.reload()}set(e,t){this.clientId=e.trim().length>2?e.trim():Ke(t),this.userName=t.trim(),localStorage.setItem("userId",this.clientId),localStorage.setItem("userName",this.userName),this.dispatchEvent(new Event("change"))}setLod(e){this.lod=e,localStorage.setItem("lod",e),this.dispatchEvent(new Event("change"))}setFlip(e){this.flip=!!e,localStorage.setItem("flip",this.flip),this.dispatchEvent(new Event("change"))}getCustom(){return{...this.custom}}setCustom(e,t){this.custom={...this.custom,[e]:t},localStorage.setItem("custom",JSON.stringify(this.custom)),this.dispatchEvent(new Event("change"))}},p=new ue,V=class extends f{connectedCallback(){super.connectedCallback(),this._storeListener=()=>this.requestUpdate(),p.addEventListener("change",this._storeListener)}disconnectedCallback(){super.disconnectedCallback(),p.removeEventListener("change",this._storeListener)}};var wt=[[4352,4447],[11904,42191],[44032,55203],[63744,64255],[65040,65135],[65280,65376],[65504,65510],[127744,129791],[131072,195103]],Xe=n=>{let e=0;for(let t of n){let i=t.codePointAt(0);e+=wt.some(([s,r])=>i>=s&&i<=r)?2:1}return Math.max(e,1)},me=class extends V{static properties={_dotColor:{state:!0}};static styles=Je;constructor(){super(),this._clientId=p.clientId,this._name=p.userName,this._dotColor=p.isForcedId?"#9fca10ff":"#4caf50"}_commit(e){let t=e.trim().slice(0,12)||"Anonymous";this._name=t,p.set(this._clientId,t),this.dispatchEvent(new CustomEvent("user-name-changed",{bubbles:!0,composed:!0,detail:{userId:this._clientId,userName:t}}))}render(){return J?d``:d`
    ...
    `];constructor(){super(),this.standings=[],this.players=[],this.onlineUsers=[],this.expired=!1,this.countdown=""}render(){return d`
        ...
        `}};function $t(n){return["bot-thefarjaw","bot-clawbreak"].includes(n)}customElements.define("arena-leaderboard",fe);var tt=window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1"?"":"https://billiards-network.onrender.com",It=new Set(["bot-thefarjaw","bot-clawbreak"]),St={"bot-thefarjaw":"TheFarJaw","bot-clawbreak":"ClawBreak"},ve=n=>It.has(n),ye=10,Ct=5,it=2e3,xe=class extends f{static properties={arenaId:{type:String},theme:{type:String,reflect:!0},_arena:{state:!0},_leaderboard:{state:!0},_onlineUsers:{state:!0},_busy:{state:!0},_error:{state:!0},_pairingState:{state:!0},_pairingCountdown:{state:!0},_pairedName:{state:!0}};static styles=[w,P,g`
    ...
    `];constructor(){super(),this.arenaId="",this.theme=document.documentElement.getAttribute("theme")||localStorage.getItem("theme")||"dark",this._arena=null,this._leaderboard=[],this._onlineUsers=[],this._busy=!1,this._theme=this.theme,document.documentElement.setAttribute("theme",this._theme),document.documentElement.style.colorScheme=this._theme,this._presenceClient=null,this._lobby=null,this._error="",this._timer=null,this._staleRefetchDone=!1,this._lastLoadedArenaId=null,this._pairingState=null,this._pairingCountdown=ye,this._pairedName="",this._pairingInterval=null,this._pairingTimeout=null,this._pendingArenaChallenge=null}connectedCallback(){super.connectedCallback(),this._load(),this._connectPresence(),this._timer=setInterval(()=>{this._arena&&this.requestUpdate()},1e3)}disconnectedCallback(){this._timer&&(clearInterval(this._timer),this._timer=null),this._cancelPairing(),this._pendingArenaChallenge=null,this._lobby?.leave(),this._presenceClient?.stop(),super.disconnectedCallback()}_isExpired(){return!!(this._arena&&this._arena.endTime&&Date.now()>=this._arena.endTime)}get _localCustom(){let e=p.getCustom();return(e.emoji===void 0||e.emoji===null)&&this._onlineUsers.find(i=>i.userId===p.clientId)?.meta?.country==="BOT"?{...e,emoji:"\u{1F916}"}:e}_getCountdownText(){if(!this._arena||!this._arena.endTime)return"";let e=Math.max(0,this._arena.endTime-Date.now());if(e<=0||this._arena.status==="finished")return"00:00";let t=Math.floor(e/1e3),i=Math.floor(t/60),s=t%60;if(i>=60){let r=Math.floor(i/60),a=i%60;return`${String(r).padStart(2,"0")}:${String(a).padStart(2,"0")}:${String(s).padStart(2,"0")}`}return`${String(i).padStart(2,"0")}:${String(s).padStart(2,"0")}`}async _connectPresence(){let e=window.location.protocol==="https:"?"https:":"http:",t=window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1"?`${e}//${window.location.host}`:`https://${pe}`;this._presenceClient=new K({baseUrl:t}),this._presenceClient.setVersion(We(Ve));try{this._lobby=await this._presenceClient.joinLobby({messageType:"presence",type:"join",userId:p.clientId,userName:p.userName}),await this._syncArenaPresence(),this._lobby.onUsersChange(i=>{this._onlineUsers=[...i,{userId:p.clientId,userName:p.userName,custom:this._localCustom}],this._checkStaleArenaPresence()}),this._lobby.onChallenge(i=>{i.type==="offer"?this._handleIncomingChallenge(i):this._handleArenaChallengeMessage(i)})}catch(i){console.error("Arena presence connection failed:",i)}}async _handleIncomingChallenge(e){if(e.type!=="offer"||e.challengeeId!==p.clientId)return;let t=this._pairingState==="counting";if(this._cancelPairing(),!this._arena?.players?.some(s=>s.playerId===p.clientId&&s.active!==!1)||e.options?.tournamentId!==this.arenaId){t&&this.requestUpdate();return}await this._acceptArenaChallenge(e)}_handleArenaChallengeMessage(e){let t=this._pendingArenaChallenge;if(!t||e.challengerId!==p.clientId||e.challengeeId!==t.opponentId)return;if(e.type==="decline"||e.type==="cancel"){this._pendingArenaChallenge=null;return}if(e.type!=="accept")return;if(!t.tableId){t.earlyAccept=e;return}if(e.tableId!==t.tableId)return;this._pendingArenaChallenge=null;let i=e.ruleType||t.ruleType,s=e.options||t.options,r=e.nextTurnId?e.nextTurnId===p.clientId:!0,a=G({tableId:e.tableId,userId:p.clientId,userName:p.userName,ruleType:i,isFirst:r,options:s,lod:p.lod,flip:p.flip,custom:this._localCustom,opponent:{userId:t.opponentId,userName:t.opponentName,custom:t.opponentCustom}});window.location.href=a}async _acceptArenaChallenge(e){if(!this._lobby)return;let t=e.ruleType||this._arena?.ruleType||"nineball",i=e.options||this._arena?.options||{};try{await this._lobby.acceptChallenge(e.challengerId,t,e.tableId,i,e.challengerName,void 0,this._localCustom)}catch(a){console.error("Arena auto-accept failed:",a);return}let s=e.nextTurnId?e.nextTurnId===p.clientId:!1,r=G({tableId:e.tableId,userId:p.clientId,userName:p.userName,ruleType:t,isFirst:s,options:i,lod:p.lod,flip:p.flip,custom:this._localCustom,opponent:{userId:e.challengerId,userName:e.challengerName||"",custom:e.custom}});window.location.href=r}async _load(){this._busy=!0,this._error="";try{let e=await fetch(`${tt}/api/arena/${encodeURIComponent(this.arenaId)}`),t=await e.json();if(!e.ok)throw new Error(t.error||`Unable to load Arena (${e.status})`);this._arena=t.arena,this._leaderboard=t.leaderboard||[],this.arenaId!==this._lastLoadedArenaId&&(this._staleRefetchDone=!1,this._lastLoadedArenaId=this.arenaId),await this._syncArenaPresence(),this._checkStaleArenaPresence()}catch(e){this._error=e.message||"Unable to load Arena."}finally{this._busy=!1}}async _join(){await this._mutate("join",{playerId:p.clientId,name:p.userName||"Anonymous"})}async _leave(){this._cancelPairing(),await this._mutate("leave",{playerId:p.clientId})}async _syncArenaPresence(){if(!this._lobby||!this._arena)return;let e=this._arena.players?.find(t=>t.playerId===p.clientId);try{await this._lobby.updatePresence({arenaId:e?.active!==!1&&e?this.arenaId:void 0})}catch(t){console.error("Failed to update Arena presence:",t)}}_checkStaleArenaPresence(){if(!this._arena||!this._lobby)return;this._onlineUsers.some(t=>t.userId!==p.clientId&&t.arenaId===this.arenaId&&!this._arena.players?.some(i=>i.playerId===t.userId))&&this._refetchStaleArenaOnce()}_refetchStaleArenaOnce(){this._staleRefetchDone||this._busy||(this._staleRefetchDone=!0,this._load())}async _mutate(e,t){this._busy=!0,this._error="";try{let i=await fetch(`${tt}/api/arena/${encodeURIComponent(this.arenaId)}/${e}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}),s=await i.json();if(!i.ok)throw new Error(s.error||`${e} failed (${i.status})`);await this._load()}catch(i){this._error=i.message||`Unable to ${e} Arena.`,this._busy=!1}}_getPairingCandidates(){let e=p.clientId,t=[],i=[],s=[];for(let r of this._leaderboard){if(r.playerId===e)continue;let a=ve(r.playerId),l=this._arena?.players?.find(m=>m.playerId===r.playerId),o=this._onlineUsers.find(m=>m.userId===r.playerId),h=!a&&!!o?.tableId,u=l?.active!==!1&&(a||!!(o&&!h)),c={playerId:r.playerId,name:r.name,playing:h,bot:a,available:u};s.push(c),u&&(a?i.push(r):t.push(r))}return{candidates:t.length>0?t:i,diagnostics:s}}_findEligibleOpponents(){return this._getPairingCandidates().candidates}_startPairing(){this._pairingState!=="counting"&&(this._pairingState="counting",this._pairingCountdown=this._getPairingCandidates().candidates.some(e=>!ve(e.playerId))?Ct:ye,this._pairedName="",this._pairingInterval=setInterval(()=>this._onPairingTick(),1e3))}_cancelPairing(){this._pairingInterval&&(clearInterval(this._pairingInterval),this._pairingInterval=null),this._pairingTimeout&&(clearTimeout(this._pairingTimeout),this._pairingTimeout=null),this._pairingState=null,this._pairingCountdown=ye,this._pairedName=""}_onPairingTick(){let e=this._arena,t=p.clientId,i=e?.players?.some(r=>r.playerId===t&&r.active!==!1),s=e?.status==="active"&&Date.now()<(e?.endTime||0);if(!i||!s){this._cancelPairing();return}if(this._pairingCountdown-=1,this._pairingCountdown<=0){clearInterval(this._pairingInterval),this._pairingInterval=null,this._executePairing();return}this.requestUpdate()}async _executePairing(){let{candidates:e,diagnostics:t}=this._getPairingCandidates();if(e.length===0){console.log("[Arena pairing]",{candidates:t,choice:null}),this._pairingState="no-opponent",this._pairingTimeout=setTimeout(()=>this._cancelPairing(),it);return}let i=e[Math.floor(Math.random()*e.length)],s=t.find(r=>r.playerId===i.playerId);console.log("[Arena pairing]",{candidates:t,choice:s}),this._pairedName=i.name,this._pairingState="paired";try{await this._initiateChallenge(i)}catch(r){console.error("Pairing challenge failed:",r)}this._pairingTimeout=setTimeout(()=>this._cancelPairing(),it)}async _initiateChallenge(e){let t=this._arena,i=t?.ruleType||"nineball",s=t?.options||{},r=t?.id||"";if(ve(e.playerId)){let o=St[e.playerId]||e.name,h="arena-bot-"+Math.random().toString(36).slice(2,8),u=G({tableId:h,userId:p.clientId,userName:p.userName,ruleType:i,isFirst:!0,options:s,bot:o,lod:p.lod,custom:this._localCustom,opponent:{userId:e.playerId,userName:e.name,custom:e.custom},flip:p.flip});window.location.href=u+`&tournamentId=${encodeURIComponent(r)}`;return}if(!this._lobby){console.error("Pairing: no lobby connection");return}let a={...s,tournamentId:r},l={opponentId:e.playerId,opponentName:e.name,opponentCustom:e.custom||this._onlineUsers.find(o=>o.userId===e.playerId)?.custom,ruleType:i,options:a,tableId:null,earlyAccept:null};this._pendingArenaChallenge=l;try{let o=await this._lobby.challenge(e.playerId,i,a,void 0,this._localCustom);if(l.tableId=o,l.earlyAccept){let h=l.earlyAccept;l.earlyAccept=null,this._handleArenaChallengeMessage(h)}}catch(o){throw this._pendingArenaChallenge===l&&(this._pendingArenaChallenge=null),o}}_renderPairingOverlay(){return this._pairingState==="counting"?d`
                ...
                </div>`:null}render(){let e=this._arena,t=p.clientId,i=e?.players?.find(c=>c.playerId===t),s=!!i,r=i?.active!==!1,a=this._isExpired(),l=e?.status==="active"&&!a,o=s&&r&&l&&this._pairingState===null,h=this._pairingState!==null,u=this._renderPairingOverlay();return d`<div class="container">
  ...
  `;constructor(){super(),this.open=!1,this._game="threecushion",this._variant="15",this._size="full",this._freeaim=!1}show(){this.open=!0}hide(){this.open=!1}_selectGame(e){this._game=e;let t=this._currentGame;this._variant=t.variants[0].id}get _currentGame(){return _e.find(e=>e.key===this._game)||_e[0]}_confirm(){let e=this._currentGame,i={...(e.variants.find(s=>s.id===this._variant)||e.variants[0]).options};this._size==="mini"?i.tableSize=["snooker","nineball","eightball"].includes(e.key)?"6":"5":e.key==="snooker"&&(i.tableSize="12"),this._freeaim&&(i.freeaim="true"),this.dispatchEvent(new CustomEvent("confirm",{bubbles:!0,composed:!0,detail:{ruleType:e.key,options:i}})),this.hide()}render(){let e=this._currentGame;return d`<div class="backdrop" @click=${t=>t.target===t.currentTarget&&this.hide()}><div class="modal" role="dialog" aria-modal="true" aria-label="Select game parameters"><h3>Select game parameters</h3><div class="tiles" role="radiogroup" aria-label="Game type">${_e.map(t=>d`<button class="tile ${t.key===this._game?"selected":""}" @click=${()=>this._selectGame(t.key)}><img src=${t.img} alt="" /><span>${t.label}</span></button>`)}</div><div class="label">Rule</div><div class="choices">${e.variants.map(t=>d`<button class="choice ${t.id===this._variant?"selected":""}" @click=${()=>{this._variant=t.id}}>${t.label}</button>`)}</div><div class="label">Table size</div><div class="choices"><button class="choice ${this._size==="full"?"selected":""}" @click=${()=>{this._size="full"}}>Full</button><button class="choice ${this._size==="mini"?"selected":""}" @click=${()=>{this._size="mini"}}>Mini</button></div><div class="label">Aim</div><div class="choices"><button class="choice ${this._freeaim?"":"selected"}" @click=${()=>{this._freeaim=!1}}>Assist</button><button class="choice ${this._freeaim?"selected":""}" @click=${()=>{this._freeaim=!0}}>Free</button></div><button class="action" @click=${this._confirm}>Use these parameters</button><button class="cancel" @click=${this.hide}>Cancel</button></div></div>`}};customElements.define("proto2-modal",we);var $e=class extends f{static properties={ruleType:{type:String},options:{attribute:!1},durationMinutes:{type:Number},busy:{type:Boolean},error:{type:String}};static styles=g`
    ...
    `];constructor(){super(),this._theme=document.documentElement.getAttribute("theme")||localStorage.getItem("theme")||"dark",document.documentElement.setAttribute("theme",this._theme),document.documentElement.style.colorScheme=this._theme;let e=new URLSearchParams(window.location.search);this._id=e.get("id")||e.get("tournamentId")||"",this._ruleType="",this._options={},this._durationMinutes=10,this._createdArena=null,this._arenas=[],this._loadingArenas=!1,this._busy=!1,this._error=""}connectedCallback(){super.connectedCallback(),this._id||this._loadArenas()}async _loadArenas(){this._loadingArenas=!0;try{let e=await fetch(`${st}/api/arena`),t=await e.json();if(!e.ok)throw new Error(t.error||`Unable to load Arenas (${e.status})`);this._arenas=(t.arenas||[]).sort((i,s)=>s.createdAt-i.createdAt)}catch(e){this._error=e.message||"Unable to load Arenas."}finally{this._loadingArenas=!1}}async _create(){if(!this._ruleType){this._error="Choose game parameters first.";return}this._busy=!0,this._error="";try{let e=await fetch(`${st}/api/arena`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({creatorId:p.clientId,creatorName:p.userName||"Anonymous",ruleType:this._ruleType,options:this._options,durationMinutes:this._durationMinutes})}),t=await e.json();if(!e.ok)throw new Error(t.error||`Create failed (${e.status})`);this._createdArena=t.arena,await this._loadArenas()}catch(e){this._error=e.message||"Unable to create Arena."}finally{this._busy=!1}}_backToLobby(){window.location.href="./lobby.html"}_renderHeader(){return d`<header class="topbar">
        ...
        </div>`}};customElements.define("arena-app",Ie);})();
