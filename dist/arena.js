...
`,de=(i,e=!1,t=null,r=!0)=>{let o=`lobby.html?tournamentId=${encodeURIComponent(i.id)}`,n=s=>{t?(s.preventDefault(),s.stopPropagation(),t(i.id)):s.currentTarget instanceof HTMLButtonElement&&(s.preventDefault(),window.location.href=s.currentTarget.closest("a").href)};return a`<a class="arena-item ${e?"completed":""}" href=${o} @click=${n}>
        <div class="arena-item-main"><div class="arena-item-title"><span class="arena-item-name">${Fe(i.ruleType,i.options)}${i.creatorName?a` · ${i.creatorName}`:""}</span><span class="arena-item-meta"> 👥\uFE0E ${i.players.length} · ⏰\uFE0E ${e?"ended":"ends"} ${new Date(i.endTime).toLocaleTimeString([],{hour:"numeric",minute:"2-digit"})}</span></div></div>
