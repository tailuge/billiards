...
`];var Qe=931,Ke=n=>`v${Math.floor(n/100)}.${String(n%100).padStart(2,"0")}`;var z=typeof localStorage<"u"&&localStorage.getItem("useProxy")==="true"?"nchanproxy.tailuge.workers.dev":"billiards-network.onrender.com",Xe=typeof window<"u"&&(window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1"),me=Xe?`ws://${window.location.hostname}:80`:`wss://${z}`;var G=typeof window<"u"&&window.location.hostname.includes("vercel");var _t=Xe?`http://${window.location.hostname}:8080/`:"https://billiards.tailuge.workers.dev/",wt=(n,e)=>e?Object.entries(e).reduce((t,[i,s])=>t+`&${encodeURIComponent(i)}=${encodeURIComponent(s)}`,n):n,Ze=(n,e,t)=>{for(let[i,s]of Object.entries(n)){let r=e?`${e}.${encodeURIComponent(i)}`:encodeURIComponent(i);s&&typeof s=="object"&&!Array.isArray(s)?Ze(s,r,t):s!=null&&t.push(`${r}=${encodeURIComponent(s)}`)}return t},qe=(n,e,t)=>e&&typeof e=="object"?Ze(e,t,[]).reduce((i,s)=>i+`&${s}`,n):n;var V=({tableId:n,userId:e,userName:t,ruleType:i,isFirst:s,options:r,bot:a,lod:l,flip:o,custom:c,opponent:p})=>{let h=`${_t}?websocketserver=${me}&userName=${encodeURIComponent(t)}&userId=${e}&ruletype=${i}`;return a||(h+=`&tableId=${n}`),s&&(h+="&first=true"),a&&(h+=`&bot=${encodeURIComponent(a)}`),l!==void 0&&(h+=`&lod=${l}`),o&&(h+="&flip=true"),h=wt(h,r),h=qe(h,c,"custom"),p?.userId&&(h+=`&opponent.userId=${encodeURIComponent(p.userId)}&opponent.userName=${encodeURIComponent(p.userName||"")}`,h=qe(h,p.custom,"opponent.custom")),h};var $t={eightball:"eightball",snooker:"snooker",threecushion:"threecushion",nineball:"nineball",sagu:"sagu"},ge=n=>{let e=$t[n];return e?d`<img src="assets/${e}.png" alt="${n}" title="${n}" width="18" height="18" style="vertical-align:middle">`:d`🎱`},et=(n,e={})=>d`<span title="${n}">
    ...
    `];constructor(){super(),this.standings=[]}render(){let e=[this.standings[1],this.standings[0],this.standings[2]],t=["silver","gold","bronze"],i=["\u{1F948}","\u{1F947}","\u{1F949}"];return this.standings.length?d`<div class="podium" aria-label="Top three final standings">
        ...
        </div>`:d`<div class="empty">No final standings available.</div>`}};customElements.define("arena-podium",xe);var _e=class extends f{static properties={standings:{attribute:!1},players:{attribute:!1},onlineUsers:{attribute:!1},expired:{type:Boolean},countdown:{type:String}};static styles=[w,m`
        :host { display: block; }
    ...
    `];constructor(){super(),this.arenaId="",this.theme=document.documentElement.getAttribute("theme")||localStorage.getItem("theme")||"dark",this._arena=null,this._leaderboard=[],this._onlineUsers=[],this._busy=!1,this._theme=this.theme,document.documentElement.setAttribute("theme",this._theme),document.documentElement.style.colorScheme=this._theme,this._presenceClient=null,this._lobby=null,this._error="",this._timer=null,this._staleRefetchDone=!1,this._lastLoadedArenaId=null,this._pairingState=null,this._pairingCountdown=$e,this._pairedName="",this._pairingInterval=null,this._pairingTimeout=null,this._pendingArenaChallenge=null}connectedCallback(){super.connectedCallback(),this._load(),this._connectPresence(),this._timer=setInterval(()=>{this._arena&&this.requestUpdate()},1e3)}disconnectedCallback(){this._timer&&(clearInterval(this._timer),this._timer=null),this._cancelPairing(),this._pendingArenaChallenge=null,this._lobby?.leave(),this._presenceClient?.stop(),super.disconnectedCallback()}_isExpired(){return!!(this._arena&&this._arena.endTime&&Date.now()>=this._arena.endTime)}get _localCustom(){let e=u.getCustom();return(e.emoji===void 0||e.emoji===null)&&this._onlineUsers.find(i=>i.userId===u.clientId)?.meta?.country==="BOT"?{...e,emoji:"\u{1F916}"}:e}_getCountdownText(){if(!this._arena||!this._arena.endTime)return"";let e=Math.max(0,this._arena.endTime-Date.now());if(e<=0||this._arena.status==="finished")return"00:00";let t=Math.floor(e/1e3),i=Math.floor(t/60),s=t%60;if(i>=60){let r=Math.floor(i/60),a=i%60;return`${String(r).padStart(2,"0")}:${String(a).padStart(2,"0")}:${String(s).padStart(2,"0")}`}return`${String(i).padStart(2,"0")}:${String(s).padStart(2,"0")}`}async _connectPresence(){let e=window.location.protocol==="https:"?"https:":"http:",t=window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1"?`${e}//${window.location.host}`:`https://${z}`;this._presenceClient=new X({baseUrl:t}),this._presenceClient.setVersion(Ke(Qe));try{this._lobby=await this._presenceClient.joinLobby({messageType:"presence",type:"join",userId:u.clientId,userName:u.userName}),await this._syncArenaPresence(),this._lobby.onUsersChange(i=>{this._onlineUsers=[...i,{userId:u.clientId,userName:u.userName,custom:this._localCustom}],this._checkStaleArenaPresence()}),this._lobby.onChallenge(i=>{i.type==="offer"?this._handleIncomingChallenge(i):this._handleArenaChallengeMessage(i)})}catch(i){console.error("Arena presence connection failed:",i)}}async _handleIncomingChallenge(e){if(e.type!=="offer"||e.challengeeId!==u.clientId)return;let t=this._pairingState==="counting";if(this._cancelPairing(),!this._arena?.players?.some(s=>s.playerId===u.clientId&&s.active!==!1)||e.options?.tournamentId!==this.arenaId){t&&this.requestUpdate();return}await this._acceptArenaChallenge(e)}_handleArenaChallengeMessage(e){let t=this._pendingArenaChallenge;if(!t||e.challengerId!==u.clientId||e.challengeeId!==t.opponentId)return;if(e.type==="decline"||e.type==="cancel"){this._pendingArenaChallenge=null;return}if(e.type!=="accept")return;if(!t.tableId){t.earlyAccept=e;return}if(e.tableId!==t.tableId)return;this._pendingArenaChallenge=null;let i=e.ruleType||t.ruleType,s=e.options||t.options,r=e.nextTurnId?e.nextTurnId===u.clientId:!0,a=V({tableId:e.tableId,userId:u.clientId,userName:u.userName,ruleType:i,isFirst:r,options:s,lod:u.lod,flip:u.flip,custom:this._localCustom,opponent:{userId:t.opponentId,userName:t.opponentName,custom:t.opponentCustom}});window.location.href=a}async _acceptArenaChallenge(e){if(!this._lobby)return;let t=e.ruleType||this._arena?.ruleType||"nineball",i=e.options||this._arena?.options||{};try{await this._lobby.acceptChallenge(e.challengerId,t,e.tableId,i,e.challengerName,void 0,this._localCustom)}catch(a){console.error("Arena auto-accept failed:",a);return}let s=e.nextTurnId?e.nextTurnId===u.clientId:!1,r=V({tableId:e.tableId,userId:u.clientId,userName:u.userName,ruleType:t,isFirst:s,options:i,lod:u.lod,flip:u.flip,custom:this._localCustom,opponent:{userId:e.challengerId,userName:e.challengerName||"",custom:e.custom}});window.location.href=r}async _load(){this._busy=!0,this._error="";try{let e=await fetch(`${nt}/api/arena/${encodeURIComponent(this.arenaId)}`),t=await e.json();if(!e.ok)throw new Error(t.error||`Unable to load Arena (${e.status})`);this._arena=t.arena,this._leaderboard=t.leaderboard||[],this.arenaId!==this._lastLoadedArenaId&&(this._staleRefetchDone=!1,this._lastLoadedArenaId=this.arenaId),await this._syncArenaPresence(),this._checkStaleArenaPresence()}catch(e){this._error=e.message||"Unable to load Arena."}finally{this._busy=!1}}async _join(){let e=(u.userName||"").trim();if(/^(anonymous|anon)$/i.test(e)){window.alert("You must change name, Anonymous is not a valid arean name");return}await this._mutate("join",{playerId:u.clientId,name:e})}async _leave(){this._cancelPairing(),await this._mutate("leave",{playerId:u.clientId})}async _syncArenaPresence(){if(!this._lobby||!this._arena)return;let e=this._arena.players?.find(t=>t.playerId===u.clientId);try{await this._lobby.updatePresence({arenaId:e?.active!==!1&&e?this.arenaId:void 0})}catch(t){console.error("Failed to update Arena presence:",t)}}_checkStaleArenaPresence(){if(!this._arena||!this._lobby)return;this._onlineUsers.some(t=>t.userId!==u.clientId&&t.arenaId===this.arenaId&&!this._arena.players?.some(i=>i.playerId===t.userId))&&this._refetchStaleArenaOnce()}_refetchStaleArenaOnce(){this._staleRefetchDone||this._busy||(this._staleRefetchDone=!0,this._load())}async _mutate(e,t){this._busy=!0,this._error="";try{let i=await fetch(`${nt}/api/arena/${encodeURIComponent(this.arenaId)}/${e}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}),s=await i.json();if(!i.ok)throw new Error(s.error||`${e} failed (${i.status})`);await this._load()}catch(i){this._error=i.message||`Unable to ${e} Arena.`,this._busy=!1}}_getPairingCandidates(){let e=u.clientId,t=[],i=[],s=[];for(let r of this._leaderboard){if(r.playerId===e)continue;let a=we(r.playerId),l=this._arena?.players?.find(g=>g.playerId===r.playerId),o=this._onlineUsers.find(g=>g.userId===r.playerId),c=!a&&!!o?.tableId,p=l?.active!==!1&&(a||!!(o&&!c)),h={playerId:r.playerId,name:r.name,playing:c,bot:a,available:p};s.push(h),p&&(a?i.push(r):t.push(r))}return{candidates:t.length>0?t:i,diagnostics:s}}_findEligibleOpponents(){return this._getPairingCandidates().candidates}_startPairing(){this._pairingState!=="counting"&&(this._pairingState="counting",this._pairingCountdown=this._getPairingCandidates().candidates.some(e=>!we(e.playerId))?At:$e,this._pairedName="",this._pairingInterval=setInterval(()=>this._onPairingTick(),1e3))}_cancelPairing(){this._pairingInterval&&(clearInterval(this._pairingInterval),this._pairingInterval=null),this._pairingTimeout&&(clearTimeout(this._pairingTimeout),this._pairingTimeout=null),this._pairingState=null,this._pairingCountdown=$e,this._pairedName=""}_onPairingTick(){let e=this._arena,t=u.clientId,i=e?.players?.some(r=>r.playerId===t&&r.active!==!1),s=e?.status==="active"&&Date.now()<(e?.endTime||0);if(!i||!s){this._cancelPairing();return}if(this._pairingCountdown-=1,this._pairingCountdown<=0){clearInterval(this._pairingInterval),this._pairingInterval=null,this._executePairing();return}this.requestUpdate()}_getOpponentHistory(){if(!this.arenaId)return[];try{let e=localStorage.getItem(`arena_opponents_${this.arenaId}`);return e?JSON.parse(e):[]}catch{return[]}}_recordOpponentHistory(e){if(!(!this.arenaId||!e))try{let t=this._getOpponentHistory();t.push(e),t.length>10&&t.shift(),localStorage.setItem(`arena_opponents_${this.arenaId}`,JSON.stringify(t))}catch(t){console.error("Failed to save opponent history:",t)}}async _executePairing(){let{candidates:e,diagnostics:t}=this._getPairingCandidates();if(e.length===0){console.log("[Arena pairing]",{candidates:t,choice:null}),this._pairingState="no-opponent",this._pairingTimeout=setTimeout(()=>this._cancelPairing(),at);return}let i=this._getOpponentHistory(),s={};for(let c of i)s[c]=(s[c]||0)+1;let r=1/0;for(let c of e){let p=s[c.playerId]||0;p<r&&(r=p)}let a=e.filter(c=>(s[c.playerId]||0)===r),l=a[Math.floor(Math.random()*a.length)];this._recordOpponentHistory(l.playerId);let o=t.find(c=>c.playerId===l.playerId);console.log("[Arena pairing]",{candidates:t,choice:o}),this._pairedName=l.name,this._pairingState="paired";try{await this._initiateChallenge(l)}catch(c){console.error("Pairing challenge failed:",c)}this._pairingTimeout=setTimeout(()=>this._cancelPairing(),at)}async _initiateChallenge(e){let t=this._arena,i=t?.ruleType||"nineball",s=t?.options||{},r=t?.id||"";if(we(e.playerId)){let o=Tt[e.playerId]||e.name,c="arena-bot-"+Math.random().toString(36).slice(2,8),p=V({tableId:c,userId:u.clientId,userName:u.userName,ruleType:i,isFirst:!0,options:s,bot:o,lod:u.lod,custom:this._localCustom,opponent:{userId:e.playerId,userName:e.name,custom:e.custom},flip:u.flip});window.location.href=p+`&tournamentId=${encodeURIComponent(r)}`;return}if(!this._lobby){console.error("Pairing: no lobby connection");return}let a={...s,tournamentId:r},l={opponentId:e.playerId,opponentName:e.name,opponentCustom:e.custom||this._onlineUsers.find(o=>o.userId===e.playerId)?.custom,ruleType:i,options:a,tableId:null,earlyAccept:null};this._pendingArenaChallenge=l;try{let o=await this._lobby.challenge(e.playerId,i,a,void 0,this._localCustom);if(l.tableId=o,l.earlyAccept){let c=l.earlyAccept;l.earlyAccept=null,this._handleArenaChallengeMessage(c)}}catch(o){throw this._pendingArenaChallenge===l&&(this._pendingArenaChallenge=null),o}}_renderPairingOverlay(){return this._pairingState==="counting"?d`
                ...
                </div>`:null}render(){let e=this._arena,t=u.clientId,i=e?.players?.find(h=>h.playerId===t),s=!!i,r=i?.active!==!1,a=this._isExpired(),l=e?.status==="active"&&!a,o=s&&r&&l&&this._pairingState===null,c=this._pairingState!==null,p=this._renderPairingOverlay();return d`<div class="container">
  ...
  `;constructor(){super(),this.open=!1,this._game="threecushion",this._variant="15",this._size="full",this._freeaim=!1}show(){this.open=!0}hide(){this.open=!1}_selectGame(e){this._game=e;let t=this._currentGame;this._variant=t.variants[0].id}get _currentGame(){return Se.find(e=>e.key===this._game)||Se[0]}_confirm(){let e=this._currentGame,i={...(e.variants.find(s=>s.id===this._variant)||e.variants[0]).options};this._size==="mini"?i.tableSize=["snooker","nineball","eightball"].includes(e.key)?"6":"5":e.key==="snooker"&&(i.tableSize="12"),this._freeaim&&(i.freeaim="true"),this.dispatchEvent(new CustomEvent("confirm",{bubbles:!0,composed:!0,detail:{ruleType:e.key,options:i}})),this.hide()}render(){let e=this._currentGame;return d`<div class="backdrop" @click=${t=>t.target===t.currentTarget&&this.hide()}><div class="modal" role="dialog" aria-modal="true" aria-label="Select game parameters"><h3>Select game parameters</h3><div class="tiles" role="radiogroup" aria-label="Game type">${Se.map(t=>d`<button class="tile ${t.key===this._game?"selected":""}" @click=${()=>this._selectGame(t.key)}><img src=${t.img} alt="" /><span>${t.label}</span></button>`)}</div><div class="label">Rule</div><div class="choices">${e.variants.map(t=>d`<button class="choice ${t.id===this._variant?"selected":""}" @click=${()=>{this._variant=t.id}}>${t.label}</button>`)}</div><div class="label">Table size</div><div class="choices"><button class="choice ${this._size==="full"?"selected":""}" @click=${()=>{this._size="full"}}>Full</button><button class="choice ${this._size==="mini"?"selected":""}" @click=${()=>{this._size="mini"}}>Mini</button></div><div class="label">Aim</div><div class="choices"><button class="choice ${this._freeaim?"":"selected"}" @click=${()=>{this._freeaim=!1}}>Assist</button><button class="choice ${this._freeaim?"selected":""}" @click=${()=>{this._freeaim=!0}}>Free</button></div><button class="action" @click=${this._confirm}>Use these parameters</button><button class="cancel" @click=${this.hide}>Cancel</button></div></div>`}};customElements.define("proto2-modal",Ce);var Te=class extends f{static properties={ruleType:{type:String},options:{attribute:!1},durationMinutes:{type:Number},busy:{type:Boolean},error:{type:String}};static styles=m`
    ...
    `];constructor(){super(),this._theme=document.documentElement.getAttribute("theme")||localStorage.getItem("theme")||"dark",document.documentElement.setAttribute("theme",this._theme),document.documentElement.style.colorScheme=this._theme;let e=new URLSearchParams(window.location.search);this._id=e.get("id")||e.get("tournamentId")||"",this._ruleType="",this._options={},this._durationMinutes=10,this._createdArena=null,this._arenas=[],this._loadingArenas=!1,this._busy=!1,this._error="",this._hourlyArenaPeriod=null}connectedCallback(){super.connectedCallback(),this._id||this._loadArenas()}async _loadArenas(){this._loadingArenas=!0;try{let e=await fetch(`${Z}/api/arena`),t=await e.json();if(!e.ok)throw new Error(t.error||`Unable to load Arenas (${e.status})`);let i=new Date,s=i.getUTCMinutes(),r=`${i.getUTCFullYear()}-${i.getUTCMonth()}-${i.getUTCDate()}-${i.getUTCHours()}`,a=(t.arenas||[]).some(l=>l.endTime>i.getTime()&&l.status!=="finished");if(s>=30&&s<55&&!a&&this._hourlyArenaPeriod!==r){this._hourlyArenaPeriod=r;let l=[{ruleType:"threecushion",options:{raceTo:"7",tableSize:"5"}},{ruleType:"nineball",options:{tableSize:"6",freeaim:"true"}},{ruleType:"eightball",options:{tableSize:"6",freeaim:"true"}}],o=l[i.getUTCHours()%l.length];if(await fetch(`${Z}/api/arena`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({id:`arena-hourly-${i.getUTCFullYear()}${String(i.getUTCMonth()+1).padStart(2,"0")}${String(i.getUTCDate()).padStart(2,"0")}-${String(i.getUTCHours()).padStart(2,"0")}`,creatorId:"hourly-arena",creatorName:"Hourly Arena",...o,durationMinutes:30})}),e=await fetch(`${Z}/api/arena`),t=await e.json(),!e.ok)throw new Error(t.error||`Unable to reload Arenas (${e.status})`)}this._arenas=(t.arenas||[]).sort((l,o)=>o.createdAt-l.createdAt)}catch(e){this._error=e.message||"Unable to load Arenas."}finally{this._loadingArenas=!1}}async _create(){if(!this._ruleType){this._error="Choose game parameters first.";return}this._busy=!0,this._error="";try{let e=await fetch(`${Z}/api/arena`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({creatorId:u.clientId,creatorName:u.userName||"Anonymous",ruleType:this._ruleType,options:this._options,durationMinutes:this._durationMinutes})}),t=await e.json();if(!e.ok)throw new Error(t.error||`Create failed (${e.status})`);this._createdArena=t.arena,await this._loadArenas()}catch(e){this._error=e.message||"Unable to create Arena."}finally{this._busy=!1}}_backToLobby(){window.location.href="./lobby.html"}_renderHeader(){return d`<header class="topbar">
            ...
            ${e.map(i=>d`<a class="arena-item ${t?"completed":""}" href="${this._arenaUrlFor(i)}">
                <div class="arena-item-main"><div class="arena-item-title">${et(i.ruleType,i.options)}${i.creatorName?d` · ${i.creatorName}`:""} - ${i.players.length} participant${i.players.length===1?"":"s"} · ${t?"ended":"ends"} ${new Date(i.endTime).toLocaleTimeString([],{hour:"numeric",minute:"2-digit"})}</div></div>
            </a>`)}
