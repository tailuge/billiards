...
`];var Me=1063,Oe=i=>`v${Math.floor(i/100)}.${String(i%100).padStart(2,"0")}`;var lt=typeof localStorage<"u"&&localStorage.getItem("useProxy")==="true"?"nchanproxy.tailuge.workers.dev":"billiards-network.onrender.com",ne=typeof window<"u"&&(window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1"),Kt=ne?`ws://${window.location.hostname}:80`:`wss://${lt}`;var w=ne?"":"https://billiards-network.onrender.com",E=typeof window<"u"&&window.location.hostname.includes("vercel");var Jt=ne?`http://${window.location.hostname}:8080/`:"https://billiards.tailuge.workers.dev/";var ct={eightball:"eightball",snooker:"snooker",threecushion:"threecushion",nineball:"nineball",sagu:"sagu"},dt=i=>{let e=ct[i];return e?a`<img src="assets/${e}.png" alt="${i}" title="${i}" width="18" height="18" style="vertical-align:middle">`:a`🎱`},He=(i,e={})=>a`<span title="${i}">
