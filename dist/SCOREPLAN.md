...
*   **`src/controller/rules/nineball.ts`**: Contains game logic, including `isEndOfGame` to detect game end.
...
### Step 1: Define the `MatchResult` Type [DONE]
...
### Step 2: Create a Score Reporting Service [DONE]
...
This plan provides a more robust and extensib