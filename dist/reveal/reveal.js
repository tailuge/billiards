...
`];var xe=1116,we=r=>`v${Math.floor(r/100)}.${String(r%100).padStart(2,"0")}`;var P=typeof localStorage<"u"&&localStorage.getItem("useProxy")==="true"?"nchanproxy.tailuge.workers.dev":"billiards-network.onrender.com",ee=typeof window<"u"&&(window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1"),Et=ee?`ws://${window.location.hostname}:80`:`wss://${P}`;var it=ee?"":"https://billiards-network.onrender.com",T=typeof window<"u"&&window.location.hostname.includes("vercel");var st=r=>{if(r==="BOT")return{emoji:"\u{1F916}",title:"BOT"};if(!r)return{emoji:"\u{1F310}",title:""};let e=r.toUpperCase();return{emoji:[...e].map(i=>String.fromCodePoint(127397+i.charCodeAt(0))).join(""),title:e}},rt=ee?`http://${window.location.hostname}:8080/`:"https://billiards.tailuge.workers.dev/";var nt=(r,e,t)=>{for(let[i,s]of Object.entries(r)){let n=e?`${e}.${encodeURIComponent(i)}`:encodeURIComponent(i);s&&typeof s=="object"&&!Array.isArray(s)?nt(s,n,t):s!=null&&t.push(`${n}=${encodeURIComponent(s)}`)}return t},Ct=(r,e,t)=>e&&typeof e=="object"?nt(e,t,[]).reduce((i,s)=>i+`&${s}`,r):r;var ot=({imageUrl:r,userId:e,userName:t,lod:i,flip:s,rating:n,stars:o,custom:l})=>{let a=Math.min(1,Math.max(0,Number.isFinite(n)?n:0)),d=Math.max(1,Math.round(a*32)),h=o??Math.min(5,Math.max(1,Math.ceil(a*5))),c=`${rt}?ruletype=reveal&image=${encodeURIComponent(r)}&userId=${encodeURIComponent(e)}&userName=${encodeURIComponent(t)}&lod=${i}&reds=${d}`;return h===1?c+="&tableSize=6":h===2?c+="&tableSize=6&freeaim=true":h===5&&(c+="&freeaim=true"),ee&&(c+=`&lobbyUrl=${Et}`),s&&(c+="&flip=true"),c=Ct(c,l,"custom"),c},te=({imageUrl:r,state:e})=>{if(!e)return"";let t=`${rt}?ruletype=reveal&state=${encodeURIComponent(e)}`;return r&&(t+=`&image=${encodeURIComponent(r)}`),t};var at=r=>{let e=(r||"user").slice(0,4),t=/Tauri/i.test(navigator.userAgent)?"-t-":"-";return e+t+Math.random().toString(36).slice(2,7)},_e=class extends EventTarget{constructor(){super();let e=new URLSearchParams(window.location.search),t=(e.get("userId")||"").trim(),i=(e.get("userName")||"").trim();T&&(localStorage.removeItem("userId"),localStorage.removeItem("userName"),localStorage.removeItem("custom"));let s=(localStorage.getItem("userId")||"").trim(),n=(localStorage.getItem("userName")||"").trim();if(t.length>2)this.clientId=t,this.isForcedId=!0;else if(window.self!==window.top&&(location.hostname==="localhost"||location.hostname==="127.0.0.1")&&window.name.includes("-"))this.clientId=window.name,this.isForcedId=!0,i||(this.userName=window.name.split("-")[0]);else{let l=i||n||"",a=!l||s.split("-")[0].slice(0,4)===l.slice(0,4);this.clientId=s.length>2&&!s.startsWith("user-")&&a?s:at(l),this.isForcedId=!1,this.clientId!==s&&localStorage.setItem("userId",this.clientId)}this.userName=i||this.userName||n||"Anonymous",this.lod=localStorage.getItem("lod")||"4",this.flip=localStorage.getItem("flip")==="true",this.useProxy=localStorage.getItem("useProxy")==="true";try{this.custom=JSON.parse(localStorage.getItem("custom"))||{}}catch{this.custom={}}window.addEventListener("storage",o=>{if(o.key==="custom"){try{this.custom=JSON.parse(o.newValue)||{}}catch{this.custom={}}this.dispatchEvent(new Event("change"))}}),console.log("UserStore identity:",this.userName,this.clientId)}setUseProxy(e){this.useProxy=!!e,localStorage.setItem("useProxy",this.useProxy),this.dispatchEvent(new Event("change")),window.location.reload()}set(e,t){this.clientId=e.trim().length>2?e.trim():at(t),this.userName=t.trim(),localStorage.setItem("userId",this.clientId),localStorage.setItem("userName",this.userName),this.dispatchEvent(new Event("change"))}setLod(e){this.lod=e,localStorage.setItem("lod",e),this.dispatchEvent(new Event("change"))}setFlip(e){this.flip=!!e,localStorage.setItem("flip",this.flip),this.dispatchEvent(new Event("change"))}getCustom(){return{...this.custom}}setCustom(e,t){this.custom={...this.custom,[e]:t},localStorage.setItem("custom",JSON.stringify(this.custom)),this.dispatchEvent(new Event("change"))}},g=new _e,$=class extends y{connectedCallback(){super.connectedCallback(),this._storeListener=()=>this.requestUpdate(),g.addEventListener("change",this._storeListener)}disconnectedCallback(){super.disconnectedCallback(),g.removeEventListener("change",this._storeListener)}};var Pt=[[4352,4447,1],[11904,42191,1],[44032,55203,1],[63744,64255,1],[65040,65135,1],[65280,65376,1],[65504,65510,1],[127744,129791,1.25],[131072,195103,1]],lt=r=>{let e=0,t=0;for(let i of r){let s=i.codePointAt(0),n=Pt.find(([o,l])=>s>=o&&s<=l);n?t+=n[2]:e++}return!e&&!t&&(e=1),`calc(${e}ch + ${+t.toFixed(2)}em)`},ke=class extends ${static properties={_dotColor:{state:!0}};static styles=tt;constructor(){super(),this._clientId=g.clientId,this._name=g.userName,this._dotColor=g.isForcedId?"#9fca10ff":"#4caf50"}_commit(e){let t=e.trim().slice(0,12)||"Anonymous";this._name=t,g.set(this._clientId,t),this.dispatchEvent(new CustomEvent("user-name-changed",{bubbles:!0,composed:!0,detail:{userId:this._clientId,userName:t}}))}render(){return T?m``:m`
            ...
            </div>`}};customElements.define("user-badge",ke);var ie=null,Tt=()=>(ie||(ie=fetch(`${it}/api/arena/winners`).then(r=>r.ok?r.json():Promise.reject(new Error(String(r.status)))).then(r=>Array.isArray(r?.winners)?r.winners.filter(e=>e&&typeof e=="object"&&typeof e.userName=="string"):[]).catch(()=>(ie=null,null))),ie),$e=class extends ${static styles=f`
    ...
    `;constructor(){super(),this._trophies=[],this._trophyCheckedFor=null,this._winners=null,this._observer=null,this._idleTimer=null,this._started=!1}connectedCallback(){super.connectedCallback(),T||this._startLazy()}disconnectedCallback(){this._observer?.disconnect(),this._observer=null,this._idleTimer&&(clearTimeout(this._idleTimer),this._idleTimer=null),super.disconnectedCallback()}_startLazy(){this._started||(this._started=!0,typeof IntersectionObserver<"u"?(this._observer=new IntersectionObserver(e=>{e.some(t=>t.isIntersecting)&&(this._observer.disconnect(),this._observer=null,this._load())}),this._observer.observe(this)):this._whenIdle(()=>this._load()))}_whenIdle(e){typeof requestIdleCallback=="function"?requestIdleCallback(()=>e()):this._idleTimer=setTimeout(e,200)}async _load(){this._winners=await Tt(),this._recheck()}_recheck(){let e=(g.userName||"").trim();if(!e||!this._winners){this._trophies.length&&(this._trophies=[],this.requestUpdate());return}if(this._trophyCheckedFor===e)return;this._trophyCheckedFor=e;let t=this._winners.filter(i=>typeof i.userName=="string"&&i.userName.trim()===e);JSON.stringify(t)!==JSON.stringify(this._trophies)&&(this._trophies=t,this.requestUpdate())}willUpdate(){this._recheck()}render(){return T||!this._trophies.length?m``:m`
        ...
        `}};customElements.define("trophy-item",$e);var At=`https://${P}/api/stats`,Se=class extends y{static styles=f`
    ...
    `;connectedCallback(){super.connectedCallback(),fetch(At,{mode:"cors"}).then(e=>e.json()).then(e=>{this._data=e,this.requestUpdate()}).catch(()=>{this._err=!0,this.requestUpdate()})}_formatUptime(e){if(!e)return"";let t=[];return e.days&&t.push(`${e.days}d`),e.hours&&t.push(`${e.hours}h`),e.mins!==void 0&&t.push(`${e.mins}m`),t.join(" ")}_countryCounts(e){let t={};for(let i of Object.values(e)){let s=i.split("|")[0]||"XX";t[s]=(t[s]??0)+1}return Object.entries(t).sort((i,s)=>s[1]-i[1])}render(){if(this._err)return m`<span class="loading">Could not load stats.</span>`;if(!this._data)return m`<span class="loading">Loading…</span>`;let{uptime:e,ip_cache:t}=this._data,i=this._countryCounts(t??{});return m`
            ${e?m`<div class="uptime"><a href="https://billiards-network.onrender.com/dashboard.html" target="_blank" rel="noopener" style="text-decoration:none;color:inherit">⏱</a> ${this._formatUptime(e)}</div>`:""}
            <ul>
                ${i.map(([s,n])=>m`
                    <li>${st(s).emoji} <span>${s}</span> <span class="count">${n}</span></li>
                `)}
            </ul>`}};customElements.define("stats-panel",Se);var Ie=class r extends ${static properties={_open:{state:!0},_notifEnabled:{state:!0},_copied:{state:!0},_picker:{state:!0}};static LOD_LABELS=["pixelated","polygons","high poly","shaders","antialiased"];static styles=[Z,et,f`
                    ...
                    <div class="modal" role="dialog" aria-modal="true" aria-label="Settings">
                        ...
                        <div class="row">
                            <a href="#" @click=${e=>{e.preventDefault(),this._share()}}>
                                Share
                                ${this._copied?m`<span class="copied-badge">Copied!</span>`:""}
                            </a>
                        </div>
                ...
                ${this._picker?m`
                    <div class="picker-backdrop" @click=${e=>e.target===e.currentTarget&&(this._picker=null)}>
                        <div class="picker-frame">
                            ${this._picker==="cue"?m`<iframe src="./cue.html" title="Cue"></iframe>`:m`<iframe src="./wall.html?userName=${encodeURIComponent(g.userName)}" title="Wall"></iframe>`}
                        </div>
                    </div>
                `:""}`:""}
        `}};customElements.define("settings-modal",Ie);var se="reveal:collection",Me="reveal:removed",ht="reveal:deck",re=20,x=[{id:"kids",label:"K-idols",title:"K-Pot Idol",mode:"k-idols",dataId:"challenge-data"},{id:"pokemon",label:"Pokemon",title:"Pok\xE9pot",mode:"pokepot",dataId:"pokemon-data"}];function pt(r){return r.toLowerCase().replace(/[()]/g,"").replace(/[^a-z0-9]+/g,"-").replace(/^-|-$/g,"").slice(0,48)}function Ee(r="challenge-data"){let e=document.getElementById(r);return e?[...e.querySelectorAll("a[data-image]")].map(i=>{let s=i.textContent.trim(),n=i.getAttribute("data-image")||"",o=i.getAttribute("href")||"",l=Number.parseFloat(i.getAttribute("data-rating")||""),a=Number.isFinite(l)?Math.min(1,Math.max(0,l)):0;return{name:s,imageUrl:n.trim(),wikipediaUrl:o.trim(),rating:a,id:pt(s),pokeType:i.getAttribute("data-type")||void 0,pokeNature:i.getAttribute("data-nature")||void 0}}).filter(i=>i.imageUrl):[]}function Mt(r){return()=>{r|=0,r=r+1831565813|0;let e=Math.imul(r^r>>>15,1|r);return e=e+Math.imul(e^e>>>7,61|e)^e,((e^e>>>14)>>>0)/4294967296}}function Lt(r){let e=0;for(let t=0;t<r.length;t++)e=Math.imul(31,e)+r.charCodeAt(t)|0;return e>>>0}function Ce(r){if(!r.length)return r;let e=r.slice().sort((n,o)=>n.rating-o.rating),t=e.length,i=e.map((n,o)=>{let l=(o+1)/t,a=Math.max(1,Math.round(l*32)),d=Math.min(5,Math.max(1,Math.ceil(l*5)));return{...n,normRating:l,reds:a,stars:d,rankRating:l}}),s=Mt(Lt(r[0].imageUrl));for(let n=i.length-1;n>0;n--){let o=Math.floor(s()*(n+1));[i[n],i[o]]=[i[o],i[n]]}return i}function Pe(){try{let r=localStorage.getItem(se);if(!r)return[];let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch{return[]}}function Te(r){try{localStorage.setItem(se,JSON.stringify(r.slice(0,re)))}catch(e){if(e&&e.name==="QuotaExceededError"){console.log("reveal: localStorage quota exceeded, evicting oldest");try{r.pop(),localStorage.setItem(se,JSON.stringify(r.slice(0,re)))}catch{console.log("reveal: still over quota after eviction")}}else console.log("reveal: saveCollection failed",e)}}function Ut(){try{localStorage.removeItem(se),localStorage.removeItem(Me)}catch(r){console.log("reveal: clearCollection failed",r)}}function Rt(){try{let r=localStorage.getItem(Me);if(!r)return[];let e=JSON.parse(r);return Array.isArray(e)?e.filter(t=>typeof t=="string"):[]}catch{return[]}}function ct(r){try{localStorage.setItem(Me,JSON.stringify(r))}catch(e){console.log("reveal: saveRemovedIds failed",e)}}function Nt(){try{let r=localStorage.getItem(ht);return x.some(e=>e.id===r)?r:x[0].id}catch{return x[0].id}}function jt(r){try{localStorage.setItem(ht,r)}catch(e){console.log("reveal: saveDeckId failed",e)}}function Ot(){let r;try{r=new URLSearchParams(window.location.search).get("mode")}catch{return null}if(!r)return null;let e=r.trim().toLowerCase();return x.find(t=>t.mode===e)?.id??null}var zt={normal:"#9fa19f",fire:"#e62829",water:"#2980ef",electric:"#fac000",grass:"#3fa129",ice:"#3dcef3",fighting:"#ff8000",poison:"#9141cb",ground:"#915121",flying:"#81b9ef",psychic:"#ef4179",bug:"#91a119",rock:"#afa981",ghost:"#704170",dragon:"#5060e1",dark:"#624d4e",steel:"#60a1b8",fairy:"#ef70ef"};function dt(r,e=42,t=22){let i=Number.parseInt(r.replace("#",""),16),s=(i>>16&255)/255,n=(i>>8&255)/255,o=(i&255)/255,l=Math.max(s,n,o),a=l-Math.min(s,n,o),d=0;a&&(l===s?d=((n-o)/a+6)%6:l===n?d=(o-s)/a+2:d=(s-n)/a+4,d*=60);let h=Math.min(1,a/.35);return`${d.toFixed(1)} ${(e*h).toFixed(1)}% ${t}%`}async function Dt(r,{targetEdge:e=180,type:t=""}={}){let i=new Image;i.crossOrigin="anonymous";let n=await new Promise((b,R)=>{i.onload=()=>b(i),i.onerror=()=>R(new Error("image load failed")),i.src=r}),o=Math.max(n.naturalWidth,n.naturalHeight);if(!o)throw new Error("zero size image");let l=Math.min(1,e/o),a=Math.max(1,Math.round(n.naturalWidth*l)),d=Math.max(1,Math.round(n.naturalHeight*l)),h=document.createElement("canvas");h.width=a,h.height=d;let c=h.getContext("2d");if(!c)throw new Error("no 2d context");let u=zt[t];if(u){let b=c.createRadialGradient(a/2,d/2,0,a/2,d/2,Math.hypot(a,d)/2);b.addColorStop(0,`hsl(${dt(u)})`),b.addColorStop(1,`hsl(${dt(u,32,8)})`),c.fillStyle=b,c.fillRect(0,0,a,d)}c.drawImage(n,0,0,a,d);let p;try{p=h.toDataURL("image/webp",.6),p.startsWith("data:image/webp")||(p=h.toDataURL("image/jpeg",.7))}catch(b){throw console.log("reveal: thumb toDataURL failed (taint?)",b),b}return p}function A(r){return r.id||pt(r.name)}var Ae=class extends y{static properties={_theme:{type:String,reflect:!0,attribute:"theme"},_flippedId:{state:!0},_completedIds:{state:!0},_removedIds:{state:!0},_collection:{state:!0},_challenges:{state:!0},_deckId:{state:!0},_lobby:{state:!0},_connected:{state:!0}};static styles=[ye,Z,f`
      :host {
        display: block;
    ...
    `}render(){let e=new Map(this._collection.map(s=>[s.id,s])),t=!!document.getElementById(this._deck().dataId),i=this._challenges.filter(s=>!this._removedIds.has(A(s)));return m`
      <div class="container">
        <header class="topbar">
        ...
        <section class="panel" aria-labelledby="collection-heading">
          ...
          <div class="card-grid">
            ${i.length?i.map(s=>{let n=A(s),o=e.get(n);return this._renderCard(s,o)}):m`<p style="color:var(--text-muted);font-size:0.78rem">
          ...
          <div class="deck-footer">
            ...
            ${this._collection.length||this._removedIds.size?m`<button
                    class="reset-btn"
                    type="button"
