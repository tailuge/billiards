...
`];var xe=1158,we=r=>`v${Math.floor(r/100)}.${String(r%100).padStart(2,"0")}`,Tt="https://scoreboard-tailuge.vercel.app",T=typeof localStorage<"u"&&localStorage.getItem("useProxy")==="true"?"nchanproxy.tailuge.workers.dev":"billiards-network.onrender.com",te=typeof window<"u"&&(window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1"),At=te?`ws://${window.location.hostname}:80`:`wss://${T}`;var st=te?"":"https://billiards-network.onrender.com",A=typeof window<"u"&&window.location.hostname.includes("vercel");var rt=r=>{if(r==="BOT")return{emoji:"\u{1F916}",title:"BOT"};if(!r)return{emoji:"\u{1F310}",title:""};let e=r.toUpperCase();return{emoji:[...e].map(i=>String.fromCodePoint(127397+i.charCodeAt(0))).join(""),title:e}},nt=te?`http://${window.location.hostname}:8080/`:"https://billiards.tailuge.workers.dev/";var ot=(r,e,t)=>{for(let[i,s]of Object.entries(r)){let n=e?`${e}.${encodeURIComponent(i)}`:encodeURIComponent(i);s&&typeof s=="object"&&!Array.isArray(s)?ot(s,n,t):s!=null&&t.push(`${n}=${encodeURIComponent(s)}`)}return t},Mt=(r,e,t)=>e&&typeof e=="object"?ot(e,t,[]).reduce((i,s)=>i+`&${s}`,r):r;var at=({imageUrl:r,userId:e,userName:t,lod:i,flip:s,rating:n,stars:o,custom:l})=>{let a=Math.min(1,Math.max(0,Number.isFinite(n)?n:0)),d=Math.min(15,Math.max(1,Math.round(a*15))),h=o??Math.min(5,Math.max(1,Math.ceil(a*5))),c=`${nt}?ruletype=reveal&image=${encodeURIComponent(r)}&userId=${encodeURIComponent(e)}&userName=${encodeURIComponent(t)}&lod=${i}&reds=${d}`;return h===1?c+="&tableSize=6":h===2?c+="&tableSize=6&freeaim=true":h===5&&(c+="&freeaim=true"),te&&(c+=`&lobbyUrl=${At}`),s&&(c+="&flip=true"),c=Mt(c,l,"custom"),c},J=({imageUrl:r,state:e})=>{if(!e)return"";let t=`${nt}?ruletype=reveal&state=${encodeURIComponent(e)}`;return r&&(t+=`&image=${encodeURIComponent(r)}`),t},lt=(r,e=document.title)=>navigator.share&&/Android|iPhone|iPad|iPod/i.test(navigator.userAgent)?navigator.share({title:e,url:r}).then(()=>"shared").catch(()=>"dismissed"):navigator.clipboard.writeText(r).then(()=>"copied").catch(()=>"dismissed"),ct=async r=>{try{return(await(await fetch(`${Tt}/api/shorten`,{method:"POST",mode:"cors",headers:{"Content-Type":"application/json"},body:JSON.stringify({input:new URL(r).search})})).json()).shortUrl||r}catch(e){return console.error("reveal: could not shorten url",r,e),r}};var dt=r=>{let e=(r||"user").slice(0,4),t=/Tauri/i.test(navigator.userAgent)?"-t-":"-";return e+t+Math.random().toString(36).slice(2,7)},ke=()=>{let[r,...e]=(navigator.languages?.[0]||navigator.language||"en").split("-");return`Anon-${(e.find(s=>/^[A-Za-z]{2}$/.test(s))||r||"en").toUpperCase().slice(0,2)}`};var _e=class extends EventTarget{constructor(){super();let e=new URLSearchParams(window.location.search),t=(e.get("userId")||"").trim(),i=(e.get("userName")||"").trim();A&&(localStorage.removeItem("userId"),localStorage.removeItem("userName"),localStorage.removeItem("custom"));let s=(localStorage.getItem("userId")||"").trim(),n=(localStorage.getItem("userName")||"").trim();if(t.length>2)this.clientId=t,this.isForcedId=!0;else if(window.self!==window.top&&(location.hostname==="localhost"||location.hostname==="127.0.0.1")&&window.name.includes("-"))this.clientId=window.name,this.isForcedId=!0,i||(this.userName=window.name.split("-")[0]);else{let l=i||n||"",a=!l||s.split("-")[0].slice(0,4)===l.slice(0,4);this.clientId=s.length>2&&!s.startsWith("user-")&&a?s:dt(l),this.isForcedId=!1,this.clientId!==s&&localStorage.setItem("userId",this.clientId)}this.userName=i||this.userName||n||ke(),this.lod=localStorage.getItem("lod")||"4",this.flip=localStorage.getItem("flip")==="true",this.useProxy=localStorage.getItem("useProxy")==="true";try{this.custom=JSON.parse(localStorage.getItem("custom"))||{}}catch{this.custom={}}window.addEventListener("storage",o=>{if(o.key==="custom"){try{this.custom=JSON.parse(o.newValue)||{}}catch{this.custom={}}this.dispatchEvent(new Event("change"))}}),console.log("UserStore identity:",this.userName,this.clientId)}setUseProxy(e){this.useProxy=!!e,localStorage.setItem("useProxy",this.useProxy),this.dispatchEvent(new Event("change")),window.location.reload()}set(e,t){this.clientId=e.trim().length>2?e.trim():dt(t),this.userName=t.trim(),localStorage.setItem("userId",this.clientId),localStorage.setItem("userName",this.userName),this.dispatchEvent(new Event("change"))}setLod(e){this.lod=e,localStorage.setItem("lod",e),this.dispatchEvent(new Event("change"))}setFlip(e){this.flip=!!e,localStorage.setItem("flip",this.flip),this.dispatchEvent(new Event("change"))}getCustom(){return{...this.custom}}setCustom(e,t){this.custom={...this.custom,[e]:t},localStorage.setItem("custom",JSON.stringify(this.custom)),this.dispatchEvent(new Event("change"))}},g=new _e,$=class extends y{connectedCallback(){super.connectedCallback(),this._storeListener=()=>this.requestUpdate(),g.addEventListener("change",this._storeListener)}disconnectedCallback(){super.disconnectedCallback(),g.removeEventListener("change",this._storeListener)}};var Lt=[[4352,4447,1],[11904,42191,1],[44032,55203,1],[63744,64255,1],[65040,65135,1],[65280,65376,1],[65504,65510,1],[127744,129791,1.25],[131072,195103,1]],ht=r=>{let e=0,t=0;for(let i of r){let s=i.codePointAt(0),n=Lt.find(([o,l])=>s>=o&&s<=l);n?t+=n[2]:e++}return!e&&!t&&(e=1),`calc(${e}ch + ${+t.toFixed(2)}em)`},$e=class extends ${static properties={_dotColor:{state:!0}};static styles=it;constructor(){super(),this._clientId=g.clientId,this._name=g.userName,this._dotColor=g.isForcedId?"#9fca10ff":"#4caf50"}_commit(e){let t=e.trim().slice(0,12)||ke();this._name=t,g.set(this._clientId,t),this.dispatchEvent(new CustomEvent("user-name-changed",{bubbles:!0,composed:!0,detail:{userId:this._clientId,userName:t}}))}render(){return A?u``:u`
    ...
    `;constructor(){super(),this._trophies=[],this._trophyCheckedFor=null,this._winners=null,this._observer=null,this._idleTimer=null,this._started=!1}connectedCallback(){super.connectedCallback(),A||this._startLazy()}disconnectedCallback(){this._observer?.disconnect(),this._observer=null,this._idleTimer&&(clearTimeout(this._idleTimer),this._idleTimer=null),super.disconnectedCallback()}_startLazy(){this._started||(this._started=!0,typeof IntersectionObserver<"u"?(this._observer=new IntersectionObserver(e=>{e.some(t=>t.isIntersecting)&&(this._observer.disconnect(),this._observer=null,this._load())}),this._observer.observe(this)):this._whenIdle(()=>this._load()))}_whenIdle(e){typeof requestIdleCallback=="function"?requestIdleCallback(()=>e()):this._idleTimer=setTimeout(e,200)}async _load(){this._winners=await Ut(),this._recheck()}_recheck(){let e=(g.userName||"").trim();if(!e||!this._winners){this._trophies.length&&(this._trophies=[],this.requestUpdate());return}if(this._trophyCheckedFor===e)return;this._trophyCheckedFor=e;let t=this._winners.filter(i=>typeof i.userName=="string"&&i.userName.trim()===e);JSON.stringify(t)!==JSON.stringify(this._trophies)&&(this._trophies=t,this.requestUpdate())}willUpdate(){this._recheck()}render(){return A||!this._trophies.length?u``:u`
        ...
        `}};customElements.define("trophy-item",Se);var Rt=`https://${T}/api/stats`,Ie=class extends y{static styles=f`
    ...
    `;connectedCallback(){super.connectedCallback(),fetch(Rt,{mode:"cors"}).then(e=>e.json()).then(e=>{this._data=e,this.requestUpdate()}).catch(()=>{this._err=!0,this.requestUpdate()})}_formatUptime(e){if(!e)return"";let t=[];return e.days&&t.push(`${e.days}d`),e.hours&&t.push(`${e.hours}h`),e.mins!==void 0&&t.push(`${e.mins}m`),t.join(" ")}_countryCounts(e){let t={};for(let i of Object.values(e)){let s=i.split("|")[0]||"XX";t[s]=(t[s]??0)+1}return Object.entries(t).sort((i,s)=>s[1]-i[1])}render(){if(this._err)return u`<span class="loading">Could not load stats.</span>`;if(!this._data)return u`<span class="loading">Loading…</span>`;let{uptime:e,ip_cache:t}=this._data,i=this._countryCounts(t??{});return u`
            ...
            <ul>
                ...
                `)}
            </ul>`}};customElements.define("stats-panel",Ie);var Ce=class r extends ${static properties={_open:{state:!0},_notifEnabled:{state:!0},_copied:{state:!0},_picker:{state:!0}};static LOD_LABELS=["pixelated","polygons","high poly","shaders","antialiased"];static styles=[ee,tt,f`
    ...
    `];constructor(){super(),this._theme=document.documentElement.getAttribute("theme")||"dark",this._flippedId=null,this._completedIds=new Set,this._removedIds=new Set,this._collection=[],this._challenges=[],this._deckId=x[0].id,this._lobby=null,this._connected=!1,this._hasMessage=!1,this._pendingChats=[],this._popoverOpen=!1,this._client=null}connectedCallback(){super.connectedCallback();try{let e=localStorage.getItem("theme")||this._theme||"dark";this._theme=e,document.documentElement.setAttribute("theme",e),document.documentElement.style.colorScheme=e}catch{}this._deckId=Ft()??Dt(),this._challenges=Pe(Ee(this._deck().dataId)),this._collection=Te(),this._completedIds=new Set(this._collection.map(e=>e.id)),this._removedIds=new Set(zt()),this._onNameChanged=()=>this.requestUpdate(),document.addEventListener("user-name-changed",this._onNameChanged),this._onDocPointerDown=e=>this._handleDocPointerDown(e),document.addEventListener("pointerdown",this._onDocPointerDown),this._onDocKeyDown=e=>{e.key==="Escape"&&this._popoverOpen&&this._dismissPopover()},document.addEventListener("keydown",this._onDocKeyDown),this._connectPresence().catch(e=>console.error("reveal presence failed",e)),this._handleReturnParam().catch(e=>console.log("reveal: handleReturnParam error",e))}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("user-name-changed",this._onNameChanged),document.removeEventListener("pointerdown",this._onDocPointerDown),document.removeEventListener("keydown",this._onDocKeyDown);try{this._lobby?.leave()}catch{}try{this._client?.stop()}catch{}}_deck(){return x.find(e=>e.id===this._deckId)??x[0]}_setDeck(e){let t=x.find(s=>s.id===e)??x[0];Ht(t.id);let i=new URLSearchParams(window.location.search);i.set("mode",t.mode),this._replaceQuery(i.toString()),(t.id!==this._deckId||!this._challenges.length)&&(this._deckId=t.id,this._challenges=Pe(Ee(t.dataId)),this._flippedId=null),this.requestUpdate()}_matchChallenge(e){for(let t of x){let i=t.id===this._deckId&&this._challenges.length?this._challenges:Pe(Ee(t.dataId)),s=i.find(n=>n.imageUrl===e)||i.find(n=>decodeURIComponent(n.imageUrl)===e);if(s)return{ch:s,deck:t}}return null}async _connectPresence(){let t=`https://${typeof T<"u"&&T?T:"billiards-network.onrender.com"}`;(location.hostname==="localhost"||location.hostname==="127.0.0.1")&&(t=`${location.protocol==="https:"?"https:":"http:"}//${location.host}`);let i=new Z({baseUrl:t});i.setVersion(we(xe)),this._client=i;let s=await i.joinLobby({messageType:"presence",type:"join",userId:g.clientId,userName:g.userName});this._lobby=s,s.onChat(n=>this._onIncomingChat(n)),s.onChallenge(n=>{n.type==="offer"&&this._flagPendingMessage()}),this._connected=!0,this.requestUpdate(),this._presenceNameListener=n=>{let o=n.detail||{},l=o.userName||g.userName,a=o.userId||g.clientId;s.updatePresence({userId:a,userName:l}).catch(d=>console.error("reveal: updatePresence failed",d))},document.addEventListener("user-name-changed",this._presenceNameListener)}_flagPendingMessage(){this._hasMessage||(this._hasMessage=!0)}_onIncomingChat(e){if(!e?.text)return;let t=this._lobby?.getUsers?.().find(i=>i.userId===e.senderId)?.userName||e.senderId;this._pendingChats=[...this._pendingChats,{sender:t,text:e.text}].slice(-5),this._hasMessage=!0,this._popoverOpen=!0,this.requestUpdate()}_dismissPopover(){this._popoverOpen&&(this._popoverOpen=!1,this.requestUpdate())}_handleDocPointerDown(e){!this._popoverOpen||(e.composedPath?.()??[]).some(i=>i?.classList?.contains?.("chat-popover"))||this._dismissPopover()}async _handleReturnParam(){let e=new URLSearchParams(window.location.search),t=e.get("image");if(!t)return;this._stripReturnParams();let i;try{i=decodeURIComponent(t)}catch{i=t}let s=this._matchChallenge(i);if(!s){console.log("reveal: ?image= did not match any challenge, ignoring",i.slice(0,120));return}s.deck.id!==this._deckId&&this._setDeck(s.deck.id);let n=s.ch,o=S(n),l=e.get("state")||"";if(this._completedIds.has(o)){console.log("reveal: already completed",o);let c=Te(),m=c.findIndex(p=>p.id===o);if(m>=0){let[p]=c.splice(m,1);p.completedAt=Date.now(),l&&(p.state=l,p.replayUrl=J({imageUrl:p.imageUrl,state:l})),c.unshift(p),Ae(c),this._collection=c,this.requestUpdate()}return}let a="";try{a=await Jt(n.imageUrl,{type:n.pokeType})}catch(c){console.log("reveal: thumb generation failed, card stays unsolved",c);return}let d={id:o,name:n.name,imageUrl:n.imageUrl,wikipediaUrl:n.wikipediaUrl,thumb:a,completedAt:Date.now(),state:l,replayUrl:J({imageUrl:n.imageUrl,state:l})},h=Te();if(h.unshift(d),h.length>re&&(h.length=re),Ae(h),this._collection=h,this._completedIds=new Set(h.map(c=>c.id)),this._removedIds.has(o)){let c=new Set(this._removedIds);c.delete(o),pt([...c]),this._removedIds=c}this.requestUpdate()}_replaceQuery(e){history.replaceState(null,"",location.pathname+(e?`?${e}`:"")+location.hash)}_stripReturnParams(){let e=new URLSearchParams(window.location.search);!e.has("image")&&!e.has("state")||(e.delete("image"),e.delete("state"),this._replaceQuery(e.toString()))}_entryFor(e){let t=S(e);return this._collection.find(i=>i.id===t||i.imageUrl===e.imageUrl)}_replayUrlFor(e){return e?e.replayUrl||(e.state?J({imageUrl:e.imageUrl,state:e.state}):""):""}_onFlip(e){let t=S(e);this._flippedId=this._flippedId===t?null:t}_onPlay(e,t){e.stopPropagation();let i=at({imageUrl:t.imageUrl,userId:g.clientId,userName:g.userName,lod:g.lod,flip:g.flip,rating:t.normRating??t.rating,stars:t.stars,custom:g.getCustom()});window.location.href=i}async _onShare(e,t){e.stopPropagation();let i=this._entryFor(t)?.state;if(!i)return;let s=S(t);this._sharingId=s;let n=await ct(J({state:i}));this._sharingId=null,await lt(n)==="copied"&&(this._sharedId=s,setTimeout(()=>{this._sharedId=null},2e3))}_onReplay(e,t){e.stopPropagation();let i=this._replayUrlFor(this._entryFor(t));i&&window.open(i,"_blank","noopener")}_onResetClick(){let e=this._collection.length,t=this._removedIds.size;if(!e&&!t)return;let i=[];e&&i.push(`${e} revealed card${e===1?"":"s"}`),t&&i.push(`${t} deleted picture${t===1?"":"s"}`),window.confirm(`Reset deck? This clears ${i.join(" and ")}, setting every card back to unsolved.`)&&(Ot(),this._collection=[],this._completedIds=new Set,this._removedIds=new Set,this._flippedId=null,console.log("reveal: deck reset"),this.requestUpdate())}_onDelete(e,t){e.stopPropagation();let i=S(t),s=this._collection.filter(o=>o.id!==i);Ae(s),this._collection=s,this._completedIds=new Set(s.map(o=>o.id));let n=new Set(this._removedIds);n.add(i),pt([...n]),this._removedIds=n,this._flippedId===i&&(this._flippedId=null),console.log("reveal: deleted",i),this.requestUpdate()}_renderCard(e,t){let i=S(e),s=!!t,n=this._flippedId===i,o=["card",s?"completed":"",n?"is-flipped":""].filter(Boolean).join(" "),l=s&&!!this._replayUrlFor(t),a=e.stars,d=e.pokeNature?e.pokeNature.split(" ")[0]:"",h=[e.pokeType,d].filter(Boolean),c=h.length?`${h.join(" ")} \u2014 `:"",m=s?`${e.name} \u2014 completed, tap for actions`:`Mystery picture \u2014 ${c}play to reveal, ${a} star rating, tap to flip`;return u`
      <button
        class="${o}"
        role="button"
        aria-label="${m}"
      ...
      <div class="container">
        <header class="topbar">
          ...
          ${this._popoverOpen&&this._pendingChats.length?u`
                ...
                >
                  <ul>
                    ${this._pendingChats.map(s=>u`
                        <li>
                          <span class="chat-popover-sender"
                            >${s.sender}:</span
                          >
                          <span class="chat-popover-text">${s.text}</span>
                        </li>
                      `)}
                  </ul>
    ...
    `}};customElements.define("reveal-app",Me);})();
