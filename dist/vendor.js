...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:n.XIg,depthTest:!1,depthWrite:!1})}(a,e,i)}return a}_compileMaterial(e){let i=new n.eaF(this._lodPlanes[0],e);this._renderer.compile(i,x)}_sceneToCubeUV(e,i,r,a,s){let o=new n.ubm(90,1,i,r),l=[1,-1,1,1,1,1],c=[1,1,1,-1,-1,-1],h=this._renderer,u=h.autoClear,d=h.toneMapping;h.getClearColor(M),h.toneMapping=n.y_p,h.autoClear=!1,h.state.buffers.depth.getReversed()&&(h.setRenderTarget(a),h.clearDepth(),h.setRenderTarget(null));let p=new n.V9B({name:"PMREM.Background",side:n.hsX,depthWrite:!1,depthTest:!1}),f=new n.eaF(new n.iNn,p),m=!1,g=e.background;g?g.isColor&&(p.color.copy(g),e.background=null,m=!0):(p.color.copy(M),m=!0);for(let i=0;i<6;i++){let r=i%3;0===r?(o.up.set(0,l[i],0),o.position.set(s.x,s.y,s.z),o.lookAt(s.x+c[i],s.y,s.z)):1===r?(o.up.set(0,0,l[i]),o.position.set(s.x,s.y,s.z),o.lookAt(s.x,s.y+c[i],s.z)):(o.up.set(0,l[i],0),o.position.set(s.x,s.y,s.z),o.lookAt(s.x,s.y,s.z+c[i]));let n=this._cubeSize;D(a,r*n,i>2?n:0,n,n),h.setRenderTarget(a),m&&h.render(f,o),h.render(e,o)}f.geometry.dispose(),f.material.dispose(),h.toneMapping=d,h.autoClear=u,e.background=g}_textureToCubeUV(e,i){let r=this._renderer,a=e.mapping===n.hy7||e.mapping===n.xFO;a?(null===this._cubemapMaterial&&(this._cubemapMaterial=U()),this._cubemapMaterial.uniforms.flipEnvMap.value=!1===e.isRenderTargetTexture?-1:1):null===this._equirectMaterial&&(this._equirectMaterial=L());let s=a?this._cubemapMaterial:this._equirectMaterial,o=new n.eaF(this._lodPlanes[0],s);s.uniforms.envMap.value=e;let l=this._cubeSize;D(i,0,0,3*l,2*l),r.setRenderTarget(i),r.render(o,x)}_applyPMREM(e){let i=this._renderer,r=i.autoClear;i.autoClear=!1;let n=this._lodPlanes.length;for(let i=1;i<n;i++){let r=Math.sqrt(this._sigmas[i]*this._sigmas[i]-this._sigmas[i-1]*this._sigmas[i-1]),a=R[(n-i-1)%R.length];this._blur(e,i-1,i,r,a)}i.autoClear=r}_blur(e,i,r,n,a){let s=this._pingPongRenderTarget;this._halfBlur(e,s,i,r,n,"latitudinal",a),this._halfBlur(s,e,r,r,n,"longitudinal",a)}_halfBlur(e,i,r,a,s,o,l){let c=this._renderer,h=this._blurMaterial;"latitudinal"!==o&&"longitudinal"!==o&&console.error("blur direction must be either latitudinal or longitudinal!");let u=new n.eaF(this._lodPlanes[a],h),d=h.uniforms,p=this._sizeLods[r]-1,f=isFinite(s)?Math.PI/(2*p):2*Math.PI/39,m=s/f,g=isFinite(s)?1+Math.floor(3*m):20;g>20&&console.warn(`sigmaRadians, ${s}, is too large and will clip, as it requested ${g} samples when the maximum is set to 20`);let v=[],_=0;for(let e=0;e<20;++e){let i=e/m,r=Math.exp(-i*i/2);v.push(r),0===e?_+=r:e<g&&(_+=2*r)}for(let e=0;e<v.length;e++)v[e]=v[e]/_;d.envMap.value=e.texture,d.samples.value=g,d.weights.value=v,d.latitudinal.value="latitudinal"===o,l&&(d.poleAxis.value=l);let{_lodMax:y}=this;d.dTheta.value=f,d.mipInt.value=y-r;let M=this._sizeLods[a],b=4*(this._cubeSize-M);D(i,3*M*(a>y-4?a-y+4:0),b,3*M,2*M),c.setRenderTarget(i),c.render(u,x)}}function I(e,i,r){let a=new n.nWS(e,i,r);return a.texture.mapping=n.Om,a.texture.name="PMREM.cubeUv",a.scissorTest=!0,a}function D(e,i,r,n,a){e.viewport.set(i,r,n,a),e.scissor.set(i,r,n,a)}function L(){return new n.BKk({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:N(),fragmentShader:`
