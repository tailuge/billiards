...
`];var ge=1066,be=r=>`v${Math.floor(r/100)}.${String(r%100).padStart(2,"0")}`,j="https://scoreboard-tailuge.vercel.app",O=typeof localStorage<"u"&&localStorage.getItem("useProxy")==="true"?"nchanproxy.tailuge.workers.dev":"billiards-network.onrender.com",ee=typeof window<"u"&&(window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1"),te=ee?`ws://${window.location.hostname}:80`:`wss://${O}`,Wt=ee?"./active.html":"https://billiards-network.onrender.com/active.html",E=ee?"":"https://billiards-network.onrender.com",I=typeof window<"u"&&window.location.hostname.includes("vercel"),Kt=r=>{let e=Math.floor((Date.now()-r)/1e3);if(e<60)return`${e}s ago`;let t=Math.floor(e/60);if(t<60)return`${t}m ago`;let s=Math.floor(t/60);return s<24?`${s}h ago`:`${Math.floor(s/24)}d ago`},Qt={connected:!1,users:[],challenges:{},currentMatch:null};function Xt(r,e){let t={...r.challenges},s=i=>i.challengerId===e.myId?i.challengeeId:i.challengerId;switch(e.type){case"CONNECTED":return{...r,connected:e.payload};case"SETTLED":return{...r,settled:e.payload};case"USERS_UPDATE":return{...r,users:e.payload};case"CHALLENGE_SENT":return{...r,challenges:{...t,[e.payload.challengeeId]:{...e.payload,status:"pending"}}};case"CHALLENGE_MSG":{let i=e.payload,n=s(i);if(i.type==="offer"){if(r.currentMatch)return r;let a=t[i.challengerId];if(a&&a.challengerId===e.myId&&a.status==="pending"&&e.myId>i.challengerId)return r;(!t[i.challengerId]||t[i.challengerId].tableId!==i.tableId)&&(t[i.challengerId]={...i,status:"pending"})}else if(i.type==="accept"&&!r.currentMatch){let a=t[n];if(!a||a.tableId!==i.tableId)return r;let l=i.options||a.options,c=i.nextTurnId||a.nextTurnId,h=e.myId===i.challengerId,p=h?i.challengeeId:i.challengerId,d=h?i.custom||{}:a.custom||{},m=h?a.recipientName:a.challengerName;return delete t[n],{...r,challenges:t,currentMatch:{tableId:i.tableId,ruleType:i.ruleType,options:l,isFirst:c===i.challengerId||c===i.challengeeId?c===e.myId:i.challengerId===e.myId,opponentId:p,opponentName:m,opponentCustom:d}}}else i.type==="decline"?t[i.challengeeId]&&(t[i.challengeeId]={...t[i.challengeeId],status:"declined"}):i.type==="cancel"&&delete t[s(i)];return{...r,challenges:t}}case"CHALLENGE_DISMISS":return delete t[e.payload],{...r,challenges:t};default:return r}}function Je(r="",e="",t="",s={},i=void 0){let n={bot:{emoji:"\u{1F916}",title:"bot"},nineball:{emoji:"\u2468",title:"nineball"},eightball:{emoji:"\u{1F3B1}",title:"eightball"},snooker:{emoji:"\u{1F534}",title:"snooker"},threecushion:{emoji:"\u2462",title:"threecushion"},sagu:{emoji:"\u2463",title:"sagu"}},a=n[e],l=["5","6"].includes(String(s?.tableSize)),c=!!s?.freeaim,h=p=>{if(!l&&!c)return p;let d=p.emoji+(l?"\u{1F37C}":"")+(c?"\u2316":""),m=[l&&"mini",c&&"freeaim"].filter(Boolean).join(" ");return{emoji:d,title:m}};if(i)return{emoji:"\u2694\uFE0F",title:"arena"};if(t==="spectating")return{emoji:"\u{1F52D}",title:"spectator"};if(t==="playing")return h(a??{emoji:"\u{1F3AE}",title:"playing"});if(t==="available"&&e==="replay")return{emoji:"\u{1F440}",title:"replay"};if(a)return r.includes("veli")?h({emoji:"\u{1F393}",title:"study"}):r.includes("github")?h({emoji:a.emoji+"\u{1F419}",title:"github"}):r.includes("localhost")?h({emoji:a.emoji+"\u{1F3E0}",title:"localhost"}):h(a);if(e.includes("-bot")){let p=n[e.replace("-bot","")];if(p)return h({emoji:p.emoji+"\u{1F916}",title:"bot"})}if(e.includes("-exam")){let p=n[e.replace("-exam","")];if(p)return h({emoji:p.emoji+"\u{1F4DC}",title:"exam"})}if(e.includes("-speedrun")){let p=n[e.replace("-speedrun","")];if(p)return h({emoji:p.emoji+"\u{1F45F}",title:"speedrun"})}return r.startsWith("/")||r.includes("workers")?{emoji:"\u{1F464}",title:"vercel"}:r.includes("github")?{emoji:"\u{1F419}",title:"github"}:r.includes("vercel")?{emoji:"\u{1F465}",title:"vercel"}:r.includes("localhost")?{emoji:"\u{1F3E0}",title:"localhost"}:n[e]??{emoji:"\u{1F3AE}",title:"external"}}var w=r=>{if(r==="BOT")return{emoji:"\u{1F916}",title:"BOT"};if(!r)return{emoji:"\u{1F310}",title:""};let e=r.toUpperCase();return{emoji:[...e].map(s=>String.fromCodePoint(127397+s.charCodeAt(0))).join(""),title:e}},Ye=ee?`http://${window.location.hostname}:8080/`:"https://billiards.tailuge.workers.dev/",me=(r,e)=>e?Object.entries(e).reduce((t,[s,i])=>t+`&${encodeURIComponent(s)}=${encodeURIComponent(i)}`,r):r,Zt=(r,e,t)=>{for(let[s,i]of Object.entries(r)){let n=e?`${e}.${encodeURIComponent(s)}`:encodeURIComponent(s);i&&typeof i=="object"&&!Array.isArray(i)?Zt(i,n,t):i!=null&&t.push(`${n}=${encodeURIComponent(i)}`)}return t},Ge=(r,e,t)=>e&&typeof e=="object"?Zt(e,t,[]).reduce((s,i)=>s+`&${i}`,r):r,es=(r,e,t,s,i,n)=>{if(r.absolute)return r.url;let a=r.url?`${r.url}?userId=${encodeURIComponent(e)}&userName=${encodeURIComponent(t)}&lod=${s}`:`${Ye}?ruletype=${r.ruletype}&userId=${encodeURIComponent(e)}&userName=${encodeURIComponent(t)}&lod=${s}`;return ee&&(a+=`&lobbyUrl=${te}`),i&&(a+="&flip=true"),a=Ge(a,n,"custom"),r.url?a:me(a,r.options)},z=({tableId:r,userId:e,userName:t,ruleType:s,isFirst:i,options:n,localOptions:a,bot:l,lod:c,flip:h,custom:p,opponent:d})=>{let m=`${Ye}?websocketserver=${te}&userName=${encodeURIComponent(t)}&userId=${e}&ruletype=${s}`;return l||(m+=`&tableId=${r}`),i&&(m+="&first=true"),l&&(m+=`&bot=${encodeURIComponent(l)}`),c!==void 0&&(m+=`&lod=${c}`),h&&(m+="&flip=true"),m=me(m,n),m=me(m,a),m=Ge(m,p,"custom"),d?.userId&&(m+=`&opponent.userId=${encodeURIComponent(d.userId)}&opponent.userName=${encodeURIComponent(d.userName||"")}`,m=Ge(m,d.custom,"opponent.custom")),m},ts=({tableId:r,userId:e,userName:t,ruleType:s,options:i})=>{let n=`${Ye}?websocketserver=${te}&tableId=${r}&userName=${encodeURIComponent(t)}&userId=${e}&ruletype=${s}&spectator=true`;return me(n,i)},Ms={eightball:"eightball",snooker:"snooker",threecushion:"threecushion",nineball:"nineball",sagu:"sagu"},A=r=>{let e=Ms[r];return e?o`<img src="assets/${e}.png" alt="${r}" title="${r}" width="18" height="18" style="vertical-align:middle">`:o`🎱`},fe=(r,e={})=>o`<span title="${r}">
    ...
    </div>`}};customElements.define("solo-panel",Ke);var Qe=class extends f{static properties={url:{type:String},color:{type:String},label:{type:String},prefix:{type:String},prefixTitle:{type:String}};static styles=b`
        :host {
    ...
    `;constructor(){super(),this.msg=ns[Math.floor(Math.random()*ns.length)]}render(){return o`${rs(this.msg)}`}};customElements.define("motd-panel",tt);var st=class extends S{static styles=Yt;connectedCallback(){if(super.connectedCallback(),I){this.classList.add("loaded");return}let e=this._fontsReady(),t=()=>e.then(()=>{this.classList.add("loaded"),this.requestUpdate()});fetch(`${j}/api/summary`,{mode:"cors"}).then(s=>s.json()).then(s=>{this._data=s,t()}).catch(()=>{this._err=!0,t()})}_fontsReady(){let e=document.fonts;return e?.load?Promise.all([e.load("200 1rem 'Exo'"),e.load("600 1rem 'Exo'")]).catch(()=>{}):Promise.resolve()}render(){return I?o`<span class="loading">We have moved <a href="https://billiards.tailuge.workers.dev/lobby">Play online here</a></span>`:o`
            ...
            <tr><th>Name</th><th></th></tr>
                ${e[s].slice(0,4).map((i,n)=>o`<tr><td>${qe(n)} ${i.name}</td><td><replay-button url="${Ve(`${j}/api/rank/${i.id}?ruletype=${s}&lod=${u.lod}`,u.clientId,u.userName)}" label="${i.score}"></replay-button></td></tr>`)}
            </table></div>
...
<td class="replay-col">
                                    ${n.hasReplay?o`<replay-button prefix="${w(n.locationCountry).emoji}" prefixTitle="${w(n.locationCountry).title}" url="${Ve(`${j}/api/match-replay?id=${n.id}&lod=${u.lod}`,u.clientId,u.userName)}"></replay-button>`:w(n.locationCountry).emoji}
                                </td>
                            </tr>`)}
                        </table></div>
                    </div>
    ...
    `];constructor(){super(),this._messages=new Map,this._unread=new Map,this._lobbyBound=!1}willUpdate(e){e.has("lobby")&&this.lobby&&!this._lobbyBound&&(this._lobbyBound=!0,this.lobby.onChat(t=>{let s=t.senderId,i=[...this._messages.get(s)??[],t];if(this._messages=new Map(this._messages).set(s,i),s!==this.targetId){let n=(this._unread.get(s)??0)+1;this._unread=new Map(this._unread).set(s,n),Pe(this,"unread-changed",{userId:s,count:n})}this.requestUpdate()})),e.has("targetId")&&this.targetId&&this._unread.has(this.targetId)&&(this._unread=new Map(this._unread).set(this.targetId,0),Pe(this,"unread-changed",{userId:this.targetId,count:0}))}_send(e){e.preventDefault();let t=this.shadowRoot.querySelector("input"),s=t.value.trim();if(!s||!this.lobby||!this.targetId)return;this.lobby.sendChat(this.targetId,s);let n={messageType:"chat",senderId:this.lobby.currentUser.userId,recipientId:this.targetId,text:s},a=[...this._messages.get(this.targetId)??[],n];this._messages=new Map(this._messages).set(this.targetId,a),t.value="",this.requestUpdate()}updated(e){if(e.has("targetId")){let t=this.shadowRoot.querySelector(".thread");t&&(t.scrollTop=t.scrollHeight);let s=this.shadowRoot.querySelector("input");s&&s.focus()}else if(e.has("_messages")){let t=e.get("_messages");if(this._messages.get(this.targetId)!==t?.get(this.targetId)){let s=this.shadowRoot.querySelector(".thread");s&&(s.scrollTop=s.scrollHeight)}}}render(){if(!this.targetId)return o``;let e=this.lobby?.currentUser?.userId,t=this._messages.get(this.targetId)??[];return o`
            <div class="backdrop" @click=${s=>s.target===s.currentTarget&&Pe(this,"close")}>
                <div class="modal" role="dialog" aria-modal="true" aria-label="Chat with ${this.targetName}">
                    ...
                    <div class="thread">
                        ${t.length===0?o`<div class="empty">No messages yet</div>`:t.map(s=>o`<div class="msg ${s.senderId===e?"mine":"theirs"}">${Ws(s.text)}</div>`)}
                    </div>
            ...
            </div>`}};customElements.define("message-modal",at);var Ne=(r,e,t)=>r.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0})),Ks={raceTo:"Race to",reds:"Reds",shotClock:"Shot clock",collaboration:"Collaboration",practice:"Practice"},bs=(r,e)=>r?Object.entries(r).filter(([,t])=>!(typeof t=="boolean"&&t===!1)).map(([t,s])=>{if(t.startsWith("handicap_")){let n=t.slice(9),a=e&&n===e?"Your handicap":"Handicap";return typeof s=="boolean"?a:`${a}: ${s}`}let i=Ks[t]??t;return typeof s=="boolean"?i:`${i}: ${s}`}):[],ot=class extends f{static properties={challenge:{type:Object},sent:{type:Object},myId:{type:String}};static styles=[x,Bt,Ft];render(){return this.challenge?this._incoming(this.challenge):this.sent?this._sent(this.sent):o``}_incoming(e){let t={...e.options};if(Object.keys(t).some(i=>i.startsWith("handicap_"))){let i=localStorage.getItem(`handicap_${e.ruleType}`)||"15";t["handicap_"+this.myId]=i}let s=bs(t,this.myId);return o`
            <div class="banner">
            ...
            </div>`}};customElements.define("user-badge",dt);var Xs=`https://${O}/api/stats`,ht=class extends f{static styles=b`
    ...
    `];constructor(){super(),this._open=!1,this._showStats=!1,this._copied=!1,this._picker=null,this._theme=document.documentElement.getAttribute("theme")||"light",this._notifEnabled=typeof Notification<"u"&&Notification.permission==="granted",this._onKeydown=this._onKeydown.bind(this),this._onMessage=this._onMessage.bind(this)}connectedCallback(){super.connectedCallback(),window.addEventListener("keydown",this._onKeydown),window.addEventListener("message",this._onMessage)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this._onKeydown),window.removeEventListener("message",this._onMessage)}_onMessage(e){e.data?.type==="done"&&(this._picker=null)}_onKeydown(e){e.key==="Escape"&&(this._picker?this._picker=null:this._open&&this._close())}_toggle(e){e.stopPropagation(),this._open=!this._open}_close(){this._open=!1,this._picker=null}_setTheme(e){let t=e.target.checked?"dark":"light";this._theme=t,document.documentElement.setAttribute("theme",t),localStorage.setItem("theme",t),this.dispatchEvent(new CustomEvent("theme-changed",{detail:t,bubbles:!0,composed:!0}))}_share(){navigator.share&&/Android|iPhone|iPad|iPod/i.test(navigator.userAgent)?navigator.share({title:document.title,url:location.href}):navigator.clipboard.writeText(location.href).then(()=>{this._copied=!0,setTimeout(()=>{this._copied=!1},2e3)})}async _toggleNotifications(e){if(e.target.checked&&typeof Notification<"u"){let t=await Notification.requestPermission();this._notifEnabled=t==="granted"}else this._notifEnabled=!1;this.requestUpdate()}render(){return o`
            ...
            ${this._open?o`
                ...
                `:""}`:""}
        `}};customElements.define("settings-modal",pt);var Zs=3e4,ei=5,vs=1800*1e3,ti=r=>(Math.floor(r/vs)+1)*vs,xs=[{name:"Nine Ball Mini Hourly Arena",ruleType:"nineball",options:{tableSize:"6",freeaim:"true"}},{name:"Eight Ball Mini Hourly Arena",ruleType:"eightball",options:{tableSize:"6",freeaim:"true"}},{name:"Snooker Mini Hourly Arena",ruleType:"snooker",options:{tableSize:"6",reds:"3",freeaim:"true"}}],si=b`
...
`,ii=(r,e=!1,t=null,s=!0)=>{let i=`lobby.html?tournamentId=${encodeURIComponent(r.id)}`,n=a=>{t?(a.preventDefault(),a.stopPropagation(),t(r.id)):a.currentTarget instanceof HTMLButtonElement&&(a.preventDefault(),window.location.href=a.currentTarget.closest("a").href)};return o`<a class="arena-item ${e?"completed":""}" href=${i} @click=${n}>
    ...
    </a>`},ut=class extends f{static properties={heading:{type:String},_arenas:{state:!0},_error:{state:!0},selectable:{type:Boolean}};static styles=[si,b`
        :host { display: block; }
    ...
    `];constructor(){super(),this.standings=[],this.players=[],this.onlineUsers=[],this.expired=!1,this.countdown=""}render(){return o`
            ...
            ${this.standings.length?o`<div class="players-scroll"><table class="players">
                    ...
                    <tbody>${this.standings.map((e,t)=>{let s=this.players.find(n=>n.playerId===e.playerId),i=ri(e.playerId)?!0:this.onlineUsers.some(n=>n.userId===e.playerId);return o`<tr>
                            <td>#${t+1}</td>
                            <td>
        ...
        `}};function ri(r){return["bot-thefarjaw","bot-clawbreak"].includes(r)}customElements.define("arena-leaderboard",bt);var ni=new Set(["bot-thefarjaw","bot-clawbreak"]),ai={"bot-thefarjaw":"TheFarJaw","bot-clawbreak":"ClawBreak"},ft=r=>ni.has(r),yt=10,oi=5,_s=2e3,vt=class extends f{static properties={arenaId:{type:String},lobby:{type:Object},theme:{type:String,reflect:!0},_arena:{state:!0},_leaderboard:{state:!0},_onlineUsers:{state:!0},_busy:{state:!0},_error:{state:!0},_pairingState:{state:!0},_pairingCountdown:{state:!0},_pairedName:{state:!0},_berserk:{state:!0}};static styles=[Z,x,b`
