                ...
                <div class="group recent">
                    <div class="group-body">
                        ...
                        <tr><th>Rule</th><th>Match</th><th>Ago</th><th class="city-col">City</th><th></th></tr>
                            ${s.map(n=>c`<tr>
                                <td>${U(n.ruleType)}</td><td>${n.loser?n.tableSize!=null&&n.tableSize<10?"\u{1F37C}":"\u{1F396}\uFE0F":""}${n.freeaim===!0?"\u2316":""}${n.winner}${n.winnerScore!=null?c`<span class="score">(${n.winnerScore})</span>`:""}${n.loser?c` vs ${n.loser}${n.loserScore!=null?c`<span class="score">(${n.loserScore})</span>`:""}`:""}</td>
