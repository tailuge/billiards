...
`];var ue=973,me=n=>`v${Math.floor(n/100)}.${String(n%100).padStart(2,"0")}`,O="https://scoreboard-tailuge.vercel.app",z=typeof localStorage<"u"&&localStorage.getItem("useProxy")==="true"?"nchanproxy.tailuge.workers.dev":"billiards-network.onrender.com",Z=typeof window<"u"&&(window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1"),ee=Z?`ws://${window.location.hostname}:80`:`wss://${z}`,Dt=Z?"./active.html":"https://billiards-network.onrender.com/active.html",A=Z?"":"https://billiards-network.onrender.com",P=typeof window<"u"&&window.location.hostname.includes("vercel"),Bt=n=>{let e=Math.floor((Date.now()-n)/1e3);if(e<60)return`${e}s ago`;let t=Math.floor(e/60);if(t<60)return`${t}m ago`;let s=Math.floor(t/60);return s<24?`${s}h ago`:`${Math.floor(s/24)}d ago`},Ft={connected:!1,users:[],challenges:{},currentMatch:null};function Jt(n,e){let t={...n.challenges},s=i=>i.challengerId===e.myId?i.challengeeId:i.challengerId;switch(e.type){case"CONNECTED":return{...n,connected:e.payload};case"SETTLED":return{...n,settled:e.payload};case"USERS_UPDATE":return{...n,users:e.payload};case"CHALLENGE_SENT":return{...n,challenges:{...t,[e.payload.challengeeId]:{...e.payload,status:"pending"}}};case"CHALLENGE_MSG":{let i=e.payload,r=s(i);if(i.type==="offer"){if(n.currentMatch)return n;let a=t[i.challengerId];if(a&&a.challengerId===e.myId&&a.status==="pending"&&e.myId>i.challengerId)return n;(!t[i.challengerId]||t[i.challengerId].tableId!==i.tableId)&&(t[i.challengerId]={...i,status:"pending"})}else if(i.type==="accept"&&!n.currentMatch){let a=t[r];if(!a||a.tableId!==i.tableId)return n;let c=i.options||a.options,l=i.nextTurnId||a.nextTurnId,h=e.myId===i.challengerId,d=h?i.challengeeId:i.challengerId,p=h?i.custom||{}:a.custom||{},u=h?a.recipientName:a.challengerName;return delete t[r],{...n,challenges:t,currentMatch:{tableId:i.tableId,ruleType:i.ruleType,options:c,isFirst:l===i.challengerId||l===i.challengeeId?l===e.myId:i.challengerId===e.myId,opponentId:d,opponentName:u,opponentCustom:p}}}else i.type==="decline"?t[i.challengeeId]&&(t[i.challengeeId]={...t[i.challengeeId],status:"declined"}):i.type==="cancel"&&delete t[s(i)];return{...n,challenges:t}}case"CHALLENGE_DISMISS":return delete t[e.payload],{...n,challenges:t};default:return n}}function De(n="",e="",t="",s={},i=void 0){let r={bot:{emoji:"\u{1F916}",title:"bot"},nineball:{emoji:"\u2468",title:"nineball"},eightball:{emoji:"\u{1F3B1}",title:"eightball"},snooker:{emoji:"\u{1F534}",title:"snooker"},threecushion:{emoji:"\u2462",title:"threecushion"},sagu:{emoji:"\u2463",title:"sagu"}},a=r[e],c=["5","6"].includes(String(s?.tableSize)),l=!!s?.freeaim,h=d=>{if(!c&&!l)return d;let p=d.emoji+(c?"\u{1F37C}":"")+(l?"\u2316":""),u=[c&&"mini",l&&"freeaim"].filter(Boolean).join(" ");return{emoji:p,title:u}};if(i)return{emoji:"\u2694\uFE0F",title:"arena"};if(t==="spectating")return{emoji:"\u{1F52D}",title:"spectator"};if(t==="playing")return h(a??{emoji:"\u{1F3AE}",title:"playing"});if(t==="available"&&e==="replay")return{emoji:"\u{1F440}",title:"replay"};if(a)return n.includes("veli")?h({emoji:"\u{1F393}",title:"study"}):n.includes("github")?h({emoji:a.emoji+"\u{1F419}",title:"github"}):n.includes("localhost")?h({emoji:a.emoji+"\u{1F3E0}",title:"localhost"}):h(a);if(e.includes("-bot")){let d=r[e.replace("-bot","")];if(d)return h({emoji:d.emoji+"\u{1F916}",title:"bot"})}if(e.includes("-exam")){let d=r[e.replace("-exam","")];if(d)return h({emoji:d.emoji+"\u{1F4DC}",title:"exam"})}if(e.includes("-speedrun")){let d=r[e.replace("-speedrun","")];if(d)return h({emoji:d.emoji+"\u{1F45F}",title:"speedrun"})}return n.startsWith("/")||n.includes("workers")?{emoji:"\u{1F464}",title:"vercel"}:n.includes("github")?{emoji:"\u{1F419}",title:"github"}:n.includes("vercel")?{emoji:"\u{1F465}",title:"vercel"}:n.includes("localhost")?{emoji:"\u{1F3E0}",title:"localhost"}:r[e]??{emoji:"\u{1F3AE}",title:"external"}}var w=n=>{if(n==="BOT")return{emoji:"\u{1F916}",title:"BOT"};if(!n)return{emoji:"\u{1F310}",title:""};let e=n.toUpperCase();return{emoji:[...e].map(s=>String.fromCodePoint(127397+s.charCodeAt(0))).join(""),title:e}},Be=Z?`http://${window.location.hostname}:8080/`:"https://billiards.tailuge.workers.dev/",pe=(n,e)=>e?Object.entries(e).reduce((t,[s,i])=>t+`&${encodeURIComponent(s)}=${encodeURIComponent(i)}`,n):n,Gt=(n,e,t)=>{for(let[s,i]of Object.entries(n)){let r=e?`${e}.${encodeURIComponent(s)}`:encodeURIComponent(s);i&&typeof i=="object"&&!Array.isArray(i)?Gt(i,r,t):i!=null&&t.push(`${r}=${encodeURIComponent(i)}`)}return t},He=(n,e,t)=>e&&typeof e=="object"?Gt(e,t,[]).reduce((s,i)=>s+`&${i}`,n):n,Yt=(n,e,t,s,i,r)=>{if(n.absolute)return n.url;let a=n.url?`${n.url}?userId=${encodeURIComponent(e)}&userName=${encodeURIComponent(t)}&lod=${s}`:`${Be}?ruletype=${n.ruletype}&userId=${encodeURIComponent(e)}&userName=${encodeURIComponent(t)}&lod=${s}`;return Z&&(a+=`&lobbyUrl=${ee}`),i&&(a+="&flip=true"),a=He(a,r,"custom"),n.url?a:pe(a,n.options)},H=({tableId:n,userId:e,userName:t,ruleType:s,isFirst:i,options:r,localOptions:a,bot:c,lod:l,flip:h,custom:d,opponent:p})=>{let u=`${Be}?websocketserver=${ee}&userName=${encodeURIComponent(t)}&userId=${e}&ruletype=${s}`;return c||(u+=`&tableId=${n}`),i&&(u+="&first=true"),c&&(u+=`&bot=${encodeURIComponent(c)}`),l!==void 0&&(u+=`&lod=${l}`),h&&(u+="&flip=true"),u=pe(u,r),u=pe(u,a),u=He(u,d,"custom"),p?.userId&&(u+=`&opponent.userId=${encodeURIComponent(p.userId)}&opponent.userName=${encodeURIComponent(p.userName||"")}`,u=He(u,p.custom,"opponent.custom")),u},Vt=({tableId:n,userId:e,userName:t,ruleType:s,options:i})=>{let r=`${Be}?websocketserver=${ee}&tableId=${n}&userName=${encodeURIComponent(t)}&userId=${e}&ruletype=${s}&spectator=true`;return pe(r,i)},Ss={eightball:"eightball",snooker:"snooker",threecushion:"threecushion",nineball:"nineball",sagu:"sagu"},I=n=>{let e=Ss[n];return e?o`<img src="assets/${e}.png" alt="${n}" title="${n}" width="18" height="18" style="vertical-align:middle">`:o`🎱`},ge=(n,e={})=>o`<span title="${n}">
    ...
    `;render(){let e=this.color?`background-color: ${this.color}`:"",t=this.prefix?o`<span class="prefix" title=${this.prefixTitle}>${this.prefix}</span>`:"";return o`
        ...
        `}};customElements.define("replay-button",Ve);var qe=class extends S{static styles=Ot;connectedCallback(){if(super.connectedCallback(),P){this.classList.add("loaded");return}fetch(`${O}/api/summary`,{mode:"cors"}).then(e=>e.json()).then(e=>{this._data=e,this.classList.add("loaded"),this.requestUpdate()}).catch(()=>{this._err=!0,this.classList.add("loaded"),this.requestUpdate()})}render(){if(P)return o`<span class="loading">We have moved <a href="https://billiards.tailuge.workers.dev/lobby">Play online here</a></span>`;if(this._err)return o`<span class="loading">Could not load scores.</span>`;if(!this._data)return o`<span class="loading">Connecting to server…</span>`;let{hiscores:e,topPlayers:t,recentMatches:s}=this._data,i=Object.keys(e);return o`
            <div class="group hiscores">
                <div class="group-body">
                    ${i.map(r=>o`
                        <div class="tbl${r==="sagu"?" sagu-hi":""}"><table><caption><a href="${O}/leaderboard" target="_blank" rel="noopener" style="font-weight:200;font-size:0.75rem">${I(r)} HiScore</a></caption>
...
<td class="replay-col">
                ...
                <div class="group top-players">
                    <div class="group-body">
                        ${i.map(r=>o`
                            <div class="tbl"><table><caption><a href="${O}/elo" target="_blank" rel="noopener">${I(r)} <span style="font-size:0.75rem;font-weight:200">Rankings</span></a></caption>
    ...
    `;connectedCallback(){super.connectedCallback(),fetch(Ps,{mode:"cors"}).then(e=>e.json()).then(e=>{this._data=e,this.requestUpdate()}).catch(()=>{this._err=!0,this.requestUpdate()})}_formatUptime(e){if(!e)return"";let t=[];return e.days&&t.push(`${e.days}d`),e.hours&&t.push(`${e.hours}h`),e.mins!==void 0&&t.push(`${e.mins}m`),t.join(" ")}_countryCounts(e){let t={};for(let s of Object.values(e)){let i=s.split("|")[0]||"XX";t[i]=(t[i]??0)+1}return Object.entries(t).sort((s,i)=>i[1]-s[1])}render(){if(this._err)return o`<span class="loading">Could not load stats.</span>`;if(!this._data)return o`<span class="loading">Loading…</span>`;let{uptime:e,ip_cache:t}=this._data,s=this._countryCounts(t??{});return o`
            ...
            <ul>
                ...
                `)}
            </ul>`}};customElements.define("stats-panel",it);var nt=class n extends S{static properties={_open:{state:!0},_notifEnabled:{state:!0},_showStats:{state:!0},_copied:{state:!0},_picker:{state:!0}};static LOD_LABELS=["pixelated","polygons","high poly","shaders","antialiased"];static styles=[v,F,b`
...
`,Rs=(n,e=!1,t=null,s=!0)=>{let i=`lobby.html?tournamentId=${encodeURIComponent(n.id)}`,r=a=>{t?(a.preventDefault(),a.stopPropagation(),t(n.id)):a.currentTarget instanceof HTMLButtonElement&&(a.preventDefault(),window.location.href=a.currentTarget.closest("a").href)};return o`<a class="arena-item ${e?"completed":""}" href=${i} @click=${r}>
    ...
    `}};customElements.define("arena-chat",at);var ot=class extends f{static properties={standings:{attribute:!1}};static styles=[T,v,b`
        :host { display: block; }
    ...
    `];constructor(){super(),this.standings=[]}render(){let e=[this.standings[1],this.standings[0],this.standings[2]],t=["silver","gold","bronze"],s=["\u{1F948}","\u{1F3C6}","\u{1F949}"];return this.standings.length?o`<div class="podium" aria-label="Top three final standings">
        ...
        </div>`:o`<div class="empty">No final standings available.</div>`}};customElements.define("arena-podium",ot);var lt=class extends f{static properties={standings:{attribute:!1},players:{attribute:!1},onlineUsers:{attribute:!1},expired:{type:Boolean},countdown:{type:String}};static styles=[T,b`
        :host { display: block; }
    ...
    `];constructor(){super(),this.arenaId="",this.lobby=null,this.theme=document.documentElement.getAttribute("theme")||localStorage.getItem("theme")||"dark",this._arena=null,this._leaderboard=[],this._onlineUsers=[],this._busy=!1,this._theme=this.theme,document.documentElement.setAttribute("theme",this._theme),document.documentElement.style.colorScheme=this._theme,this._lobby=null,this._lobbyWired=!1,this._error="",this._timer=null,this._staleRefetchDone=!1,this._lastLoadedArenaId=null,this._pairingState=null,this._pairingCountdown=dt,this._pairedName="",this._beserk=!1,this._pairingInterval=null,this._pairingTimeout=null,this._pendingArenaChallenge=null}connectedCallback(){super.connectedCallback(),this._load(),this.lobby&&this._setupLobby(),this._timer=setInterval(()=>{this._arena&&this.requestUpdate()},1e3)}updated(e){e.has("lobby")&&this.lobby&&this._setupLobby(),e.has("arenaId")&&this.arenaId&&this.arenaId!==this._lastLoadedArenaId&&this._load()}disconnectedCallback(){this._timer&&(clearInterval(this._timer),this._timer=null),this._cancelPairing(),this._pendingArenaChallenge=null,this._lobbyWired=!1,super.disconnectedCallback()}_isExpired(){return!!(this._arena&&this._arena.endTime&&Date.now()>=this._arena.endTime)}get _localCustom(){let e=m.getCustom();return(e.emoji===void 0||e.emoji===null)&&this._onlineUsers.find(s=>s.userId===m.clientId)?.meta?.country==="BOT"?{...e,emoji:"\u{1F916}"}:e}_getCountdownText(){if(!this._arena||!this._arena.endTime)return"";let e=Math.max(0,this._arena.endTime-Date.now());if(e<=0||this._arena.status==="finished")return"00:00";let t=Math.floor(e/1e3),s=Math.floor(t/60),i=t%60;if(s>=60){let r=Math.floor(s/60),a=s%60;return`${String(r).padStart(2,"0")}:${String(a).padStart(2,"0")}:${String(i).padStart(2,"0")}`}return`${String(s).padStart(2,"0")}:${String(i).padStart(2,"0")}`}_setupLobby(){!this.lobby||this._lobbyWired||(this._lobby=this.lobby,this._lobbyWired=!0,this._syncArenaPresence(),this._lobby.onUsersChange(e=>{this._onlineUsers=[...e,{userId:m.clientId,userName:m.userName,custom:this._localCustom}],this._checkStaleArenaPresence()}),this._lobby.onChallenge(e=>{e.type==="offer"?this._handleIncomingChallenge(e):this._handleArenaChallengeMessage(e)}))}async _handleIncomingChallenge(e){if(e.type!=="offer"||e.challengeeId!==m.clientId)return;let t=this._pairingState==="counting",s=this._beserk;if(this._cancelPairing(),!this._arena?.players?.some(r=>r.playerId===m.clientId&&r.active!==!1)||e.options?.tournamentId!==this.arenaId){t&&this.requestUpdate();return}await this._acceptArenaChallenge(e,s)}_handleArenaChallengeMessage(e){let t=this._pendingArenaChallenge;if(!t||e.challengerId!==m.clientId||e.challengeeId!==t.opponentId)return;if(e.type==="decline"||e.type==="cancel"){this._pendingArenaChallenge=null;return}if(e.type!=="accept")return;if(!t.tableId){t.earlyAccept=e;return}if(e.tableId!==t.tableId)return;this._pendingArenaChallenge=null;let s=e.ruleType||t.ruleType,i=e.options||t.options,r=e.nextTurnId?e.nextTurnId===m.clientId:!0,a=H({tableId:e.tableId,userId:m.clientId,userName:m.userName,ruleType:s,isFirst:r,options:i,localOptions:t.beserk?{beserk:"true"}:void 0,lod:m.lod,flip:m.flip,custom:this._localCustom,opponent:{userId:t.opponentId,userName:t.opponentName,custom:t.opponentCustom}});window.location.href=a}async _acceptArenaChallenge(e,t=this._beserk){if(!this._lobby)return;let s=e.ruleType||this._arena?.ruleType||"nineball",i=e.options||this._arena?.options||{};try{await this._lobby.acceptChallenge(e.challengerId,s,e.tableId,i,e.challengerName,void 0,this._localCustom)}catch(c){console.error("Arena auto-accept failed:",c);return}let r=e.nextTurnId?e.nextTurnId===m.clientId:!1,a=H({tableId:e.tableId,userId:m.clientId,userName:m.userName,ruleType:s,isFirst:r,options:i,localOptions:t?{beserk:"true"}:void 0,lod:m.lod,flip:m.flip,custom:this._localCustom,opponent:{userId:e.challengerId,userName:e.challengerName||"",custom:e.custom}});window.location.href=a}async _load(){if(this.arenaId){this._busy=!0,this._error="";try{let e=await fetch(`${A}/api/arena/${encodeURIComponent(this.arenaId)}`),t=await e.json();if(!e.ok)throw new Error(t.error||`Unable to load Arena (${e.status})`);this._arena=t.arena,this._leaderboard=t.leaderboard||[],this.arenaId!==this._lastLoadedArenaId&&(this._staleRefetchDone=!1,this._lastLoadedArenaId=this.arenaId),await this._syncArenaPresence(),this._checkStaleArenaPresence()}catch(e){this._error=e.message||"Unable to load Arena."}finally{this._busy=!1}}}async _join(){let e=(m.userName||"").trim();if(/^(anonymous|anon)$/i.test(e)){window.alert("You must change name, Anonymous is not a valid arena name");return}await this._mutate("join",{playerId:m.clientId,name:e})}async _leave(){if(this._cancelPairing(),this._lobby)try{await this._lobby.updatePresence({arenaId:void 0})}catch(e){console.error("Failed to clear arena presence:",e)}await this._mutate("leave",{playerId:m.clientId})}async _syncArenaPresence(){if(!this._lobby||!this._arena)return;let e=this._arena.players?.find(t=>t.playerId===m.clientId);try{await this._lobby.updatePresence({arenaId:e?.active!==!1&&e?this.arenaId:void 0})}catch(t){console.error("Failed to update Arena presence:",t)}}_checkStaleArenaPresence(){if(!this._arena||!this._lobby)return;this._onlineUsers.some(t=>t.userId!==m.clientId&&t.arenaId===this.arenaId&&!this._arena.players?.some(s=>s.playerId===t.userId))&&this._refetchStaleArenaOnce()}_refetchStaleArenaOnce(){this._staleRefetchDone||this._busy||(this._staleRefetchDone=!0,this._load())}async _mutate(e,t){this._busy=!0,this._error="";try{let s=await fetch(`${A}/api/arena/${encodeURIComponent(this.arenaId)}/${e}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}),i=await s.json();if(!s.ok)throw new Error(i.error||`${e} failed (${s.status})`);await this._load()}catch(s){this._error=s.message||`Unable to ${e} Arena.`,this._busy=!1}}_getPairingCandidates(){let e=m.clientId,t=[],s=[],i=[];for(let r of this._leaderboard){if(r.playerId===e)continue;let a=ct(r.playerId),c=this._arena?.players?.find(u=>u.playerId===r.playerId),l=this._onlineUsers.find(u=>u.userId===r.playerId),h=!a&&!!l?.tableId,d=c?.active!==!1&&(a||!!(l&&!h)),p={playerId:r.playerId,name:r.name,playing:h,bot:a,available:d};i.push(p),d&&(a?s.push(r):t.push(r))}return{candidates:t.length>0?t:s,diagnostics:i}}_findEligibleOpponents(){return this._getPairingCandidates().candidates}_startPairing(){this._pairingState!=="counting"&&(this._pairingState="counting",this._pairingCountdown=this._getPairingCandidates().candidates.some(e=>!ct(e.playerId))?Hs:dt,this._pairedName="",this._pairingInterval=setInterval(()=>this._onPairingTick(),1e3))}_cancelPairing(){this._pairingInterval&&(clearInterval(this._pairingInterval),this._pairingInterval=null),this._pairingTimeout&&(clearTimeout(this._pairingTimeout),this._pairingTimeout=null),this._pairingState=null,this._pairingCountdown=dt,this._pairedName="",this._beserk=!1}_onPairingTick(){let e=this._arena,t=m.clientId,s=e?.players?.some(r=>r.playerId===t&&r.active!==!1),i=e?.status==="active"&&Date.now()<(e?.endTime||0);if(!s||!i){this._cancelPairing();return}if(this._pairingCountdown-=1,this._pairingCountdown<=0){clearInterval(this._pairingInterval),this._pairingInterval=null,this._executePairing();return}this.requestUpdate()}_getOpponentHistory(){if(!this.arenaId)return[];try{let e=localStorage.getItem(`arena_opponents_${this.arenaId}`);return e?JSON.parse(e):[]}catch{return[]}}_recordOpponentHistory(e){if(!(!this.arenaId||!e))try{let t=this._getOpponentHistory();t.push(e),t.length>10&&t.shift(),localStorage.setItem(`arena_opponents_${this.arenaId}`,JSON.stringify(t))}catch(t){console.error("Failed to save opponent history:",t)}}async _executePairing(){let e=this._beserk;this._beserk=!1;let{candidates:t,diagnostics:s}=this._getPairingCandidates();if(t.length===0){console.log("[Arena pairing]",{candidates:s,choice:null}),this._pairingState="no-opponent",this._pairingTimeout=setTimeout(()=>this._cancelPairing(),ps);return}let i=this._getOpponentHistory(),r={};for(let d of i)r[d]=(r[d]||0)+1;let a=1/0;for(let d of t){let p=r[d.playerId]||0;p<a&&(a=p)}let c=t.filter(d=>(r[d.playerId]||0)===a),l=c[Math.floor(Math.random()*c.length)];this._recordOpponentHistory(l.playerId);let h=s.find(d=>d.playerId===l.playerId);console.log("[Arena pairing]",{candidates:s,choice:h}),this._pairedName=l.name,this._pairingState="paired";try{await this._initiateChallenge(l,e)}catch(d){console.error("Pairing challenge failed:",d)}this._pairingTimeout=setTimeout(()=>this._cancelPairing(),ps)}async _initiateChallenge(e,t=this._beserk){let s=this._arena,i=s?.ruleType||"nineball",r=s?.options||{},a=s?.id||"";if(ct(e.playerId)){let h=zs[e.playerId]||e.name,d="arena-bot-"+Math.random().toString(36).slice(2,8),p=H({tableId:d,userId:m.clientId,userName:m.userName,ruleType:i,isFirst:!0,options:r,bot:h,lod:m.lod,custom:this._localCustom,opponent:{userId:e.playerId,userName:e.name,custom:e.custom},flip:m.flip,localOptions:t?{beserk:"true"}:void 0});window.location.href=p+`&tournamentId=${encodeURIComponent(a)}`;return}if(!this._lobby){console.error("Pairing: no lobby connection");return}let c={...r,tournamentId:a},l={opponentId:e.playerId,opponentName:e.name,opponentCustom:e.custom||this._onlineUsers.find(h=>h.userId===e.playerId)?.custom,ruleType:i,options:c,beserk:t,tableId:null,earlyAccept:null};this._pendingArenaChallenge=l;try{let h=await this._lobby.challenge(e.playerId,i,c,void 0,this._localCustom);if(l.tableId=h,l.earlyAccept){let d=l.earlyAccept;l.earlyAccept=null,this._handleArenaChallengeMessage(d)}}catch(h){throw this._pendingArenaChallenge===l&&(this._pendingArenaChallenge=null),h}}_renderPairingOverlay(){return this._pairingState==="counting"?o`
        ...
        </div>`}};customElements.define("arena-view",ht);var pt=class extends f{static properties={arenaId:{type:String},lobby:{type:Object},theme:{type:String,reflect:!0},_arenaName:{state:!0}};static styles=[T,v,b`
        :host { display: block; }
        .panel-bar {
            display: flex;
            align-items: center;
