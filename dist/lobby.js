"use strict";(()=>{var z=globalThis,Y=z.ShadowRoot&&(z.ShadyCSS===void 0||z.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,se=Symbol(),Ae=new WeakMap,M=class{constructor(e,t,s){if(this._$cssResult$=!0,s!==se)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o,t=this.t;if(Y&&e===void 0){let s=t!==void 0&&t.length===1;s&&(e=Ae.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),s&&Ae.set(t,e))}return e}toString(){return this.cssText}},Le=r=>new M(typeof r=="string"?r:r+"",void 0,se),p=(r,...e)=>{let t=r.length===1?r[0]:e.reduce((s,i,n)=>s+(a=>{if(a._$cssResult$===!0)return a.cssText;if(typeof a=="number")return a;throw Error("Value passed to 'css' function must be a 'css' function result: "+a+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+r[n+1],r[0]);return new M(t,r,se)},Pe=(r,e)=>{if(Y)r.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(let t of e){let s=document.createElement("style"),i=z.litNonce;i!==void 0&&s.setAttribute("nonce",i),s.textContent=t.cssText,r.appendChild(s)}},ie=Y?r=>r:r=>r instanceof CSSStyleSheet?(e=>{let t="";for(let s of e.cssRules)t+=s.cssText;return Le(t)})(r):r;var{is:gt,defineProperty:bt,getOwnPropertyDescriptor:mt,getOwnPropertyNames:ft,getOwnPropertySymbols:yt,getPrototypeOf:vt}=Object,G=globalThis,ke=G.trustedTypes,$t=ke?ke.emptyScript:"",_t=G.reactiveElementPolyfillSupport,N=(r,e)=>r,re={toAttribute(r,e){switch(e){case Boolean:r=r?$t:null;break;case Object:case Array:r=r==null?r:JSON.stringify(r)}return r},fromAttribute(r,e){let t=r;switch(e){case Boolean:t=r!==null;break;case Number:t=r===null?null:Number(r);break;case Object:case Array:try{t=JSON.parse(r)}catch{t=null}}return t}},Ne=(r,e)=>!gt(r,e),Me={attribute:!0,type:String,converter:re,reflect:!1,useDefault:!1,hasChanged:Ne};Symbol.metadata??=Symbol("metadata"),G.litPropertyMetadata??=new WeakMap;var _=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??=[]).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,t=Me){if(t.state&&(t.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((t=Object.create(t)).wrapped=!0),this.elementProperties.set(e,t),!t.noAccessor){let s=Symbol(),i=this.getPropertyDescriptor(e,s,t);i!==void 0&&bt(this.prototype,e,i)}}static getPropertyDescriptor(e,t,s){let{get:i,set:n}=mt(this.prototype,e)??{get(){return this[t]},set(a){this[t]=a}};return{get:i,set(a){let c=i?.call(this);n?.call(this,a),this.requestUpdate(e,c,s)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??Me}static _$Ei(){if(this.hasOwnProperty(N("elementProperties")))return;let e=vt(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(N("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(N("properties"))){let t=this.properties,s=[...ft(t),...yt(t)];for(let i of s)this.createProperty(i,t[i])}let e=this[Symbol.metadata];if(e!==null){let t=litPropertyMetadata.get(e);if(t!==void 0)for(let[s,i]of t)this.elementProperties.set(s,i)}this._$Eh=new Map;for(let[t,s]of this.elementProperties){let i=this._$Eu(t,s);i!==void 0&&this._$Eh.set(i,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){let t=[];if(Array.isArray(e)){let s=new Set(e.flat(1/0).reverse());for(let i of s)t.unshift(ie(i))}else e!==void 0&&t.push(ie(e));return t}static _$Eu(e,t){let s=t.attribute;return s===!1?void 0:typeof s=="string"?s:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(e=>this.enableUpdating=e),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(e=>e(this))}addController(e){(this._$EO??=new Set).add(e),this.renderRoot!==void 0&&this.isConnected&&e.hostConnected?.()}removeController(e){this._$EO?.delete(e)}_$E_(){let e=new Map,t=this.constructor.elementProperties;for(let s of t.keys())this.hasOwnProperty(s)&&(e.set(s,this[s]),delete this[s]);e.size>0&&(this._$Ep=e)}createRenderRoot(){let e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return Pe(e,this.constructor.elementStyles),e}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(e=>e.hostConnected?.())}enableUpdating(e){}disconnectedCallback(){this._$EO?.forEach(e=>e.hostDisconnected?.())}attributeChangedCallback(e,t,s){this._$AK(e,s)}_$ET(e,t){let s=this.constructor.elementProperties.get(e),i=this.constructor._$Eu(e,s);if(i!==void 0&&s.reflect===!0){let n=(s.converter?.toAttribute!==void 0?s.converter:re).toAttribute(t,s.type);this._$Em=e,n==null?this.removeAttribute(i):this.setAttribute(i,n),this._$Em=null}}_$AK(e,t){let s=this.constructor,i=s._$Eh.get(e);if(i!==void 0&&this._$Em!==i){let n=s.getPropertyOptions(i),a=typeof n.converter=="function"?{fromAttribute:n.converter}:n.converter?.fromAttribute!==void 0?n.converter:re;this._$Em=i;let c=a.fromAttribute(t,n.type);this[i]=c??this._$Ej?.get(i)??c,this._$Em=null}}requestUpdate(e,t,s,i=!1,n){if(e!==void 0){let a=this.constructor;if(i===!1&&(n=this[e]),s??=a.getPropertyOptions(e),!((s.hasChanged??Ne)(n,t)||s.useDefault&&s.reflect&&n===this._$Ej?.get(e)&&!this.hasAttribute(a._$Eu(e,s))))return;this.C(e,t,s)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(e,t,{useDefault:s,reflect:i,wrapped:n},a){s&&!(this._$Ej??=new Map).has(e)&&(this._$Ej.set(e,a??t??this[e]),n!==!0||a!==void 0)||(this._$AL.has(e)||(this.hasUpdated||s||(t=void 0),this._$AL.set(e,t)),i===!0&&this._$Em!==e&&(this._$Eq??=new Set).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}let e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[i,n]of this._$Ep)this[i]=n;this._$Ep=void 0}let s=this.constructor.elementProperties;if(s.size>0)for(let[i,n]of s){let{wrapped:a}=n,c=this[i];a!==!0||this._$AL.has(i)||c===void 0||this.C(i,void 0,n,c)}}let e=!1,t=this._$AL;try{e=this.shouldUpdate(t),e?(this.willUpdate(t),this._$EO?.forEach(s=>s.hostUpdate?.()),this.update(t)):this._$EM()}catch(s){throw e=!1,this._$EM(),s}e&&this._$AE(t)}willUpdate(e){}_$AE(e){this._$EO?.forEach(t=>t.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&=this._$Eq.forEach(t=>this._$ET(t,this[t])),this._$EM()}updated(e){}firstUpdated(e){}};_.elementStyles=[],_.shadowRootOptions={mode:"open"},_[N("elementProperties")]=new Map,_[N("finalized")]=new Map,_t?.({ReactiveElement:_}),(G.reactiveElementVersions??=[]).push("2.1.2");var he=globalThis,Ue=r=>r,q=he.trustedTypes,Re=q?q.createPolicy("lit-html",{createHTML:r=>r}):void 0,ze="$lit$",E=`lit$${Math.random().toFixed(9).slice(2)}$`,Ye="?"+E,xt=`<${Ye}>`,C=document,R=()=>C.createComment(""),O=r=>r===null||typeof r!="object"&&typeof r!="function",pe=Array.isArray,wt=r=>pe(r)||typeof r?.[Symbol.iterator]=="function",ne=`[ 	
\f\r]`,U=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Oe=/-->/g,He=/>/g,S=RegExp(`>|${ne}(?:([^\\s"'>=/]+)(${ne}*=${ne}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),je=/'/g,Be=/"/g,Ge=/^(?:script|style|textarea|title)$/i,ue=r=>(e,...t)=>({_$litType$:r,strings:e,values:t}),l=ue(1),Ht=ue(2),jt=ue(3),x=Symbol.for("lit-noChange"),b=Symbol.for("lit-nothing"),De=new WeakMap,I=C.createTreeWalker(C,129);function qe(r,e){if(!pe(r)||!r.hasOwnProperty("raw"))throw Error("invalid template strings array");return Re!==void 0?Re.createHTML(e):e}var Et=(r,e)=>{let t=r.length-1,s=[],i,n=e===2?"<svg>":e===3?"<math>":"",a=U;for(let c=0;c<t;c++){let o=r[c],h,u,d=-1,y=0;for(;y<o.length&&(a.lastIndex=y,u=a.exec(o),u!==null);)y=a.lastIndex,a===U?u[1]==="!--"?a=Oe:u[1]!==void 0?a=He:u[2]!==void 0?(Ge.test(u[2])&&(i=RegExp("</"+u[2],"g")),a=S):u[3]!==void 0&&(a=S):a===S?u[0]===">"?(a=i??U,d=-1):u[1]===void 0?d=-2:(d=a.lastIndex-u[2].length,h=u[1],a=u[3]===void 0?S:u[3]==='"'?Be:je):a===Be||a===je?a=S:a===Oe||a===He?a=U:(a=S,i=void 0);let f=a===S&&r[c+1].startsWith("/>")?" ":"";n+=a===U?o+xt:d>=0?(s.push(h),o.slice(0,d)+ze+o.slice(d)+E+f):o+E+(d===-2?c:f)}return[qe(r,n+(r[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),s]},H=class r{constructor({strings:e,_$litType$:t},s){let i;this.parts=[];let n=0,a=0,c=e.length-1,o=this.parts,[h,u]=Et(e,t);if(this.el=r.createElement(h,s),I.currentNode=this.el.content,t===2||t===3){let d=this.el.content.firstChild;d.replaceWith(...d.childNodes)}for(;(i=I.nextNode())!==null&&o.length<c;){if(i.nodeType===1){if(i.hasAttributes())for(let d of i.getAttributeNames())if(d.endsWith(ze)){let y=u[a++],f=i.getAttribute(d).split(E),D=/([.?@])?(.*)/.exec(y);o.push({type:1,index:n,name:D[2],strings:f,ctor:D[1]==="."?oe:D[1]==="?"?le:D[1]==="@"?ce:A}),i.removeAttribute(d)}else d.startsWith(E)&&(o.push({type:6,index:n}),i.removeAttribute(d));if(Ge.test(i.tagName)){let d=i.textContent.split(E),y=d.length-1;if(y>0){i.textContent=q?q.emptyScript:"";for(let f=0;f<y;f++)i.append(d[f],R()),I.nextNode(),o.push({type:2,index:++n});i.append(d[y],R())}}}else if(i.nodeType===8)if(i.data===Ye)o.push({type:2,index:n});else{let d=-1;for(;(d=i.data.indexOf(E,d+1))!==-1;)o.push({type:7,index:n}),d+=E.length-1}n++}}static createElement(e,t){let s=C.createElement("template");return s.innerHTML=e,s}};function T(r,e,t=r,s){if(e===x)return e;let i=s!==void 0?t._$Co?.[s]:t._$Cl,n=O(e)?void 0:e._$litDirective$;return i?.constructor!==n&&(i?._$AO?.(!1),n===void 0?i=void 0:(i=new n(r),i._$AT(r,t,s)),s!==void 0?(t._$Co??=[])[s]=i:t._$Cl=i),i!==void 0&&(e=T(r,i._$AS(r,e.values),i,s)),e}var ae=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:s}=this._$AD,i=(e?.creationScope??C).importNode(t,!0);I.currentNode=i;let n=I.nextNode(),a=0,c=0,o=s[0];for(;o!==void 0;){if(a===o.index){let h;o.type===2?h=new j(n,n.nextSibling,this,e):o.type===1?h=new o.ctor(n,o.name,o.strings,this,e):o.type===6&&(h=new de(n,this,e)),this._$AV.push(h),o=s[++c]}a!==o?.index&&(n=I.nextNode(),a++)}return I.currentNode=C,i}p(e){let t=0;for(let s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(e,s,t),t+=s.strings.length-2):s._$AI(e[t])),t++}},j=class r{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,s,i){this.type=2,this._$AH=b,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=s,this.options=i,this._$Cv=i?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=T(this,e,t),O(e)?e===b||e==null||e===""?(this._$AH!==b&&this._$AR(),this._$AH=b):e!==this._$AH&&e!==x&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):wt(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==b&&O(this._$AH)?this._$AA.nextSibling.data=e:this.T(C.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:s}=e,i=typeof s=="number"?this._$AC(e):(s.el===void 0&&(s.el=H.createElement(qe(s.h,s.h[0]),this.options)),s);if(this._$AH?._$AD===i)this._$AH.p(t);else{let n=new ae(i,this),a=n.u(this.options);n.p(t),this.T(a),this._$AH=n}}_$AC(e){let t=De.get(e.strings);return t===void 0&&De.set(e.strings,t=new H(e)),t}k(e){pe(this._$AH)||(this._$AH=[],this._$AR());let t=this._$AH,s,i=0;for(let n of e)i===t.length?t.push(s=new r(this.O(R()),this.O(R()),this,this.options)):s=t[i],s._$AI(n),i++;i<t.length&&(this._$AR(s&&s._$AB.nextSibling,i),t.length=i)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){let s=Ue(e).nextSibling;Ue(e).remove(),e=s}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},A=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,s,i,n){this.type=1,this._$AH=b,this._$AN=void 0,this.element=e,this.name=t,this._$AM=i,this.options=n,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=b}_$AI(e,t=this,s,i){let n=this.strings,a=!1;if(n===void 0)e=T(this,e,t,0),a=!O(e)||e!==this._$AH&&e!==x,a&&(this._$AH=e);else{let c=e,o,h;for(e=n[0],o=0;o<n.length-1;o++)h=T(this,c[s+o],t,o),h===x&&(h=this._$AH[o]),a||=!O(h)||h!==this._$AH[o],h===b?e=b:e!==b&&(e+=(h??"")+n[o+1]),this._$AH[o]=h}a&&!i&&this.j(e)}j(e){e===b?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},oe=class extends A{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===b?void 0:e}},le=class extends A{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==b)}},ce=class extends A{constructor(e,t,s,i,n){super(e,t,s,i,n),this.type=5}_$AI(e,t=this){if((e=T(this,e,t,0)??b)===x)return;let s=this._$AH,i=e===b&&s!==b||e.capture!==s.capture||e.once!==s.once||e.passive!==s.passive,n=e!==b&&(s===b||i);i&&this.element.removeEventListener(this.name,this,s),n&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},de=class{constructor(e,t,s){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(e){T(this,e)}};var St=he.litHtmlPolyfillSupport;St?.(H,j),(he.litHtmlVersions??=[]).push("3.3.2");var Ve=(r,e,t)=>{let s=t?.renderBefore??e,i=s._$litPart$;if(i===void 0){let n=t?.renderBefore??null;s._$litPart$=i=new j(e.insertBefore(R(),n),n,void 0,t??{})}return i._$AI(r),i};var ge=globalThis,g=class extends _{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Ve(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return x}};g._$litElement$=!0,g.finalized=!0,ge.litElementHydrateSupport?.({LitElement:g});var It=ge.litElementPolyfillSupport;It?.({LitElement:g});(ge.litElementVersions??=[]).push("4.2.2");var Ct=p`
    :host {
        --bg:           #f5f5f5;
        --surface:      #ffffff;
        --border:       #dddddd;
...
`];var be=class extends EventTarget{clientId=localStorage.getItem("clientId")||"";userName=localStorage.getItem("userName")||"Anonymous";lod=localStorage.getItem("lod")||"1";set(e,t){this.clientId=e,this.userName=t,localStorage.setItem("clientId",e),localStorage.setItem("userName",t),this.dispatchEvent(new Event("change"))}setLod(e){this.lod=e,localStorage.setItem("lod",e),this.dispatchEvent(new Event("change"))}},m=new be,v=class extends g{connectedCallback(){super.connectedCallback(),this._storeListener=()=>this.requestUpdate(),m.addEventListener("change",this._storeListener)}disconnectedCallback(){super.disconnectedCallback(),m.removeEventListener("change",this._storeListener)}};var B="https://scoreboard-tailuge.vercel.app",tt=r=>{let e=Math.floor((Date.now()-r)/1e3);if(e<60)return`${e}s ago`;let t=Math.floor(e/60);if(t<60)return`${t}m ago`;let s=Math.floor(t/60);return s<24?`${s}h ago`:`${Math.floor(s/24)}d ago`},st={connected:!1,users:[],challenges:{},currentMatch:null};function it(r,e){let t={...r.challenges},s=i=>i.challengerId===e.myId?i.challengeeId:i.challengerId;switch(e.type){case"CONNECTED":return{...r,connected:e.payload};case"USERS_UPDATE":return{...r,users:e.payload};case"CHALLENGE_SENT":return{...r,challenges:{...t,[e.payload.challengeeId]:{...e.payload,status:"pending"}}};case"CHALLENGE_MSG":{let i=e.payload,n=s(i);if(i.type==="offer")(!t[i.challengerId]||t[i.challengerId].tableId!==i.tableId)&&(t[i.challengerId]={...i,status:"pending"});else if(i.type==="accept"&&!r.currentMatch){let a=t[n],c=i.options||(a?.tableId===i.tableId?a.options:void 0);return delete t[n],{...r,challenges:t,currentMatch:{tableId:i.tableId,ruleType:i.ruleType,options:c,isFirst:i.challengerId===e.myId}}}else i.type==="decline"?t[i.challengeeId]&&(t[i.challengeeId]={...t[i.challengeeId],status:"declined"}):i.type==="cancel"&&delete t[s(i)];return{...r,challenges:t}}case"CHALLENGE_DISMISS":return delete t[e.payload],{...r,challenges:t};case"MATCH_SET":return{...r,currentMatch:e.payload};case"MATCH_LEAVE":return{...r,currentMatch:null};default:return r}}function rt(r="",e=""){return r.includes("github")?{emoji:"\u{1F419}",title:"github"}:r.includes("vercel")?{emoji:"\u{1F465}",title:"vercel"}:r.includes("render")?{emoji:"\u{1F464}",title:"vercel"}:r.includes("localhost")?{emoji:"\u{1F3E0}",title:"localhost"}:{spectator:{emoji:"\u{1F52D}",title:"spectator"},replay:{emoji:"\u{1F440}",title:"replay"},bot:{emoji:"\u{1F916}",title:"bot"},nineball:{emoji:"\u2468",title:"nineball"},eightball:{emoji:"\u{1F3B1}",title:"eightball"},snooker:{emoji:"\u{1F534}",title:"snooker"},threecushion:{emoji:"\u2462",title:"threecushion"}}[e]??{emoji:"\u{1F3AE}",title:"external"}}var F=r=>r==="BOT"?"\u{1F916}":r?[...r.toUpperCase()].map(e=>String.fromCodePoint(127397+e.charCodeAt(0))).join(""):"\u{1F310}",nt="https://billiards.tailuge.workers.dev/",at=(r,e)=>e?Object.entries(e).reduce((t,[s,i])=>t+`&${encodeURIComponent(s)}=${encodeURIComponent(i)}`,r):r,ot=(r,e,t,s)=>r.url?`${r.url}?clientId=${encodeURIComponent(e)}&userName=${encodeURIComponent(t)}&lod=${s}`:at(`${nt}?ruletype=${r.ruletype}&clientId=${encodeURIComponent(e)}&userName=${encodeURIComponent(t)}&lod=${s}`,r.options),me=({tableId:r,userId:e,userName:t,ruleType:s,isFirst:i,options:n,bot:a,lod:c})=>{let o=`${nt}?websocketserver=wss://billiards.onrender.com/ws&tableId=${r}&userName=${encodeURIComponent(t)}&clientId=${e}&ruletype=${s}`;return i&&(o+="&first=true"),a&&(o+=`&bot=${encodeURIComponent(a)}`),c!==void 0&&(o+=`&lod=${c}`),at(o,n)},Tt={eightball:"eightball",snooker:"snooker",threecushion:"threecushion",nineball:"nineball"},W=r=>{let e=Tt[r];return e?l`<img src="assets/${e}.png" alt="${r}" title="${r}" width="12" height="12" style="vertical-align:middle">`:l`🎱`},fe=r=>["\u{1F3C6}","\u{1F948}","\u{1F949}","\u{1F396}\uFE0F"][r]??"";var At=[{label:"Nine Ball",img:"assets/nineball.png",ruletype:"nineball"},{label:"Snooker 6r",img:"assets/snooker.png",ruletype:"snooker",options:{reds:"6"}},{label:"Snooker",img:"assets/snooker.png",ruletype:"snooker",options:{reds:"15"}},{label:"3-Cushion (3)",img:"assets/threecushion.png",ruletype:"threecushion",options:{raceTo:"3"}},{label:"3-Cushion (7)",img:"assets/threecushion.png",ruletype:"threecushion",options:{raceTo:"7"}},{label:"3-Cushion (15)",img:"assets/threecushion.png",ruletype:"threecushion",options:{raceTo:"15"}},{label:"Trickshot",img:"assets/practice.png",url:"https://billiards.tailuge.workers.dev/practice"},{label:"Research",img:"assets/research.png",url:"https://billiards.tailuge.workers.dev/diagrams/three"},{label:"Eight Ball",img:"assets/eightball.png",ruletype:"eightball"}],ye=class extends v{static styles=[Ze,V];#e=[...At].sort(()=>Math.random()-.5);render(){let{clientId:e,userName:t}=m;return l`<div class="grid">${this.#e.map(s=>l`
            <button title=${s.label} aria-label="Play ${s.label}"
                @click=${()=>{window.location.href=ot(s,e,t,m.lod)}}>
                <span class="icon-wrap">
                    <img src=${s.img} alt=${s.label} />
                    ${s.options?l`<span class="badge">${Object.values(s.options)[0]}</span>`:""}
                </span>
            </button>`)}
        </div>`}};customElements.define("solo-panel",ye);var lt={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},ct=r=>(...e)=>({_$litDirective$:r,values:e}),J=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,s){this._$Ct=e,this._$AM=t,this._$Ci=s}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}};var dt="important",Lt=" !"+dt,ht=ct(class extends J{constructor(r){if(super(r),r.type!==lt.ATTRIBUTE||r.name!=="style"||r.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(r){return Object.keys(r).reduce((e,t)=>{let s=r[t];return s==null?e:e+`${t=t.includes("-")?t:t.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${s};`},"")}update(r,[e]){let{style:t}=r.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(e)),this.render(e);for(let s of this.ft)e[s]==null&&(this.ft.delete(s),s.includes("-")?t.removeProperty(s):t[s]=null);for(let s in e){let i=e[s];if(i!=null){this.ft.add(s);let n=typeof i=="string"&&i.endsWith(Lt);s.includes("-")||n?t.setProperty(s,n?i.slice(0,-11):i,n?dt:""):t[s]=i}}return x}});var ve=class extends g{static properties={url:{type:String},color:{type:String},label:{type:String}};static styles=p`
        :host {
    ...
    `;render(){return l`
            <a
                class="pill"
                href=${this.url}
                style=${ht({backgroundColor:this.color||"#4a90d9"})}>
                ${this.label?l`<span>${this.label}</span>`:""}
                <svg viewBox="0 0 24 24"><path d="M8 5v14l11-7z"/></svg>
            </a>
        `}};customElements.define("replay-button",ve);var $e=class extends v{static styles=Qe;connectedCallback(){super.connectedCallback(),fetch(`${B}/api/summary`,{mode:"cors"}).then(e=>e.json()).then(e=>{this._data=e,this.requestUpdate()}).catch(()=>{this._err=!0,this.requestUpdate()})}render(){if(this._err)return l`<span class="loading">Could not load scores.</span>`;if(!this._data)return l`<span class="loading">Loading…</span>`;let{hiscores:e,topPlayers:t,recentMatches:s}=this._data,i=Object.keys(e);return l`
            <div class="group hiscores">
                <div class="group-title">Hi Scores</div>
                <div class="group-body">
                    ${i.map(n=>l`
                        <div class="tbl"><table><caption>${W(n)}</caption>
                        <tr><th>Name</th><th></th></tr>
                            ${e[n].slice(0,4).map((a,c)=>l`<tr><td>${fe(c)} ${a.name}</td><td><replay-button url="${B}/api/rank/${a.id}?ruletype=${n}&lod=${m.lod}" label="${a.score}"></replay-button></td></tr>`)}
                        </table></div>
                    `)}
                </div>
            </div>
                ...
                <div class="group recent">
                    ...
                    <div class="group-body">
                        ...
                        <tr><th>Rule</th><th>Match</th><th>Date</th><th></th></tr>
                            ${s.map(n=>l`<tr>
                                <td>${W(n.ruleType)}</td><td>${n.loser?"\u{1F396}\uFE0F":""}${n.winner}${n.loser?` vs ${n.loser}`:""}</td>
                                <td class="date"><span style="font-size:0.65em">${tt(n.timestamp)}${n.locationCountry?` ${n.locationCity??""}`:""}</span>${n.locationCountry?` ${F(n.locationCountry)}`:""}</td>
                                <td>${n.hasReplay?l`<replay-button url="${B}/api/match-replay?id=${n.id}&lod=${m.lod}"></replay-button>`:""}</td>
                            </tr>`)}
                        </table></div>
                    </div>
                </div>
                        ...
                        ${i.map(n=>l`
                            ...
                            <tr><th>Name</th><th>Rating</th><th>W</th><th>L</th></tr>
                                ${t[n].slice(0,4).map((a,c)=>l`<tr>
                                    <td><a href="${B}/player/${encodeURIComponent(a.name)}?ruleType=${n}">${fe(c)} ${a.name}</a></td>
    ...
    `];constructor(){super(),this._messages=new Map,this._unread=new Map,this._lobbyBound=!1}willUpdate(e){e.has("lobby")&&this.lobby&&!this._lobbyBound&&(this._lobbyBound=!0,this.lobby.onChat(t=>{let s=t.senderId,i=[...this._messages.get(s)??[],t];if(this._messages=new Map(this._messages).set(s,i),s!==this.targetId){let n=(this._unread.get(s)??0)+1;this._unread=new Map(this._unread).set(s,n),te(this,"unread-changed",{userId:s,count:n})}this.requestUpdate()})),e.has("targetId")&&this.targetId&&this._unread.has(this.targetId)&&(this._unread=new Map(this._unread).set(this.targetId,0),te(this,"unread-changed",{userId:this.targetId,count:0}))}_send(e){e.preventDefault();let t=this.shadowRoot.querySelector("input"),s=t.value.trim();if(!s||!this.lobby||!this.targetId)return;this.lobby.sendChat(this.targetId,s);let n={messageType:"chat",senderId:this.lobby.currentUser.userId,recipientId:this.targetId,text:s},a=[...this._messages.get(this.targetId)??[],n];this._messages=new Map(this._messages).set(this.targetId,a),t.value="",this.requestUpdate()}render(){if(!this.targetId)return l``;let e=this.lobby?.currentUser?.userId,t=this._messages.get(this.targetId)??[];return l`
            ...
            </div>`}};customElements.define("message-modal",_e);var Pt=[{userId:"bot-clawbreak",userName:"ClawBreak",isBot:!0,meta:{country:"BOT"}},{userId:"bot-thefarjaw",userName:"TheFarJaw",isBot:!0,meta:{country:"BOT"}}],$=(r,e,t)=>r.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0})),xe=class extends g{static properties={users:{type:Array},myId:{type:String},tableId:{type:String},isChallengePending:{type:Boolean},pendingChats:{type:Object}};static styles=[w,Fe,p`
    ...
    `];render(){let e=(this.users||[]).filter(t=>t.userId!==this.myId);return e.length===0?l`<div class="empty">No other players online yet. Invite a friend!</div>`:l`<ul aria-label="Online players">${e.map(t=>this._row(t))}</ul>`}_row(e){let t=this.pendingChats?.get(e.userId)>0,s=e.isBot||pt(e,this.myId),i=rt(e.meta?.origin??"",e.tableId??""),n=t?l`<button class="btn-chat" aria-label="Unread message from ${e.userName}" @click=${()=>$(this,"open-chat",e.userId)}>💬</button>`:s?l`<button class="btn-challenge" aria-label="Challenge ${e.userName}" ?disabled=${this.isChallengePending} @click=${()=>$(this,"challenge",e.userId)}>Challenge</button>`:l``;return l`
            <li aria-label="${e.userName}">
                <div class="user-info">
                    <span class="user-name">${F(e.meta?.country)} ${e.userName} <span aria-label="${i.title}" role="img">${i.emoji}</span></span>
                </div>
                <div class="actions">${n}</div>
            </li>`}},we=class extends g{static properties={challenge:{type:Object},sent:{type:Object}};static styles=[w,We,Je];render(){return this.challenge?this._incoming(this.challenge):this.sent?this._sent(this.sent):l``}_incoming(e){let t=Object.entries(e.options??{}).map(([s,i])=>`${s}: ${i}`);return l`
            <div class="banner">
            ...
            </div>`}},Ee=class r extends g{static properties={userId:{type:String},userName:{type:String}};static styles=[w,L,V];static RULES=[{id:"eightball",label:"Eight Ball",img:"assets/eightball.png"},{id:"nineball",label:"Nine Ball",img:"assets/nineball.png"},{id:"threecushion",label:"Three Cushion (3)",img:"assets/threecushion.png",options:{raceTo:"3"}},{id:"threecushion",label:"Three Cushion (7)",img:"assets/threecushion.png",options:{raceTo:"7"}},{id:"threecushion",label:"Three Cushion (15)",img:"assets/threecushion.png",options:{raceTo:"15"}},{id:"snooker",label:"Snooker (15 reds)",img:"assets/snooker.png"},{id:"snooker",label:"Snooker (6 reds)",img:"assets/snooker.png",options:{reds:"6"}}];render(){return this.userId?l`
            <div class="backdrop" @click=${e=>e.target===e.currentTarget&&$(this,"cancel")}>
                <div class="modal" role="dialog" aria-modal="true" aria-label="Select game type">
                    ...
                    <div class="rules">
                        ${r.RULES.map(e=>l`
                            <button class="rule btn-challenge" @click=${()=>$(this,"confirm",{ruleType:e.id,options:e.options})}>
                                <span class="icon-wrap">
                    ...
                    <button @click=${()=>$(this,"message")}>💬 Send message</button>
                    <button class="cancel" @click=${()=>$(this,"cancel")}>Cancel</button>
                </div>
            </div>`:l``}},Se=class extends g{static styles=[w,Xe];#e={...st};#s=null;#g=null;#t;#i;#h;#p;#r=null;#n=null;#l=new Map;constructor(){super();let e=new URLSearchParams(location.search);this.#t=e.get("clientId")||localStorage.getItem("clientId")||"user-"+Math.random().toString(36).slice(2,7),this.#i=e.get("userName")||localStorage.getItem("userName")||"Anonymous";let t="https://billiards-network.onrender.com";(location.hostname==="localhost"||location.hostname==="127.0.0.1")&&(t=`${location.protocol==="https:"?"https:":"http:"}//${location.host}`),this.#p=new ee({baseUrl:t})}connectedCallback(){super.connectedCallback(),this._onUserChanged=e=>{this.#t=e.detail.userId,this.#i=e.detail.userName,this.#s?.leave(),this.#s=null,this._connect().catch(t=>console.error("Lobby reconnect failed:",t))},document.addEventListener("user-name-changed",this._onUserChanged),this._connect().catch(e=>console.error("Lobby connect failed:",e))}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("user-name-changed",this._onUserChanged),this.#s?.leave()}dispatch(e){this.#e=it(this.#e,{...e,myId:this.#t}),this.requestUpdate()}get#u(){return this.#e.connected}get#b(){return this.#e.users}get#c(){return this.#e.currentMatch?.tableId}get#m(){return this.#e.currentMatch?.ruleType||"standard"}get#f(){return!!this.#e.currentMatch?.isFirst}get#y(){return this.#e.currentMatch?.options}get#d(){return Object.values(this.#e.challenges).find(e=>e.challengeeId===this.#t&&e.status==="pending")}get#o(){return Object.values(this.#e.challenges).find(e=>e.challengerId===this.#t)}get#a(){return[...this.#b,...Pt]}async _connect(){this.#h=Date.now(),this.#s=await this.#p.joinLobby({messageType:"presence",type:"join",userId:this.#t,userName:this.#i}),this.dispatch({type:"CONNECTED",payload:!0}),this.#s.onUsersChange(e=>this.dispatch({type:"USERS_UPDATE",payload:e})),this.#s.onChallenge(e=>{(e.meta?.ts?new Date(e.meta.ts).getTime():1/0)<this.#h||(this.dispatch({type:"CHALLENGE_MSG",payload:e}),e.type==="challenge"&&e.challengeeId===this.#t&&document.hidden&&Notification.permission==="granted"&&new Notification("Challenge received!",{body:`${e.challengerName} challenged you to ${e.ruleType}`,icon:"assets/golden-cup.png"}))})}async#v(e,t,s){let i=this.#a.find(a=>a.userId===e);if(i?.isBot){let a="bot-"+Math.random().toString(36).slice(2,8);window.location.href=me({tableId:a,userId:this.#t,userName:this.#i,ruleType:t,isFirst:!0,options:s,bot:i.userName,lod:m.lod});return}let n=await this.#s.challenge(e,t,void 0,s);this.dispatch({type:"CHALLENGE_SENT",payload:{challengerId:this.#t,challengeeId:e,recipientName:i?.userName||e,ruleType:t,options:s,tableId:n}})}async#$(){let e=this.#o;e?.status==="pending"&&(await this.#s.cancelChallenge(e.challengeeId,e.ruleType),this.dispatch({type:"CHALLENGE_DISMISS",payload:e.challengeeId}))}async#_(){let e=this.#d;this.#g=await this.#s.acceptChallenge(e.challengerId,e.ruleType,e.tableId,e.options,e.challengerName),this.dispatch({type:"MATCH_SET",payload:{tableId:e.tableId,ruleType:e.ruleType,options:e.options,isFirst:!1}})}async#x(){let e=this.#d;await this.#s.declineChallenge(e.challengerId,e.ruleType,e.challengerName),this.dispatch({type:"CHALLENGE_DISMISS",payload:e.challengerId})}#w(){let e=this.#o;e&&this.dispatch({type:"CHALLENGE_DISMISS",payload:e.challengeeId})}render(){if(this.#c){let t=me({tableId:this.#c,userId:this.#t,userName:this.#i,ruleType:this.#m,isFirst:this.#f,options:this.#y,lod:m.lod});return window.location.href=t,l``}let e=this.#r;return l`
            <div class="panel-header">
                <span class="dot ${this.#u?"on":""}" role="status" aria-label="${this.#u?"Connected":"Disconnected"}"></span>
                <span class="panel-title">Play Online (${this.#a.filter(t=>t.userId!==this.#t).length})</span>
            </div>
            <challenge-banner
                .challenge=${this.#d}
                .sent=${this.#o}
            ...
            <user-list
                ...
                @open-chat=${t=>{let s=this.#a.find(i=>i.userId===t.detail);this.#n={userId:t.detail,userName:s?.userName??t.detail},this.requestUpdate()}}>
            </user-list>
            <challenge-modal
                .userId=${e?.userId??null}
                .userName=${e?.userName??""}
                @confirm=${t=>{this.#v(e.userId,t.detail.ruleType,t.detail.options),this.#r=null}}
                @message=${()=>{this.#n={userId:e.userId,userName:e.userName},this.#r=null,this.requestUpdate()}}
                @cancel=${()=>{this.#r=null,this.requestUpdate()}}>
            </challenge-modal>
            <message-modal
                .lobby=${this.#s}
                .targetId=${this.#n?.userId??null}
                .targetName=${this.#n?.userName??""}
                @close=${()=>{this.#n=null,this.requestUpdate()}}
                @unread-changed=${t=>{this.#l=new Map(this.#l).set(t.detail.userId,t.detail.count),this.requestUpdate()}}>
            </message-modal>`}};customElements.define("user-list",xe);customElements.define("challenge-banner",we);customElements.define("challenge-modal",Ee);customElements.define("online-panel",Se);var kt=()=>"id"+Math.random().toString(16).slice(2,8);function Mt(){let r=new URLSearchParams(location.search),e=r.get("clientId"),t=r.get("userName");if(e)return{clientId:e,userName:t||"Anonymous",dotColor:"#f5c518"};let s=!!localStorage.getItem("clientId"),i=localStorage.getItem("clientId")||(()=>{let a=kt();return localStorage.setItem("clientId",a),a})(),n=localStorage.getItem("userName")||"Anonymous";return{clientId:i,userName:n,dotColor:s?"#4caf50":"#888"}}var Ie=class extends v{static properties={_name:{state:!0},_editing:{state:!0},_dotColor:{state:!0}};static styles=Ke;constructor(){super();let{clientId:e,userName:t,dotColor:s}=Mt();this._clientId=e,this._name=t,this._dotColor=s,this._editing=!1}_startEdit(){this._editing=!0,this._outsideHandler=e=>{!this.contains(e.target)&&!this.shadowRoot.contains(e.target)&&this._commitValue()},document.addEventListener("click",this._outsideHandler,!0)}_commitValue(){document.removeEventListener("click",this._outsideHandler,!0),this._outsideHandler=null;let t=(this.shadowRoot?.querySelector("input")?.value??this._name).trim().slice(0,12)||"Anonymous";this._name=t,this._editing=!1,m.set(this._clientId,t),this.dispatchEvent(new CustomEvent("user-name-changed",{bubbles:!0,composed:!0,detail:{userId:this._clientId,userName:t}}))}_onKey(e){e.key==="Enter"&&this._commitValue(),e.key==="Escape"&&(document.removeEventListener("click",this._outsideHandler,!0),this._outsideHandler=null,this._cancelling=!0,this._editing=!1)}_onBlur(){if(this._cancelling){this._cancelling=!1;return}this._commitValue()}render(){return l`
            <div class="badge" style="--dot-color:${this._dotColor}"
                 @click=${this._editing?null:this._startEdit}>
                <span class="dot"></span>
                ${this._editing?l`<input autofocus maxlength="12" .value=${this._name}
                                aria-label="Edit display name"
                                @blur=${this._onBlur} @keydown=${this._onKey}
                                @click=${e=>e.stopPropagation()}>`:l`<span role="button" tabindex="0" aria-label="Display name: ${this._name}. Click to edit."
    ...
    `];constructor(){super(),this._open=!1,this._theme=document.documentElement.getAttribute("theme")||"light",this._notifEnabled=Notification.permission==="granted"}_toggle(e){e.stopPropagation(),this._open=!this._open}_close(){this._open=!1}_setTheme(e){let t=e.target.checked?"dark":"light";this._theme=t,document.documentElement.setAttribute("theme",t),localStorage.setItem("theme",t),this.dispatchEvent(new CustomEvent("theme-changed",{detail:t,bubbles:!0,composed:!0}))}_share(){navigator.share?navigator.share({title:document.title,url:location.href}):navigator.clipboard.writeText(location.href)}async _toggleNotifications(e){if(e.target.checked){let t=await Notification.requestPermission();this._notifEnabled=t==="granted"}else this._notifEnabled=!1;this.requestUpdate()}render(){return l`
                    ...
                    <div class="modal" role="dialog" aria-modal="true" aria-label="Settings">
                        ...
                        <div class="row">
                            <label title="Level of Detail">
                                <input type="range" min="0" max="4" step="1" .value=${m.lod} @input=${e=>m.setLod(e.target.value)}>
                                L.O.D (${m.lod})
                            </label>
                        </div>
        ...
        `}};customElements.define("lobby-app",Te);})();
