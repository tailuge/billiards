            ...
            ${e?o`
                <section class="panel">
                    ...
                    ${a?"":o`<div class="actions">
                        ...
                        ${i&&n?o`<button class="btn-leave" type="button" ?disabled=${this._busy} @click=${this._leave}>Leave Arena</button>`:o`<button class="btn-accept" type="button" ?disabled=${this._busy||!c} @click=${this._join}>Join Arena</button>`}
