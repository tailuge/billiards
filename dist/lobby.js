...
`,Cs=(r,e=!1)=>c`<a class="arena-item ${e?"completed":""}" href="arena.html?tournamentId=${encodeURIComponent(r.id)}">
    ...
    ${e?"":c`<button class="arena-join" type="button">Join</button>`}
