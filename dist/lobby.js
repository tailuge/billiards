                ...
                <div class="group-body">
                    ${r.map(a=>o`
                        ...
                        <tr><th>Name</th><th></th></tr>
                            ${e[a].slice(0,4).map((c,l)=>o`<tr><td>${Fe(l)} ${c.name}</td><td><replay-button url="${Je(`${j}/api/rank/${c.id}?ruletype=${a}&lod=${m.lod}`,m.clientId,m.userName)}" label="${c.score}"></replay-button></td></tr>`)}
                        </table></div>
                    `)}
                </div>
            </div>
                    ...
                    <div class="group-body">
                        ...
                        <tr><th>Rule</th><th>Match</th><th>Ago</th><th class="city-col">City</th><th></th></tr>
                            ${s.map(a=>o`<tr>
                                ...
                                <td class="ago">${Bt(a.timestamp)}</td>
                        ...
                        ${i.map(a=>o`
                            <div class="tbl"><table><caption><a href="${j}/elo" target="_blank" rel="noopener">${A(a)} <span style="font-size:0.75rem;font-weight:200">Rankings</span></a></caption>
                             <tr><th>Name</th><th>Score</th><th>W</th><th>L</th></tr>
                                 ${t[a].slice(0,4).map((c,l)=>o`<tr>
                                     <td><a href="${j}/player/${encodeURIComponent(c.name)}?ruleType=${a}">${Fe(l)} ${c.name}</a></td>
                                     <td>${Math.round(c.conservativeRating)}</td>
                                 </tr>`)}
                            </table></div>
                        `)}
                    </div>
