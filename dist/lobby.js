"use strict";(()=>{var Z=globalThis,ee=Z.ShadowRoot&&(Z.ShadyCSS===void 0||Z.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Ee=Symbol(),ot=new WeakMap,Y=class{constructor(e,t,s){if(this._$cssResult$=!0,s!==Ee)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o,t=this.t;if(ee&&e===void 0){let s=t!==void 0&&t.length===1;s&&(e=ot.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),s&&ot.set(t,e))}return e}toString(){return this.cssText}},at=r=>new Y(typeof r=="string"?r:r+"",void 0,Ee),b=(r,...e)=>{let t=r.length===1?r[0]:e.reduce((s,i,n)=>s+(o=>{if(o._$cssResult$===!0)return o.cssText;if(typeof o=="number")return o;throw Error("Value passed to 'css' function must be a 'css' function result: "+o+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+r[n+1],r[0]);return new Y(t,r,Ee)},lt=(r,e)=>{if(ee)r.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(let t of e){let s=document.createElement("style"),i=Z.litNonce;i!==void 0&&s.setAttribute("nonce",i),s.textContent=t.cssText,r.appendChild(s)}},Ce=ee?r=>r:r=>r instanceof CSSStyleSheet?(e=>{let t="";for(let s of e.cssRules)t+=s.cssText;return at(t)})(r):r;var{is:ts,defineProperty:ss,getOwnPropertyDescriptor:is,getOwnPropertyNames:rs,getOwnPropertySymbols:ns,getPrototypeOf:os}=Object,te=globalThis,ct=te.trustedTypes,as=ct?ct.emptyScript:"",ls=te.reactiveElementPolyfillSupport,J=(r,e)=>r,Te={toAttribute(r,e){switch(e){case Boolean:r=r?as:null;break;case Object:case Array:r=r==null?r:JSON.stringify(r)}return r},fromAttribute(r,e){let t=r;switch(e){case Boolean:t=r!==null;break;case Number:t=r===null?null:Number(r);break;case Object:case Array:try{t=JSON.parse(r)}catch{t=null}}return t}},ht=(r,e)=>!ts(r,e),dt={attribute:!0,type:String,converter:Te,reflect:!1,useDefault:!1,hasChanged:ht};Symbol.metadata??=Symbol("metadata"),te.litPropertyMetadata??=new WeakMap;var E=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??=[]).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,t=dt){if(t.state&&(t.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((t=Object.create(t)).wrapped=!0),this.elementProperties.set(e,t),!t.noAccessor){let s=Symbol(),i=this.getPropertyDescriptor(e,s,t);i!==void 0&&ss(this.prototype,e,i)}}static getPropertyDescriptor(e,t,s){let{get:i,set:n}=is(this.prototype,e)??{get(){return this[t]},set(o){this[t]=o}};return{get:i,set(o){let l=i?.call(this);n?.call(this,o),this.requestUpdate(e,l,s)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??dt}static _$Ei(){if(this.hasOwnProperty(J("elementProperties")))return;let e=os(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(J("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(J("properties"))){let t=this.properties,s=[...rs(t),...ns(t)];for(let i of s)this.createProperty(i,t[i])}let e=this[Symbol.metadata];if(e!==null){let t=litPropertyMetadata.get(e);if(t!==void 0)for(let[s,i]of t)this.elementProperties.set(s,i)}this._$Eh=new Map;for(let[t,s]of this.elementProperties){let i=this._$Eu(t,s);i!==void 0&&this._$Eh.set(i,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){let t=[];if(Array.isArray(e)){let s=new Set(e.flat(1/0).reverse());for(let i of s)t.unshift(Ce(i))}else e!==void 0&&t.push(Ce(e));return t}static _$Eu(e,t){let s=t.attribute;return s===!1?void 0:typeof s=="string"?s:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(e=>this.enableUpdating=e),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(e=>e(this))}addController(e){(this._$EO??=new Set).add(e),this.renderRoot!==void 0&&this.isConnected&&e.hostConnected?.()}removeController(e){this._$EO?.delete(e)}_$E_(){let e=new Map,t=this.constructor.elementProperties;for(let s of t.keys())this.hasOwnProperty(s)&&(e.set(s,this[s]),delete this[s]);e.size>0&&(this._$Ep=e)}createRenderRoot(){let e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return lt(e,this.constructor.elementStyles),e}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(e=>e.hostConnected?.())}enableUpdating(e){}disconnectedCallback(){this._$EO?.forEach(e=>e.hostDisconnected?.())}attributeChangedCallback(e,t,s){this._$AK(e,s)}_$ET(e,t){let s=this.constructor.elementProperties.get(e),i=this.constructor._$Eu(e,s);if(i!==void 0&&s.reflect===!0){let n=(s.converter?.toAttribute!==void 0?s.converter:Te).toAttribute(t,s.type);this._$Em=e,n==null?this.removeAttribute(i):this.setAttribute(i,n),this._$Em=null}}_$AK(e,t){let s=this.constructor,i=s._$Eh.get(e);if(i!==void 0&&this._$Em!==i){let n=s.getPropertyOptions(i),o=typeof n.converter=="function"?{fromAttribute:n.converter}:n.converter?.fromAttribute!==void 0?n.converter:Te;this._$Em=i;let l=o.fromAttribute(t,n.type);this[i]=l??this._$Ej?.get(i)??l,this._$Em=null}}requestUpdate(e,t,s,i=!1,n){if(e!==void 0){let o=this.constructor;if(i===!1&&(n=this[e]),s??=o.getPropertyOptions(e),!((s.hasChanged??ht)(n,t)||s.useDefault&&s.reflect&&n===this._$Ej?.get(e)&&!this.hasAttribute(o._$Eu(e,s))))return;this.C(e,t,s)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(e,t,{useDefault:s,reflect:i,wrapped:n},o){s&&!(this._$Ej??=new Map).has(e)&&(this._$Ej.set(e,o??t??this[e]),n!==!0||o!==void 0)||(this._$AL.has(e)||(this.hasUpdated||s||(t=void 0),this._$AL.set(e,t)),i===!0&&this._$Em!==e&&(this._$Eq??=new Set).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}let e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[i,n]of this._$Ep)this[i]=n;this._$Ep=void 0}let s=this.constructor.elementProperties;if(s.size>0)for(let[i,n]of s){let{wrapped:o}=n,l=this[i];o!==!0||this._$AL.has(i)||l===void 0||this.C(i,void 0,n,l)}}let e=!1,t=this._$AL;try{e=this.shouldUpdate(t),e?(this.willUpdate(t),this._$EO?.forEach(s=>s.hostUpdate?.()),this.update(t)):this._$EM()}catch(s){throw e=!1,this._$EM(),s}e&&this._$AE(t)}willUpdate(e){}_$AE(e){this._$EO?.forEach(t=>t.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&=this._$Eq.forEach(t=>this._$ET(t,this[t])),this._$EM()}updated(e){}firstUpdated(e){}};E.elementStyles=[],E.shadowRootOptions={mode:"open"},E[J("elementProperties")]=new Map,E[J("finalized")]=new Map,ls?.({ReactiveElement:E}),(te.reactiveElementVersions??=[]).push("2.1.2");var Ae=globalThis,pt=r=>r,se=Ae.trustedTypes,ut=se?se.createPolicy("lit-html",{createHTML:r=>r}):void 0,Pe="$lit$",C=`lit$${Math.random().toFixed(9).slice(2)}$`,Le="?"+C,cs=`<${Le}>`,M=document,q=()=>M.createComment(""),F=r=>r===null||typeof r!="object"&&typeof r!="function",Me=Array.isArray,vt=r=>Me(r)||typeof r?.[Symbol.iterator]=="function",ke=`[ 	
\f\r]`,V=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,gt=/-->/g,mt=/>/g,P=RegExp(`>|${ke}(?:([^\\s"'>=/]+)(${ke}*=${ke}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),bt=/'/g,ft=/"/g,xt=/^(?:script|style|textarea|title)$/i,Ne=r=>(e,...t)=>({_$litType$:r,strings:e,values:t}),c=Ne(1),Es=Ne(2),Cs=Ne(3),_=Symbol.for("lit-noChange"),v=Symbol.for("lit-nothing"),yt=new WeakMap,L=M.createTreeWalker(M,129);function wt(r,e){if(!Me(r)||!r.hasOwnProperty("raw"))throw Error("invalid template strings array");return ut!==void 0?ut.createHTML(e):e}var $t=(r,e)=>{let t=r.length-1,s=[],i,n=e===2?"<svg>":e===3?"<math>":"",o=V;for(let l=0;l<t;l++){let a=r[l],h,g,d=-1,u=0;for(;u<a.length&&(o.lastIndex=u,g=o.exec(a),g!==null);)u=o.lastIndex,o===V?g[1]==="!--"?o=gt:g[1]!==void 0?o=mt:g[2]!==void 0?(xt.test(g[2])&&(i=RegExp("</"+g[2],"g")),o=P):g[3]!==void 0&&(o=P):o===P?g[0]===">"?(o=i??V,d=-1):g[1]===void 0?d=-2:(d=o.lastIndex-g[2].length,h=g[1],o=g[3]===void 0?P:g[3]==='"'?ft:bt):o===ft||o===bt?o=P:o===gt||o===mt?o=V:(o=P,i=void 0);let p=o===P&&r[l+1].startsWith("/>")?" ":"";n+=o===V?a+cs:d>=0?(s.push(h),a.slice(0,d)+Pe+a.slice(d)+C+p):a+C+(d===-2?l:p)}return[wt(r,n+(r[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),s]},W=class r{constructor({strings:e,_$litType$:t},s){let i;this.parts=[];let n=0,o=0,l=e.length-1,a=this.parts,[h,g]=$t(e,t);if(this.el=r.createElement(h,s),L.currentNode=this.el.content,t===2||t===3){let d=this.el.content.firstChild;d.replaceWith(...d.childNodes)}for(;(i=L.nextNode())!==null&&a.length<l;){if(i.nodeType===1){if(i.hasAttributes())for(let d of i.getAttributeNames())if(d.endsWith(Pe)){let u=g[o++],p=i.getAttribute(d).split(C),y=/([.?@])?(.*)/.exec(u);a.push({type:1,index:n,name:y[2],strings:p,ctor:y[1]==="."?re:y[1]==="?"?ne:y[1]==="@"?oe:R}),i.removeAttribute(d)}else d.startsWith(C)&&(a.push({type:6,index:n}),i.removeAttribute(d));if(xt.test(i.tagName)){let d=i.textContent.split(C),u=d.length-1;if(u>0){i.textContent=se?se.emptyScript:"";for(let p=0;p<u;p++)i.append(d[p],q()),L.nextNode(),a.push({type:2,index:++n});i.append(d[u],q())}}}else if(i.nodeType===8)if(i.data===Le)a.push({type:2,index:n});else{let d=-1;for(;(d=i.data.indexOf(C,d+1))!==-1;)a.push({type:7,index:n}),d+=C.length-1}n++}}static createElement(e,t){let s=M.createElement("template");return s.innerHTML=e,s}};function N(r,e,t=r,s){if(e===_)return e;let i=s!==void 0?t._$Co?.[s]:t._$Cl,n=F(e)?void 0:e._$litDirective$;return i?.constructor!==n&&(i?._$AO?.(!1),n===void 0?i=void 0:(i=new n(r),i._$AT(r,t,s)),s!==void 0?(t._$Co??=[])[s]=i:t._$Cl=i),i!==void 0&&(e=N(r,i._$AS(r,e.values),i,s)),e}var ie=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:s}=this._$AD,i=(e?.creationScope??M).importNode(t,!0);L.currentNode=i;let n=L.nextNode(),o=0,l=0,a=s[0];for(;a!==void 0;){if(o===a.index){let h;a.type===2?h=new H(n,n.nextSibling,this,e):a.type===1?h=new a.ctor(n,a.name,a.strings,this,e):a.type===6&&(h=new ae(n,this,e)),this._$AV.push(h),a=s[++l]}o!==a?.index&&(n=L.nextNode(),o++)}return L.currentNode=M,i}p(e){let t=0;for(let s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(e,s,t),t+=s.strings.length-2):s._$AI(e[t])),t++}},H=class r{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,s,i){this.type=2,this._$AH=v,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=s,this.options=i,this._$Cv=i?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=N(this,e,t),F(e)?e===v||e==null||e===""?(this._$AH!==v&&this._$AR(),this._$AH=v):e!==this._$AH&&e!==_&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):vt(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==v&&F(this._$AH)?this._$AA.nextSibling.data=e:this.T(M.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:s}=e,i=typeof s=="number"?this._$AC(e):(s.el===void 0&&(s.el=W.createElement(wt(s.h,s.h[0]),this.options)),s);if(this._$AH?._$AD===i)this._$AH.p(t);else{let n=new ie(i,this),o=n.u(this.options);n.p(t),this.T(o),this._$AH=n}}_$AC(e){let t=yt.get(e.strings);return t===void 0&&yt.set(e.strings,t=new W(e)),t}k(e){Me(this._$AH)||(this._$AH=[],this._$AR());let t=this._$AH,s,i=0;for(let n of e)i===t.length?t.push(s=new r(this.O(q()),this.O(q()),this,this.options)):s=t[i],s._$AI(n),i++;i<t.length&&(this._$AR(s&&s._$AB.nextSibling,i),t.length=i)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){let s=pt(e).nextSibling;pt(e).remove(),e=s}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},R=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,s,i,n){this.type=1,this._$AH=v,this._$AN=void 0,this.element=e,this.name=t,this._$AM=i,this.options=n,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=v}_$AI(e,t=this,s,i){let n=this.strings,o=!1;if(n===void 0)e=N(this,e,t,0),o=!F(e)||e!==this._$AH&&e!==_,o&&(this._$AH=e);else{let l=e,a,h;for(e=n[0],a=0;a<n.length-1;a++)h=N(this,l[s+a],t,a),h===_&&(h=this._$AH[a]),o||=!F(h)||h!==this._$AH[a],h===v?e=v:e!==v&&(e+=(h??"")+n[a+1]),this._$AH[a]=h}o&&!i&&this.j(e)}j(e){e===v?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},re=class extends R{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===v?void 0:e}},ne=class extends R{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==v)}},oe=class extends R{constructor(e,t,s,i,n){super(e,t,s,i,n),this.type=5}_$AI(e,t=this){if((e=N(this,e,t,0)??v)===_)return;let s=this._$AH,i=e===v&&s!==v||e.capture!==s.capture||e.once!==s.once||e.passive!==s.passive,n=e!==v&&(s===v||i);i&&this.element.removeEventListener(this.name,this,s),n&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},ae=class{constructor(e,t,s){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(e){N(this,e)}},St={M:Pe,P:C,A:Le,C:1,L:$t,R:ie,D:vt,V:N,I:H,H:R,N:ne,U:oe,B:re,F:ae},ds=Ae.litHtmlPolyfillSupport;ds?.(W,H),(Ae.litHtmlVersions??=[]).push("3.3.2");var _t=(r,e,t)=>{let s=t?.renderBefore??e,i=s._$litPart$;if(i===void 0){let n=t?.renderBefore??null;s._$litPart$=i=new H(e.insertBefore(q(),n),n,void 0,t??{})}return i._$AI(r),i};var Re=globalThis,f=class extends E{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=_t(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return _}};f._$litElement$=!0,f.finalized=!0,Re.litElementHydrateSupport?.({LitElement:f});var hs=Re.litElementPolyfillSupport;hs?.({LitElement:f});(Re.litElementVersions??=[]).push("4.2.2");var ps=b`
...
`];var ce=726,de=r=>`v${Math.floor(r/100)}.${String(r%100).padStart(2,"0")}`,U="https://scoreboard-tailuge.vercel.app",K=typeof localStorage<"u"&&localStorage.getItem("useProxy")==="true"?"nchanproxy.tailuge.workers.dev":"billiards-network.onrender.com",he=typeof window<"u"&&(window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1"),Ue=he?`ws://${window.location.hostname}:80`:`wss://${K}`,Mt=he?"./active.html":"https://billiards-network.onrender.com/active.html",T=typeof window<"u"&&window.location.hostname.includes("vercel"),Nt=r=>{let e=Math.floor((Date.now()-r)/1e3);if(e<60)return`${e}s ago`;let t=Math.floor(e/60);if(t<60)return`${t}m ago`;let s=Math.floor(t/60);return s<24?`${s}h ago`:`${Math.floor(s/24)}d ago`},Rt={connected:!1,users:[],challenges:{},currentMatch:null};function Ut(r,e){let t={...r.challenges},s=i=>i.challengerId===e.myId?i.challengeeId:i.challengerId;switch(e.type){case"CONNECTED":return{...r,connected:e.payload};case"SETTLED":return{...r,settled:e.payload};case"USERS_UPDATE":return{...r,users:e.payload};case"CHALLENGE_SENT":return{...r,challenges:{...t,[e.payload.challengeeId]:{...e.payload,status:"pending"}}};case"CHALLENGE_MSG":{let i=e.payload,n=s(i);if(i.type==="offer"){if(r.currentMatch)return r;let o=t[i.challengerId];if(o&&o.challengerId===e.myId&&o.status==="pending"&&e.myId>i.challengerId)return r;(!t[i.challengerId]||t[i.challengerId].tableId!==i.tableId)&&(t[i.challengerId]={...i,status:"pending"})}else if(i.type==="accept"&&!r.currentMatch){let o=t[n];if(!o||o.tableId!==i.tableId)return r;let l=i.options||o.options,a=i.nextTurnId||o.nextTurnId,h=e.myId===i.challengerId,g=h?i.challengeeId:i.challengerId,d=h?i.custom||{}:o.custom||{},u=h?o.recipientName:o.challengerName;return delete t[n],{...r,challenges:t,currentMatch:{tableId:i.tableId,ruleType:i.ruleType,options:l,isFirst:a===i.challengerId||a===i.challengeeId?a===e.myId:i.challengerId===e.myId,opponentId:g,opponentName:u,opponentCustom:d}}}else i.type==="decline"?t[i.challengeeId]&&(t[i.challengeeId]={...t[i.challengeeId],status:"declined"}):i.type==="cancel"&&delete t[s(i)];return{...r,challenges:t}}case"CHALLENGE_DISMISS":return delete t[e.payload],{...r,challenges:t};default:return r}}function je(r="",e="",t="",s={}){let i={bot:{emoji:"\u{1F916}",title:"bot"},nineball:{emoji:"\u2468",title:"nineball"},eightball:{emoji:"\u{1F3B1}",title:"eightball"},snooker:{emoji:"\u{1F534}",title:"snooker"},threecushion:{emoji:"\u2462",title:"threecushion"},sagu:{emoji:"\u2463",title:"sagu"}},n=i[e],o=["5","6"].includes(String(s?.tableSize)),l=a=>o?{emoji:a.emoji+"\u{1F37C}",title:"mini"}:a;if(t==="spectating")return{emoji:"\u{1F52D}",title:"spectator"};if(t==="playing")return l(n??{emoji:"\u{1F3AE}",title:"playing"});if(t==="available"&&e==="replay")return{emoji:"\u{1F440}",title:"replay"};if(n)return r.includes("veli")?l({emoji:"\u{1F393}",title:"study"}):r.includes("github")?l({emoji:n.emoji+"\u{1F419}",title:"github"}):r.includes("localhost")?l({emoji:n.emoji+"\u{1F3E0}",title:"localhost"}):l(n);if(e.includes("-bot")){let a=i[e.replace("-bot","")];if(a)return l({emoji:a.emoji+"\u{1F916}",title:"bot"})}if(e.includes("-exam")){let a=i[e.replace("-exam","")];if(a)return l({emoji:a.emoji+"\u{1F4DC}",title:"exam"})}if(e.includes("-speedrun")){let a=i[e.replace("-speedrun","")];if(a)return l({emoji:a.emoji+"\u{1F45F}",title:"speedrun"})}return r.includes("github")?{emoji:"\u{1F419}",title:"github"}:r.includes("vercel")?{emoji:"\u{1F465}",title:"vercel"}:r.includes("workers")?{emoji:"\u{1F464}",title:"vercel"}:r.includes("localhost")?{emoji:"\u{1F3E0}",title:"localhost"}:i[e]??{emoji:"\u{1F3AE}",title:"external"}}var I=r=>{if(r==="BOT")return{emoji:"\u{1F916}",title:"BOT"};if(!r)return{emoji:"\u{1F310}",title:""};let e=r.toUpperCase();return{emoji:[...e].map(s=>String.fromCodePoint(127397+s.charCodeAt(0))).join(""),title:e}},Oe=he?`http://${window.location.hostname}:8080/`:"https://billiards.tailuge.workers.dev/",He=(r,e)=>e?Object.entries(e).reduce((t,[s,i])=>t+`&${encodeURIComponent(s)}=${encodeURIComponent(i)}`,r):r,jt=(r,e,t,s,i)=>{if(r.absolute)return r.url;let n=r.url?`${r.url}?userId=${encodeURIComponent(e)}&userName=${encodeURIComponent(t)}&lod=${s}`:`${Oe}?ruletype=${r.ruletype}&userId=${encodeURIComponent(e)}&userName=${encodeURIComponent(t)}&lod=${s}`;return he&&(n+=`&lobbyUrl=${Ue}`),i&&(n+="&flip=true"),r.url?n:He(n,r.options)},De=({tableId:r,userId:e,userName:t,ruleType:s,isFirst:i,options:n,bot:o,lod:l,flip:a,custom:h,opponent:g})=>{let d=`${Oe}?websocketserver=${Ue}&userName=${encodeURIComponent(t)}&userId=${e}&ruletype=${s}`;if(o||(d+=`&tableId=${r}`),i&&(d+="&first=true"),o&&(d+=`&bot=${encodeURIComponent(o)}`),l!==void 0&&(d+=`&lod=${l}`),a&&(d+="&flip=true"),d=He(d,n),h)for(let[u,p]of Object.entries(h))d+=`&custom.${encodeURIComponent(u)}=${encodeURIComponent(p)}`;if(g?.userId&&(d+=`&opponent.userId=${encodeURIComponent(g.userId)}&opponent.userName=${encodeURIComponent(g.userName||"")}`,g.custom))for(let[u,p]of Object.entries(g.custom))d+=`&opponent.custom.${encodeURIComponent(u)}=${encodeURIComponent(p)}`;return d},Ot=({tableId:r,userId:e,userName:t,ruleType:s,options:i})=>{let n=`${Oe}?websocketserver=${Ue}&tableId=${r}&userName=${encodeURIComponent(t)}&userId=${e}&ruletype=${s}&spectator=true`;return He(n,i)},us={eightball:"eightball",snooker:"snooker",threecushion:"threecushion",nineball:"nineball",sagu:"sagu"},j=r=>{let e=us[r];return e?c`<img src="assets/${e}.png" alt="${r}" title="${r}" width="18" height="18" style="vertical-align:middle">`:c`🎱`},ze=r=>["\u{1F3C6}","\u{1F948}","\u{1F949}","\u{1F396}\uFE0F"][r]??"",Be=(r,e,t)=>`${r}&userId=${encodeURIComponent(e)}&userName=${encodeURIComponent(t)}`;var Ht=r=>{let e=(r||"user").slice(0,4),t=/Tauri/i.test(navigator.userAgent)?"-t-":"-";return e+t+Math.random().toString(36).slice(2,7)},Ge=class extends EventTarget{constructor(){super();let e=new URLSearchParams(window.location.search),t=(e.get("userId")||"").trim(),s=(e.get("userName")||"").trim();T&&(localStorage.removeItem("userId"),localStorage.removeItem("userName"),localStorage.removeItem("custom"));let i=(localStorage.getItem("userId")||"").trim(),n=(localStorage.getItem("userName")||"").trim();if(t.length>2)this.clientId=t,this.isForcedId=!0;else if(window.self!==window.top&&(location.hostname==="localhost"||location.hostname==="127.0.0.1")&&window.name.includes("-"))this.clientId=window.name,this.isForcedId=!0,s||(this.userName=window.name.split("-")[0]);else{let l=s||n||"",a=!l||i.split("-")[0].slice(0,4)===l.slice(0,4);this.clientId=i.length>2&&!i.startsWith("user-")&&a?i:Ht(l),this.isForcedId=!1,this.clientId!==i&&localStorage.setItem("userId",this.clientId)}this.userName=s||this.userName||n||"Anonymous",this.lod=localStorage.getItem("lod")||"2",this.flip=localStorage.getItem("flip")==="true",this.useProxy=localStorage.getItem("useProxy")==="true";try{this.custom=JSON.parse(localStorage.getItem("custom"))||{}}catch{this.custom={}}console.log("UserStore identity:",this.userName,this.clientId)}setUseProxy(e){this.useProxy=!!e,localStorage.setItem("useProxy",this.useProxy),this.dispatchEvent(new Event("change")),window.location.reload()}set(e,t){this.clientId=e.trim().length>2?e.trim():Ht(t),this.userName=t.trim(),localStorage.setItem("userId",this.clientId),localStorage.setItem("userName",this.userName),this.dispatchEvent(new Event("change"))}setLod(e){this.lod=e,localStorage.setItem("lod",e),this.dispatchEvent(new Event("change"))}setFlip(e){this.flip=!!e,localStorage.setItem("flip",this.flip),this.dispatchEvent(new Event("change"))}getCustom(){return{...this.custom}}setCustom(e,t){this.custom={...this.custom,[e]:t},localStorage.setItem("custom",JSON.stringify(this.custom)),this.dispatchEvent(new Event("change"))}},m=new Ge,S=class extends f{connectedCallback(){super.connectedCallback(),this._storeListener=()=>this.requestUpdate(),m.addEventListener("change",this._storeListener)}disconnectedCallback(){super.disconnectedCallback(),m.removeEventListener("change",this._storeListener)}};var gs=[{label:"Nine Ball",img:"assets/nineball.png",ruletype:"nineball"},{label:"Snooker 6r",img:"assets/snooker.png",ruletype:"snooker",options:{reds:"6",tableSize:"12"}},{label:"Snooker 10r",img:"assets/snooker.png",ruletype:"snooker",options:{reds:"10",tableSize:"12"}},{label:"3-Cushion 5ft",img:"assets/baby.png",ruletype:"threecushion",options:{raceTo:"15",tableSize:"5"}},{label:"Snooker",img:"assets/snooker.png",ruletype:"snooker",options:{reds:"15",tableSize:"12"}},{label:"3-Cushion (7)",img:"assets/threecushion.png",ruletype:"threecushion",options:{raceTo:"7"}},{label:"Speedrun",img:"assets/speedrun.png",url:"speedrun/index.html"},{label:"3-Cushion analysis",img:"assets/drill.png",url:"https://velikodimov.github.io/billiards/dist/index.html?ruletype=threecushion&practice&drill",absolute:!0},{label:"Books",img:"assets/book.png",url:"book/index.html"},{label:"3-Cushion (40)",img:"assets/threecushion.png",ruletype:"threecushion",options:{raceTo:"40"}},{label:"3-Cushion (15)",img:"assets/threecushion.png",ruletype:"threecushion",options:{raceTo:"15"}},{label:"Sagu (5)",img:"assets/sagu.png",ruletype:"sagu",options:{raceTo:"5"}},{label:"Trickshot",img:"assets/practice.png",url:"https://billiards.tailuge.workers.dev/practice"},{label:"Research",img:"assets/research.png",url:"https://billiards.tailuge.workers.dev/diagrams/three"},{label:"Eight Ball",img:"assets/eightball.png",ruletype:"eightball"},{label:"Exam",img:"assets/cert.png",url:"exam/index.html",absolute:!0}],Ye=class extends S{static styles=[kt,le];#e=[...gs].sort(()=>Math.random()-.5);render(){let{clientId:e,userName:t,lod:s,flip:i}=m;return c`<div class="grid">
      ${this.#e.map(n=>c` <a
            href=${jt(n,e,t,s,i)}
            title=${n.label}
    ...
    </div>`}};customElements.define("solo-panel",Ye);var Je=class extends f{static properties={url:{type:String},color:{type:String},label:{type:String},prefix:{type:String},prefixTitle:{type:String}};static styles=b`
        :host {
    ...
    `;render(){let e=this.color?`background-color: ${this.color}`:"",t=this.prefix?c`<span class="prefix" title=${this.prefixTitle}>${this.prefix}</span>`:"";return c`
        ...
        `}};customElements.define("replay-button",Je);var Ve=class extends S{static styles=At;connectedCallback(){if(super.connectedCallback(),T){this.classList.add("loaded");return}fetch(`${U}/api/summary`,{mode:"cors"}).then(e=>e.json()).then(e=>{this._data=e,this.classList.add("loaded"),this.requestUpdate()}).catch(()=>{this._err=!0,this.classList.add("loaded"),this.requestUpdate()})}render(){if(T)return c`<span class="loading">We have moved <a href="https://billiards.tailuge.workers.dev/lobby">Play online here</a></span>`;if(this._err)return c`<span class="loading">Could not load scores.</span>`;if(!this._data)return c`<span class="loading">Connecting to server…</span>`;let{hiscores:e,topPlayers:t,recentMatches:s}=this._data,i=Object.keys(e);return c`
            <div class="group hiscores">
                <div class="group-body">
                    ${i.map(n=>c`
                        <div class="tbl${n==="sagu"?" sagu-hi":""}"><table><caption><a href="${U}/leaderboard" target="_blank" rel="noopener" style="font-weight:200;font-size:0.75rem">${j(n)} HiScore</a></caption>
                        <tr><th>Name</th><th></th></tr>
                            ${e[n].slice(0,4).map((o,l)=>c`<tr><td>${ze(l)} ${o.name}</td><td><replay-button url="${Be(`${U}/api/rank/${o.id}?ruletype=${n}&lod=${m.lod}`,m.clientId,m.userName)}" label="${o.score}"></replay-button></td></tr>`)}
                        </table></div>
                    `)}
                </div>
            </div>
                ...
                <div class="group recent">
                    <div class="group-body">
                        ...
                        <tr><th>Rule</th><th>Match</th><th>Ago</th><th class="city-col">City</th><th></th></tr>
                            ${s.map(n=>c`<tr>
                                <td>${j(n.ruleType)}</td><td>${n.loser?"\u{1F396}\uFE0F":""}${n.winner}${n.winnerScore!=null?c`<span class="score">(${n.winnerScore})</span>`:""}${n.loser?c` vs ${n.loser}${n.loserScore!=null?c`<span class="score">(${n.loserScore})</span>`:""}`:""}</td>
                                <td class="ago">${Nt(n.timestamp)}</td>
                                <td class="city-col">${n.locationCity??""}</td>
<td class="replay-col">
                                    ${n.hasReplay?c`<replay-button prefix="${I(n.locationCountry).emoji}" prefixTitle="${I(n.locationCountry).title}" url="${Be(`${U}/api/match-replay?id=${n.id}&lod=${m.lod}`,m.clientId,m.userName)}"></replay-button>`:I(n.locationCountry).emoji}
                                </td>
                            </tr>`)}
                        </table></div>
                    </div>
                ...
                <div class="group top-players">
                    <div class="group-body">
                        ${i.map(n=>c`
                            <div class="tbl"><table><caption><a href="${U}/elo" target="_blank" rel="noopener">${j(n)} <span style="font-size:0.75rem;font-weight:200">Rankings</span></a></caption>
                             <tr><th>Name</th><th>Score</th><th>W</th><th>L</th></tr>
                                 ${t[n].slice(0,4).map((o,l)=>c`<tr>
                                     <td><a href="${U}/player/${encodeURIComponent(o.name)}?ruleType=${n}">${ze(l)} ${o.name}</a></td>
    ...
    `];async autoExpandIfSupported(){if(this.#e)return;if((this.slots||[]).filter(t=>t.status==="online").length>4){await this.updateComplete;let t=this.renderRoot.querySelector(".expand-toggle");t&&getComputedStyle(t).visibility!=="hidden"&&(this.#e=!0,G(this,"user-list-toggle",{expanded:this.#e}),this.requestUpdate())}}updated(){if(!this.#e)return;let e=this.renderRoot.querySelector("ul");if(!e)return;let t=e.scrollHeight;t>0&&e.style.setProperty("--ul-expanded-height",t+"px")}#s(){this.#e=!this.#e,G(this,"user-list-toggle",{expanded:this.#e}),this.requestUpdate()}render(){let e=this.slots||[];if(e.filter(i=>i.status==="online").length===0)return c`<div class="empty">No other players online yet. Invite a friend!</div>`;let s=new Set(ge(this.users||[]).filter(i=>i.players.length>1).map(i=>i.tableId));return c`
            ...
            <div class="expand-toggle" @click=${this.#s}>
                ...
                </li>`}return this._row(e.user,s)}_row(e,t){let s=this.pendingChats?.get(e.userId)>0,n=!(this.challenges?.[e.userId]?.challengerId===e.userId)&&(e.isBot||zt(e,this.myId)),o=!e.isBot&&ue(e)==="playing"&&Bt(e,this.tableId)&&t.has(e.tableId),l=je(e.meta?.origin??"",e.ruleType??"",ue(e),e.options),a=s?c`<button class="btn-chat" aria-label="Unread message from ${e.userName}" @click=${()=>G(this,"open-chat",e.userId)}>💬</button>`:o?c`<button class="btn-spectate" aria-label="Spectate ${e.userName}'s game" @click=${()=>G(this,"spectate",e)}>Spectate</button>`:n?c`<button class="btn-challenge" aria-label="Challenge ${e.userName}" ?disabled=${this.isChallengePending} @click=${()=>T?window.location.href="https://billiards.tailuge.workers.dev/lobby":G(this,"challenge",e.userId)}>Challenge</button>`:c``;return c`
            <li aria-label="${e.userName}">
                <div class="user-info">
                    <span class="user-name" @click=${()=>G(this,"open-chat",e.userId)} style="cursor: pointer"><span title="${I(e.meta?.country).title}">${I(e.meta?.country).emoji}</span> ${e.userName} <span aria-label="${l.title}" role="img">${l.emoji}</span></span>
                </div>
                <div class="actions">${a}</div>
            </li>`}};customElements.define("user-list",We);var Se=(r,e,t)=>r.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0})),Ke=class extends f{static properties={lobby:{type:Object},targetId:{type:String},targetName:{type:String},_messages:{state:!0},_unread:{state:!0}};static styles=[x,k,b`
    ...
    `];constructor(){super(),this._messages=new Map,this._unread=new Map,this._lobbyBound=!1}willUpdate(e){e.has("lobby")&&this.lobby&&!this._lobbyBound&&(this._lobbyBound=!0,this.lobby.onChat(t=>{let s=t.senderId,i=[...this._messages.get(s)??[],t];if(this._messages=new Map(this._messages).set(s,i),s!==this.targetId){let n=(this._unread.get(s)??0)+1;this._unread=new Map(this._unread).set(s,n),Se(this,"unread-changed",{userId:s,count:n})}this.requestUpdate()})),e.has("targetId")&&this.targetId&&this._unread.has(this.targetId)&&(this._unread=new Map(this._unread).set(this.targetId,0),Se(this,"unread-changed",{userId:this.targetId,count:0}))}_send(e){e.preventDefault();let t=this.shadowRoot.querySelector("input"),s=t.value.trim();if(!s||!this.lobby||!this.targetId)return;this.lobby.sendChat(this.targetId,s);let n={messageType:"chat",senderId:this.lobby.currentUser.userId,recipientId:this.targetId,text:s},o=[...this._messages.get(this.targetId)??[],n];this._messages=new Map(this._messages).set(this.targetId,o),t.value="",this.requestUpdate()}updated(e){if(e.has("targetId")){let t=this.shadowRoot.querySelector(".thread");t&&(t.scrollTop=t.scrollHeight);let s=this.shadowRoot.querySelector("input");s&&s.focus()}else if(e.has("_messages")){let t=e.get("_messages");if(this._messages.get(this.targetId)!==t?.get(this.targetId)){let s=this.shadowRoot.querySelector(".thread");s&&(s.scrollTop=s.scrollHeight)}}}render(){if(!this.targetId)return c``;let e=this.lobby?.currentUser?.userId,t=this._messages.get(this.targetId)??[];return c`
            ...
            </div>`}};customElements.define("message-modal",Ke);var _e=(r,e,t)=>r.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0})),fs={raceTo:"Race to",reds:"Reds",shotClock:"Shot clock",collaboration:"Collaboration",practice:"Practice"},Kt=(r,e)=>r?Object.entries(r).filter(([,t])=>!(typeof t=="boolean"&&t===!1)).map(([t,s])=>{if(t.startsWith("handicap_")){let n=t.slice(9),o=e&&n===e?"Your handicap":"Handicap";return typeof s=="boolean"?o:`${o}: ${s}`}let i=fs[t]??t;return typeof s=="boolean"?i:`${i}: ${s}`}):[],Qe=class extends f{static properties={challenge:{type:Object},sent:{type:Object},myId:{type:String}};static styles=[x,Et,Ct];render(){return this.challenge?this._incoming(this.challenge):this.sent?this._sent(this.sent):c``}_incoming(e){let t={...e.options};if(Object.keys(t).some(i=>i.startsWith("handicap_"))){let i=localStorage.getItem(`handicap_${e.ruleType}`)||"15";t["handicap_"+this.myId]=i}let s=Kt(t,this.myId);return c`
            <div class="banner">
                <div class="details">${j(e.ruleType)} ${e.ruleType}</div>
            ...
            </div>`}_sent(e){let t=e.status==="pending",s=Kt(e.options,this.myId);return c`
            ...
            </div>`}};customElements.define("challenge-banner",Qe);var Ie=(r,e,t)=>r.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0})),Xe=class r extends f{static properties={userId:{type:String},userName:{type:String},_expanded:{state:!0},_handicap:{state:!0}};static styles=[x,k,le];static SECTIONS=[{key:"eightball",label:"Eight Ball",img:"assets/eightball.png",rules:[{id:"eightball",label:"Eight Ball",img:"assets/eightball.png"}]},{key:"nineball",label:"Nine Ball",img:"assets/nineball.png",rules:[{id:"nineball",label:"Nine Ball",img:"assets/nineball.png"}]},{key:"snooker",label:"Snooker",img:"assets/snooker.png",rules:[{id:"snooker",label:"3 reds",img:"assets/baby.png",options:{reds:"3",tableSize:"6"}},{id:"snooker",label:"6 reds",img:"assets/snooker.png",options:{reds:"6",tableSize:"12"}},{id:"snooker",label:"10 reds",img:"assets/snooker.png",options:{reds:"10",tableSize:"12"}},{id:"snooker",label:"15 reds",img:"assets/snooker.png",options:{reds:"15",tableSize:"12"}}]},{key:"threecushion",label:"Three Cushion",img:"assets/threecushion.png",rules:[{id:"threecushion",label:"Small Table (15)",img:"assets/baby.png",options:{raceTo:"15",collaboration:!0,shotClock:"60",tableSize:"5"}},{id:"threecushion",label:"Race to 7",img:"assets/threecushion.png",options:{raceTo:"7"}},{id:"threecushion",label:"Race to 25",img:"assets/threecushion.png",options:{raceTo:"25"}},{id:"threecushion",label:"Collaboration (15)",img:"assets/threecushion.png",options:{raceTo:"15",collaboration:!0,shotClock:"60"}},{id:"threecushion",label:"Traditional (10)",img:"assets/threecushion.png",options:{raceTo:"10",practice:!1,shotClock:"45"}},{id:"threecushion",label:"Handicap",img:"assets/threecushion.png",options:{handicap:!0}}]},{key:"sagu",label:"Sagu",img:"assets/sagu.png",rules:[{id:"sagu",label:"Small Table (5)",img:"assets/baby.png",options:{raceTo:"5",tableSize:"5"}},{id:"sagu",label:"Race to 11",img:"assets/sagu.png",options:{raceTo:"11"}},{id:"sagu",label:"Handicap",img:"assets/sagu.png",options:{handicap:!0}}]}];constructor(){super(),this._expanded=null,this._handicap=15}_loadHandicap(e){let t=localStorage.getItem(`handicap_${e}`);if(t!==null){let s=parseInt(t,10);if(!isNaN(s)&&s>=5&&s<=30){this._handicap=s;return}}this._handicap=15}_onHandicapChange(e){let t=parseInt(e.target.value,10);this._handicap=t,this._expanded&&localStorage.setItem(`handicap_${this._expanded}`,String(t))}_toggle(e){let t=this._expanded===e;this._expanded=t?null:e,t||r.SECTIONS.find(i=>i.key===e)?.rules.some(i=>i.options?.handicap===!0)&&this._loadHandicap(e)}render(){return this.userId?c`
            ...
            </div>`:c``}};customElements.define("challenge-modal",Xe);var Qt=[{userId:"bot-clawbreak",userName:"ClawBreak",isBot:!0,meta:{country:"BOT"}},{userId:"bot-thefarjaw",userName:"TheFarJaw",isBot:!0,meta:{country:"BOT"}}],Ze=class extends f{static styles=[x,Pt];#e={...Rt,settled:!1};#s=null;#t;#r;#c;#o=null;#a=null;#h=new Map;#b=new ve;#i=null;#d=!1;constructor(){super(),this.#t=m.clientId,this.#r=m.userName;let e=new URLSearchParams(location.search),t=e.get("opponent.userId");if(t){let i={},n=e.get("tableSize")||e.get("tablesize");n&&(i.tableSize=n);let o=e.get("raceTo")||e.get("raceto");o&&(i.raceTo=o);let l=e.get("shotClock")||e.get("shotclock");l&&(i.shotClock=l);let a=e.get("reds");a&&(i.reds=a),this.#i={opponentId:t,opponentName:e.get("opponent.userName")||t,ruleType:e.get("ruletype")||"nineball",nextTurnId:e.get("nextTurnId"),options:Object.keys(i).length>0?i:void 0};let h=new URL(location.href);h.searchParams.delete("opponent.userId"),h.searchParams.delete("opponent.userName");let g=[];for(let d of h.searchParams.keys())(d.startsWith("opponent.")||d.startsWith("custom."))&&g.push(d);for(let d of g)h.searchParams.delete(d);h.searchParams.delete("ruletype"),h.searchParams.delete("nextTurnId"),h.searchParams.delete("tableSize"),h.searchParams.delete("tablesize"),h.searchParams.delete("raceTo"),h.searchParams.delete("raceto"),h.searchParams.delete("shotClock"),h.searchParams.delete("shotclock"),h.searchParams.delete("reds"),history.replaceState(null,"",h)}let s=`https://${K}`;(location.hostname==="localhost"||location.hostname==="127.0.0.1")&&(s=`${location.protocol==="https:"?"https:":"http:"}//${location.host}`),this.#c=new ye({baseUrl:s}),this.#c.setVersion(de(ce))}connectedCallback(){super.connectedCallback(),this._onUserChanged=e=>{this.#t=e.detail.userId,this.#r=e.detail.userName,this.#s?this.#s.updatePresence({userId:this.#t,userName:this.#r}).catch(t=>console.error("Failed to update presence:",t)):this._connect().catch(t=>console.error("Lobby connect failed:",t))},document.addEventListener("user-name-changed",this._onUserChanged),this._connect().catch(e=>console.error("Lobby connect failed:",e))}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("user-name-changed",this._onUserChanged),this.#s?.leave()}dispatch(e){this.#e=Ut(this.#e,{...e,myId:this.#t}),e.type==="CHALLENGE_MSG"&&this.#$(e.payload),this.requestUpdate()}#w(){if(!this.#i||!this.#e.connected)return;let e=this.#i.opponentId;!this.#n&&this.#e.users.some(t=>t.userId===e)&&this.#x(e,this.#i.ruleType,this.#i.options,this.#i.nextTurnId)}#$(e){if(this.#i&&(e.challengerId===this.#i.opponentId||e.challengeeId===this.#i.opponentId)&&(e.type==="decline"||e.type==="cancel")&&(this.#i=null),e.type==="offer"&&e.challengeeId===this.#t&&this.#i&&this.#i.opponentId===e.challengerId){let t=this.#i.nextTurnId;this.#i=null;let s=this.#n;s&&s.challengeeId===e.challengerId&&s.status==="pending"?this.#t<e.challengerId&&this.#m(e.challengerId,t).catch(i=>console.error("Simultaneous auto-accept failed:",i)):this.#m(e.challengerId,t).catch(i=>console.error("Auto-join accept failed:",i))}}get state(){return this.#e}get#f(){return this.#e.connected}get#p(){return this.#e.users}get#u(){return this.#e.currentMatch?.tableId}get#S(){return this.#e.currentMatch?.ruleType||"standard"}get#_(){return!!this.#e.currentMatch?.isFirst}get#I(){return this.#e.currentMatch?.options}get#y(){return this.#e.currentMatch?.opponentId}get#E(){return this.#e.currentMatch?.opponentName}get#C(){return this.#e.currentMatch?.opponentCustom}get#g(){return Object.values(this.#e.challenges).find(e=>e.challengeeId===this.#t&&e.status==="pending")}get#n(){return Object.values(this.#e.challenges).find(e=>e.challengerId===this.#t)}get#l(){return[...this.#p,...Qt]}get#v(){return this.#b.getSlots()}async _connect(){this.#s=await this.#c.joinLobby({messageType:"presence",type:"join",userId:this.#t,userName:this.#r}),this.dispatch({type:"CONNECTED",payload:!0}),this.#d=!1,this.dispatch({type:"SETTLED",payload:!1}),this.#s.onUsersChange(e=>{let t=[...e,...Qt].filter(s=>s.userId!==this.#t);this.#b.update(t),this.dispatch({type:"USERS_UPDATE",payload:e})}),this.#s.onChallenge(e=>{this.dispatch({type:"CHALLENGE_MSG",payload:e}),this.#s.settled&&e.type==="offer"&&e.challengeeId===this.#t&&document.hidden&&Notification.permission==="granted"&&new Notification("Challenge received!",{body:`${e.challengerName} challenged you to ${e.ruleType}`,icon:"assets/threecushion.png"})}),this.#s.onSettled(async()=>{this.#d=!0,this.dispatch({type:"SETTLED",payload:!0}),this.#w(),await this.updateComplete,this.renderRoot.querySelector("user-list")?.autoExpandIfSupported()})}async#x(e,t,s,i){this.#i&&this.#i.opponentId===e||(this.#i=null);let o=this.#l.find(a=>a.userId===e);if(o?.isBot){let a="bot-"+Math.random().toString(36).slice(2,8),h=!0;window.location.href=De({tableId:a,userId:this.#t,userName:this.#r,ruleType:t,isFirst:h,options:s,bot:o.userName,lod:m.lod,flip:m.flip,custom:m.getCustom()});return}let l=this.#s?await this.#s.challenge(e,t,s,i,m.getCustom()):"test-"+Math.random().toString(36).slice(2,7);Fe("createTable"),this.dispatch({type:"CHALLENGE_SENT",payload:{challengerId:this.#t,challengeeId:e,recipientName:o?.userName||e,ruleType:t,options:s,tableId:l,nextTurnId:i}})}async#T(){this.#i=null;let e=this.#n;e?.status==="pending"&&(this.#s&&await this.#s.cancelChallenge(e.challengeeId,e.ruleType),this.dispatch({type:"CHALLENGE_DISMISS",payload:e.challengeeId}))}async#m(e,t){let s=e?this.#e.challenges[e]:this.#g;if(!s)return;let i={...s.options};if(Object.keys(i).some(n=>n.startsWith("handicap_"))){let n=localStorage.getItem(`handicap_${s.ruleType}`)||"15";i["handicap_"+this.#t]=n}this.#s&&await this.#s.acceptChallenge(s.challengerId,s.ruleType,s.tableId,i,s.challengerName,t,m.getCustom()),Fe("joinTable"),this.dispatch({type:"CHALLENGE_MSG",payload:{type:"accept",challengerId:s.challengerId,challengerName:s.challengerName,challengeeId:this.#t,ruleType:s.ruleType,tableId:s.tableId,options:i,nextTurnId:t,custom:m.getCustom()}}),this.#i=null}async#k(){this.#i=null;let e=this.#g;this.#s&&await this.#s.declineChallenge(e.challengerId,e.ruleType,e.challengerName),this.dispatch({type:"CHALLENGE_DISMISS",payload:e.challengerId})}#A(){this.#i=null;let e=this.#n;e&&this.dispatch({type:"CHALLENGE_DISMISS",payload:e.challengeeId})}#P(){let e=[...this.#l].filter(t=>t.meta?.country!=="BOT").map(t=>{let{meta:s={},...i}=t,{ts:n,since:o,...l}=s;return{...i,meta:l}});console.log("=== USERS ==="),console.log(JSON.stringify(e,null,2)),console.log("=== MY INFO ==="),console.log(JSON.stringify({myId:this.#t,myName:this.#r})),console.log("=== NCHAN RECORDED MESSAGES ==="),console.log(this.#c.recordedMessages),console.log("=== SLOTS ==="),console.table(this.#v.map(t=>({userId:t.userId,status:t.status,offlineSince:t.offlineSince,online:t.status==="online"?"\u2713":"\u2717"})))}_openActiveTables=()=>{let t=ge(this.#p||[]).map(s=>s.tableId).map(s=>"active="+encodeURIComponent(s)).join("&");window.open(Mt+(t?"?"+t:""),"_blank","noopener")};render(){if(this.#u){let t=De({tableId:this.#u,userId:this.#t,userName:this.#r,ruleType:this.#S,isFirst:this.#_,options:this.#I,lod:m.lod,flip:m.flip,custom:m.getCustom(),opponent:this.#y?{userId:this.#y,userName:this.#E,custom:this.#C}:void 0});return this.#i=null,this.#e={...this.#e,currentMatch:null},window.location.href=t,c``}let e=this.#o;return c`
            <div class="panel-header">
                ...
                <span class="panel-title" @click=${()=>this.#P()}>Play Online (${this.#l.filter(t=>t.userId!==this.#t).length})</span>
            </div>
            <challenge-banner
                .challenge=${this.#g}
                .sent=${this.#n}
            ...
            <challenge-modal
                ...
                .userName=${e?.userName??""}
                @confirm=${t=>{let s={...t.detail.options};s.handicap&&(s["handicap_"+this.#t]=s.handicap,delete s.handicap),this.#x(e.userId,t.detail.ruleType,s),this.#o=null}}
            ...
            </div>`}};customElements.define("user-badge",et);var ys=`https://${K}/api/stats`,tt=class extends f{static styles=b`
    ...
    `;connectedCallback(){super.connectedCallback(),fetch(ys,{mode:"cors"}).then(e=>e.json()).then(e=>{this._data=e,this.requestUpdate()}).catch(()=>{this._err=!0,this.requestUpdate()})}_formatUptime(e){if(!e)return"";let t=[];return e.days&&t.push(`${e.days}d`),e.hours&&t.push(`${e.hours}h`),e.mins!==void 0&&t.push(`${e.mins}m`),t.join(" ")}_countryCounts(e){let t={};for(let s of Object.values(e)){let i=s.split("|")[0]||"XX";t[i]=(t[i]??0)+1}return Object.entries(t).sort((s,i)=>i[1]-s[1])}render(){if(this._err)return c`<span class="loading">Could not load stats.</span>`;if(!this._data)return c`<span class="loading">Loading…</span>`;let{uptime:e,ip_cache:t}=this._data,s=this._countryCounts(t??{});return c`
            ...
            <ul>
                ${s.map(([i,n])=>c`
                    <li>${I(i).emoji} <span>${i}</span> <span class="count">${n}</span></li>
                `)}
            </ul>`}};customElements.define("stats-panel",tt);var st=class r extends S{static properties={};static CUSTOMISATIONS=[{key:"cue",label:"Cue",type:"toggle"}];static styles=[x,k,b`
    ...
    `];constructor(){super(),this._onKeydown=this._onKeydown.bind(this)}connectedCallback(){super.connectedCallback(),window.addEventListener("keydown",this._onKeydown)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this._onKeydown)}_onKeydown(e){e.key==="Escape"&&(e.stopPropagation(),this._close())}_close(){this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}render(){let e=m.getCustom();return c`
            <div class="backdrop" @click=${t=>t.target===t.currentTarget&&this._close()}>
                <div class="modal" role="dialog" aria-modal="true" aria-label="Customisation">
                    <h3>Customisation</h3>
                    <div class="section-title">Settings</div>

                    ${r.CUSTOMISATIONS.map(t=>{if(t.type==="toggle"){let s=e[t.key]??"0";return c`
                                <div class="row">
                                    <span>${t.label}</span>
                                    <label class="switch">
                                        <input type="checkbox" .checked=${s==="1"} @change=${i=>m.setCustom(t.key,i.target.checked?"1":"0")}>
        ...
        `}};customElements.define("customisation-panel",st);var it=class r extends S{static properties={_open:{state:!0},_notifEnabled:{state:!0},_showStats:{state:!0},_copied:{state:!0},_showCustomisation:{state:!0}};static LOD_LABELS=["pixelated","polygons","high poly","shaders","antialiased"];static styles=[x,k,b`
        .modal { padding: 0.7rem 1rem; gap: 0.3rem; }
        h3 { margin: 0 0 0.1rem; font-size: 0.9rem; }
    ...
    `];constructor(){super(),this._open=!1,this._showStats=!1,this._copied=!1,this._showCustomisation=!1,this._theme=document.documentElement.getAttribute("theme")||"light",this._notifEnabled=Notification.permission==="granted",this._onKeydown=this._onKeydown.bind(this)}connectedCallback(){super.connectedCallback(),window.addEventListener("keydown",this._onKeydown)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this._onKeydown)}_onKeydown(e){this._open&&e.key==="Escape"&&this._close()}_toggle(e){e.stopPropagation(),this._open=!this._open}_close(){this._open=!1,this._showCustomisation=!1}_setTheme(e){let t=e.target.checked?"dark":"light";this._theme=t,document.documentElement.setAttribute("theme",t),localStorage.setItem("theme",t),this.dispatchEvent(new CustomEvent("theme-changed",{detail:t,bubbles:!0,composed:!0}))}_share(){navigator.share&&/Android|iPhone|iPad|iPod/i.test(navigator.userAgent)?navigator.share({title:document.title,url:location.href}):navigator.clipboard.writeText(location.href).then(()=>{this._copied=!0,setTimeout(()=>{this._copied=!1},2e3)})}async _toggleNotifications(e){if(e.target.checked){let t=await Notification.requestPermission();this._notifEnabled=t==="granted"}else this._notifEnabled=!1;this.requestUpdate()}render(){return c`
            ...
            ${this._open?c`
                <div class="backdrop" @click=${e=>e.target===e.currentTarget&&this._close()}>
                    <div class="modal" role="dialog" aria-modal="true" aria-label="Settings">
                        ...
                        <div class="row">
                            <span>Customise</span>
                            <button @click=${()=>this._showCustomisation=!0} style="margin-left: auto;">Open</button>
                        </div>
                        <div class="row">
    ...
    `;constructor(){super(),this.msg=Zt[Math.floor(Math.random()*Zt.length)]}render(){return c`${Xt(this.msg)}`}};customElements.define("motd-panel",rt);var nt=class extends f{static properties={_theme:{type:String,reflect:!0,attribute:"theme"},_sidebarOpen:{type:Boolean}};static styles=Lt;constructor(){super(),console.log("URL:",window.location.href),console.log("Search params:",Object.fromEntries(new URLSearchParams(window.location.search))),this._theme=document.documentElement.getAttribute("theme")||"light",this._sidebarOpen=!1,this.addEventListener("user-list-toggle",e=>{this._sidebarOpen=e.detail.expanded})}get _ctrl(){return this.shadowRoot.querySelector("online-panel")}render(){return c`
            <div class="container">
                <header class="topbar">
