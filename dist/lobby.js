                ...
                <div class="group recent">
                    <div class="group-body">
                        ...
                        <tr><th>Rule</th><th>Match</th><th>Ago</th><th class="city-col">City</th><th></th></tr>
                            ${s.map(r=>o`<tr>
                                <td>${P(r.ruleType)}</td><td>${r.arenaId?"\u2694\uFE0F":""}${r.loser?r.tableSize!=null&&r.tableSize<10?"\u{1F37C}":"\u{1F396}\uFE0F":""}${r.freeaim===!0?"\u2316":""}${r.beserk===!0||r.beserk==="true"?"\u{1F680}":""}${r.winner}${r.winnerScore!=null?o`<span class="score">(${r.winnerScore})</span>`:""}${r.loser?o` vs ${r.loser}${r.loserScore!=null?o`<span class="score">(${r.loserScore})</span>`:""}`:""}</td>
