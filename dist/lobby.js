"use strict";(()=>{var G=globalThis,q=G.ShadowRoot&&(G.ShadyCSS===void 0||G.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,se=Symbol(),Pe=new WeakMap,U=class{constructor(e,t,s){if(this._$cssResult$=!0,s!==se)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o,t=this.t;if(q&&e===void 0){let s=t!==void 0&&t.length===1;s&&(e=Pe.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),s&&Pe.set(t,e))}return e}toString(){return this.cssText}},Me=r=>new U(typeof r=="string"?r:r+"",void 0,se),p=(r,...e)=>{let t=r.length===1?r[0]:e.reduce((s,i,n)=>s+(a=>{if(a._$cssResult$===!0)return a.cssText;if(typeof a=="number")return a;throw Error("Value passed to 'css' function must be a 'css' function result: "+a+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+r[n+1],r[0]);return new U(t,r,se)},ke=(r,e)=>{if(q)r.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(let t of e){let s=document.createElement("style"),i=G.litNonce;i!==void 0&&s.setAttribute("nonce",i),s.textContent=t.cssText,r.appendChild(s)}},ie=q?r=>r:r=>r instanceof CSSStyleSheet?(e=>{let t="";for(let s of e.cssRules)t+=s.cssText;return Me(t)})(r):r;var{is:bt,defineProperty:ft,getOwnPropertyDescriptor:yt,getOwnPropertyNames:vt,getOwnPropertySymbols:$t,getPrototypeOf:xt}=Object,F=globalThis,Ne=F.trustedTypes,_t=Ne?Ne.emptyScript:"",wt=F.reactiveElementPolyfillSupport,R=(r,e)=>r,re={toAttribute(r,e){switch(e){case Boolean:r=r?_t:null;break;case Object:case Array:r=r==null?r:JSON.stringify(r)}return r},fromAttribute(r,e){let t=r;switch(e){case Boolean:t=r!==null;break;case Number:t=r===null?null:Number(r);break;case Object:case Array:try{t=JSON.parse(r)}catch{t=null}}return t}},Re=(r,e)=>!bt(r,e),Ue={attribute:!0,type:String,converter:re,reflect:!1,useDefault:!1,hasChanged:Re};Symbol.metadata??=Symbol("metadata"),F.litPropertyMetadata??=new WeakMap;var x=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??=[]).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,t=Ue){if(t.state&&(t.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((t=Object.create(t)).wrapped=!0),this.elementProperties.set(e,t),!t.noAccessor){let s=Symbol(),i=this.getPropertyDescriptor(e,s,t);i!==void 0&&ft(this.prototype,e,i)}}static getPropertyDescriptor(e,t,s){let{get:i,set:n}=yt(this.prototype,e)??{get(){return this[t]},set(a){this[t]=a}};return{get:i,set(a){let c=i?.call(this);n?.call(this,a),this.requestUpdate(e,c,s)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??Ue}static _$Ei(){if(this.hasOwnProperty(R("elementProperties")))return;let e=xt(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(R("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(R("properties"))){let t=this.properties,s=[...vt(t),...$t(t)];for(let i of s)this.createProperty(i,t[i])}let e=this[Symbol.metadata];if(e!==null){let t=litPropertyMetadata.get(e);if(t!==void 0)for(let[s,i]of t)this.elementProperties.set(s,i)}this._$Eh=new Map;for(let[t,s]of this.elementProperties){let i=this._$Eu(t,s);i!==void 0&&this._$Eh.set(i,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){let t=[];if(Array.isArray(e)){let s=new Set(e.flat(1/0).reverse());for(let i of s)t.unshift(ie(i))}else e!==void 0&&t.push(ie(e));return t}static _$Eu(e,t){let s=t.attribute;return s===!1?void 0:typeof s=="string"?s:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(e=>this.enableUpdating=e),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(e=>e(this))}addController(e){(this._$EO??=new Set).add(e),this.renderRoot!==void 0&&this.isConnected&&e.hostConnected?.()}removeController(e){this._$EO?.delete(e)}_$E_(){let e=new Map,t=this.constructor.elementProperties;for(let s of t.keys())this.hasOwnProperty(s)&&(e.set(s,this[s]),delete this[s]);e.size>0&&(this._$Ep=e)}createRenderRoot(){let e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return ke(e,this.constructor.elementStyles),e}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(e=>e.hostConnected?.())}enableUpdating(e){}disconnectedCallback(){this._$EO?.forEach(e=>e.hostDisconnected?.())}attributeChangedCallback(e,t,s){this._$AK(e,s)}_$ET(e,t){let s=this.constructor.elementProperties.get(e),i=this.constructor._$Eu(e,s);if(i!==void 0&&s.reflect===!0){let n=(s.converter?.toAttribute!==void 0?s.converter:re).toAttribute(t,s.type);this._$Em=e,n==null?this.removeAttribute(i):this.setAttribute(i,n),this._$Em=null}}_$AK(e,t){let s=this.constructor,i=s._$Eh.get(e);if(i!==void 0&&this._$Em!==i){let n=s.getPropertyOptions(i),a=typeof n.converter=="function"?{fromAttribute:n.converter}:n.converter?.fromAttribute!==void 0?n.converter:re;this._$Em=i;let c=a.fromAttribute(t,n.type);this[i]=c??this._$Ej?.get(i)??c,this._$Em=null}}requestUpdate(e,t,s,i=!1,n){if(e!==void 0){let a=this.constructor;if(i===!1&&(n=this[e]),s??=a.getPropertyOptions(e),!((s.hasChanged??Re)(n,t)||s.useDefault&&s.reflect&&n===this._$Ej?.get(e)&&!this.hasAttribute(a._$Eu(e,s))))return;this.C(e,t,s)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(e,t,{useDefault:s,reflect:i,wrapped:n},a){s&&!(this._$Ej??=new Map).has(e)&&(this._$Ej.set(e,a??t??this[e]),n!==!0||a!==void 0)||(this._$AL.has(e)||(this.hasUpdated||s||(t=void 0),this._$AL.set(e,t)),i===!0&&this._$Em!==e&&(this._$Eq??=new Set).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}let e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[i,n]of this._$Ep)this[i]=n;this._$Ep=void 0}let s=this.constructor.elementProperties;if(s.size>0)for(let[i,n]of s){let{wrapped:a}=n,c=this[i];a!==!0||this._$AL.has(i)||c===void 0||this.C(i,void 0,n,c)}}let e=!1,t=this._$AL;try{e=this.shouldUpdate(t),e?(this.willUpdate(t),this._$EO?.forEach(s=>s.hostUpdate?.()),this.update(t)):this._$EM()}catch(s){throw e=!1,this._$EM(),s}e&&this._$AE(t)}willUpdate(e){}_$AE(e){this._$EO?.forEach(t=>t.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&=this._$Eq.forEach(t=>this._$ET(t,this[t])),this._$EM()}updated(e){}firstUpdated(e){}};x.elementStyles=[],x.shadowRootOptions={mode:"open"},x[R("elementProperties")]=new Map,x[R("finalized")]=new Map,wt?.({ReactiveElement:x}),(F.reactiveElementVersions??=[]).push("2.1.2");var de=globalThis,Oe=r=>r,W=de.trustedTypes,He=W?W.createPolicy("lit-html",{createHTML:r=>r}):void 0,Ge="$lit$",S=`lit$${Math.random().toFixed(9).slice(2)}$`,qe="?"+S,St=`<${qe}>`,C=document,H=()=>C.createComment(""),j=r=>r===null||typeof r!="object"&&typeof r!="function",pe=Array.isArray,Et=r=>pe(r)||typeof r?.[Symbol.iterator]=="function",ne=`[ 	
\f\r]`,O=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,je=/-->/g,Be=/>/g,E=RegExp(`>|${ne}(?:([^\\s"'>=/]+)(${ne}*=${ne}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),De=/'/g,ze=/"/g,Fe=/^(?:script|style|textarea|title)$/i,ue=r=>(e,...t)=>({_$litType$:r,strings:e,values:t}),o=ue(1),Bt=ue(2),Dt=ue(3),_=Symbol.for("lit-noChange"),m=Symbol.for("lit-nothing"),Ye=new WeakMap,I=C.createTreeWalker(C,129);function We(r,e){if(!pe(r)||!r.hasOwnProperty("raw"))throw Error("invalid template strings array");return He!==void 0?He.createHTML(e):e}var It=(r,e)=>{let t=r.length-1,s=[],i,n=e===2?"<svg>":e===3?"<math>":"",a=O;for(let c=0;c<t;c++){let l=r[c],h,u,d=-1,y=0;for(;y<l.length&&(a.lastIndex=y,u=a.exec(l),u!==null);)y=a.lastIndex,a===O?u[1]==="!--"?a=je:u[1]!==void 0?a=Be:u[2]!==void 0?(Fe.test(u[2])&&(i=RegExp("</"+u[2],"g")),a=E):u[3]!==void 0&&(a=E):a===E?u[0]===">"?(a=i??O,d=-1):u[1]===void 0?d=-2:(d=a.lastIndex-u[2].length,h=u[1],a=u[3]===void 0?E:u[3]==='"'?ze:De):a===ze||a===De?a=E:a===je||a===Be?a=O:(a=E,i=void 0);let f=a===E&&r[c+1].startsWith("/>")?" ":"";n+=a===O?l+St:d>=0?(s.push(h),l.slice(0,d)+Ge+l.slice(d)+S+f):l+S+(d===-2?c:f)}return[We(r,n+(r[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),s]},B=class r{constructor({strings:e,_$litType$:t},s){let i;this.parts=[];let n=0,a=0,c=e.length-1,l=this.parts,[h,u]=It(e,t);if(this.el=r.createElement(h,s),I.currentNode=this.el.content,t===2||t===3){let d=this.el.content.firstChild;d.replaceWith(...d.childNodes)}for(;(i=I.nextNode())!==null&&l.length<c;){if(i.nodeType===1){if(i.hasAttributes())for(let d of i.getAttributeNames())if(d.endsWith(Ge)){let y=u[a++],f=i.getAttribute(d).split(S),Y=/([.?@])?(.*)/.exec(y);l.push({type:1,index:n,name:Y[2],strings:f,ctor:Y[1]==="."?oe:Y[1]==="?"?le:Y[1]==="@"?ce:P}),i.removeAttribute(d)}else d.startsWith(S)&&(l.push({type:6,index:n}),i.removeAttribute(d));if(Fe.test(i.tagName)){let d=i.textContent.split(S),y=d.length-1;if(y>0){i.textContent=W?W.emptyScript:"";for(let f=0;f<y;f++)i.append(d[f],H()),I.nextNode(),l.push({type:2,index:++n});i.append(d[y],H())}}}else if(i.nodeType===8)if(i.data===qe)l.push({type:2,index:n});else{let d=-1;for(;(d=i.data.indexOf(S,d+1))!==-1;)l.push({type:7,index:n}),d+=S.length-1}n++}}static createElement(e,t){let s=C.createElement("template");return s.innerHTML=e,s}};function L(r,e,t=r,s){if(e===_)return e;let i=s!==void 0?t._$Co?.[s]:t._$Cl,n=j(e)?void 0:e._$litDirective$;return i?.constructor!==n&&(i?._$AO?.(!1),n===void 0?i=void 0:(i=new n(r),i._$AT(r,t,s)),s!==void 0?(t._$Co??=[])[s]=i:t._$Cl=i),i!==void 0&&(e=L(r,i._$AS(r,e.values),i,s)),e}var ae=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:s}=this._$AD,i=(e?.creationScope??C).importNode(t,!0);I.currentNode=i;let n=I.nextNode(),a=0,c=0,l=s[0];for(;l!==void 0;){if(a===l.index){let h;l.type===2?h=new D(n,n.nextSibling,this,e):l.type===1?h=new l.ctor(n,l.name,l.strings,this,e):l.type===6&&(h=new he(n,this,e)),this._$AV.push(h),l=s[++c]}a!==l?.index&&(n=I.nextNode(),a++)}return I.currentNode=C,i}p(e){let t=0;for(let s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(e,s,t),t+=s.strings.length-2):s._$AI(e[t])),t++}},D=class r{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,s,i){this.type=2,this._$AH=m,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=s,this.options=i,this._$Cv=i?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=L(this,e,t),j(e)?e===m||e==null||e===""?(this._$AH!==m&&this._$AR(),this._$AH=m):e!==this._$AH&&e!==_&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):Et(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==m&&j(this._$AH)?this._$AA.nextSibling.data=e:this.T(C.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:s}=e,i=typeof s=="number"?this._$AC(e):(s.el===void 0&&(s.el=B.createElement(We(s.h,s.h[0]),this.options)),s);if(this._$AH?._$AD===i)this._$AH.p(t);else{let n=new ae(i,this),a=n.u(this.options);n.p(t),this.T(a),this._$AH=n}}_$AC(e){let t=Ye.get(e.strings);return t===void 0&&Ye.set(e.strings,t=new B(e)),t}k(e){pe(this._$AH)||(this._$AH=[],this._$AR());let t=this._$AH,s,i=0;for(let n of e)i===t.length?t.push(s=new r(this.O(H()),this.O(H()),this,this.options)):s=t[i],s._$AI(n),i++;i<t.length&&(this._$AR(s&&s._$AB.nextSibling,i),t.length=i)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){let s=Oe(e).nextSibling;Oe(e).remove(),e=s}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},P=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,s,i,n){this.type=1,this._$AH=m,this._$AN=void 0,this.element=e,this.name=t,this._$AM=i,this.options=n,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=m}_$AI(e,t=this,s,i){let n=this.strings,a=!1;if(n===void 0)e=L(this,e,t,0),a=!j(e)||e!==this._$AH&&e!==_,a&&(this._$AH=e);else{let c=e,l,h;for(e=n[0],l=0;l<n.length-1;l++)h=L(this,c[s+l],t,l),h===_&&(h=this._$AH[l]),a||=!j(h)||h!==this._$AH[l],h===m?e=m:e!==m&&(e+=(h??"")+n[l+1]),this._$AH[l]=h}a&&!i&&this.j(e)}j(e){e===m?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},oe=class extends P{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===m?void 0:e}},le=class extends P{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==m)}},ce=class extends P{constructor(e,t,s,i,n){super(e,t,s,i,n),this.type=5}_$AI(e,t=this){if((e=L(this,e,t,0)??m)===_)return;let s=this._$AH,i=e===m&&s!==m||e.capture!==s.capture||e.once!==s.once||e.passive!==s.passive,n=e!==m&&(s===m||i);i&&this.element.removeEventListener(this.name,this,s),n&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},he=class{constructor(e,t,s){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(e){L(this,e)}};var Ct=de.litHtmlPolyfillSupport;Ct?.(B,D),(de.litHtmlVersions??=[]).push("3.3.2");var Je=(r,e,t)=>{let s=t?.renderBefore??e,i=s._$litPart$;if(i===void 0){let n=t?.renderBefore??null;s._$litPart$=i=new D(e.insertBefore(H(),n),n,void 0,t??{})}return i._$AI(r),i};var ge=globalThis,g=class extends x{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Je(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return _}};g._$litElement$=!0,g.finalized=!0,ge.litElementHydrateSupport?.({LitElement:g});var Tt=ge.litElementPolyfillSupport;Tt?.({LitElement:g});(ge.litElementVersions??=[]).push("4.2.2");var At=p`
...
`];var me=class extends EventTarget{clientId=localStorage.getItem("userId")||"";userName=localStorage.getItem("userName")||"Anonymous";lod=localStorage.getItem("lod")||"1";set(e,t){this.clientId=e,this.userName=t,localStorage.setItem("userId",e),localStorage.setItem("userName",t),this.dispatchEvent(new Event("change"))}setLod(e){this.lod=e,localStorage.setItem("lod",e),this.dispatchEvent(new Event("change"))}},b=new me,$=class extends g{connectedCallback(){super.connectedCallback(),this._storeListener=()=>this.requestUpdate(),b.addEventListener("change",this._storeListener)}disconnectedCallback(){super.disconnectedCallback(),b.removeEventListener("change",this._storeListener)}};var T="https://scoreboard-tailuge.vercel.app",it=r=>{let e=Math.floor((Date.now()-r)/1e3);if(e<60)return`${e}s ago`;let t=Math.floor(e/60);if(t<60)return`${t}m ago`;let s=Math.floor(t/60);return s<24?`${s}h ago`:`${Math.floor(s/24)}d ago`},rt={connected:!1,users:[],challenges:{},currentMatch:null};function nt(r,e){let t={...r.challenges},s=i=>i.challengerId===e.myId?i.challengeeId:i.challengerId;switch(e.type){case"CONNECTED":return{...r,connected:e.payload};case"USERS_UPDATE":return{...r,users:e.payload};case"CHALLENGE_SENT":return{...r,challenges:{...t,[e.payload.challengeeId]:{...e.payload,status:"pending"}}};case"CHALLENGE_MSG":{let i=e.payload,n=s(i);if(i.type==="offer")(!t[i.challengerId]||t[i.challengerId].tableId!==i.tableId)&&(t[i.challengerId]={...i,status:"pending"});else if(i.type==="accept"&&!r.currentMatch){let a=t[n],c=i.options||(a?.tableId===i.tableId?a.options:void 0);return delete t[n],{...r,challenges:t,currentMatch:{tableId:i.tableId,ruleType:i.ruleType,options:c,isFirst:i.challengerId===e.myId}}}else i.type==="decline"?t[i.challengeeId]&&(t[i.challengeeId]={...t[i.challengeeId],status:"declined"}):i.type==="cancel"&&delete t[s(i)];return{...r,challenges:t}}case"CHALLENGE_DISMISS":return delete t[e.payload],{...r,challenges:t};case"MATCH_SET":return{...r,currentMatch:e.payload};case"MATCH_LEAVE":return{...r,currentMatch:null};default:return r}}function at(r="",e=""){return r.includes("github")?{emoji:"\u{1F419}",title:"github"}:r.includes("vercel")?{emoji:"\u{1F465}",title:"vercel"}:r.includes("render")?{emoji:"\u{1F464}",title:"vercel"}:r.includes("localhost")?{emoji:"\u{1F3E0}",title:"localhost"}:{spectator:{emoji:"\u{1F52D}",title:"spectator"},replay:{emoji:"\u{1F440}",title:"replay"},bot:{emoji:"\u{1F916}",title:"bot"},nineball:{emoji:"\u2468",title:"nineball"},eightball:{emoji:"\u{1F3B1}",title:"eightball"},snooker:{emoji:"\u{1F534}",title:"snooker"},threecushion:{emoji:"\u2462",title:"threecushion"}}[e]??{emoji:"\u{1F3AE}",title:"external"}}var z=r=>r==="BOT"?"\u{1F916}":r?[...r.toUpperCase()].map(e=>String.fromCodePoint(127397+e.charCodeAt(0))).join(""):"\u{1F310}",be="https://billiards.tailuge.workers.dev/",ot=(r,e)=>e?Object.entries(e).reduce((t,[s,i])=>t+`&${encodeURIComponent(s)}=${encodeURIComponent(i)}`,r):r,lt=(r,e,t,s)=>r.url?`${r.url}?userId=${encodeURIComponent(e)}&userName=${encodeURIComponent(t)}&lod=${s}`:ot(`${be}?ruletype=${r.ruletype}&userId=${encodeURIComponent(e)}&userName=${encodeURIComponent(t)}&lod=${s}`,r.options),fe=({tableId:r,userId:e,userName:t,ruleType:s,isFirst:i,options:n,bot:a,lod:c,rematch:l})=>{let h=`${be}?websocketserver=wss://billiards.onrender.com/ws&tableId=${r}&userName=${encodeURIComponent(t)}&userId=${e}&ruletype=${s}`;return i&&(h+="&first=true"),a&&(h+=`&bot=${encodeURIComponent(a)}`),c!==void 0&&(h+=`&lod=${c}`),l&&(h+=`&rematch=${l}`),ot(h,n)},ct=({tableId:r,userId:e,userName:t,ruleType:s})=>`${be}?websocketserver=wss://billiards.onrender.com/ws&tableId=${r}&userName=${encodeURIComponent(t)}&userId=${e}&ruletype=${s}&spectator=true`,Lt={eightball:"eightball",snooker:"snooker",threecushion:"threecushion",nineball:"nineball"},A=r=>{let e=Lt[r];return e?o`<img src="assets/${e}.png" alt="${r}" title="${r}" width="18" height="18" style="vertical-align:middle">`:o`🎱`},ye=r=>["\u{1F3C6}","\u{1F948}","\u{1F949}","\u{1F396}\uFE0F"][r]??"";var Pt=[{label:"Nine Ball",img:"assets/nineball.png",ruletype:"nineball"},{label:"Snooker 6r",img:"assets/snooker.png",ruletype:"snooker",options:{reds:"6"}},{label:"Snooker",img:"assets/snooker.png",ruletype:"snooker",options:{reds:"15"}},{label:"3-Cushion (3)",img:"assets/threecushion.png",ruletype:"threecushion",options:{raceTo:"3"}},{label:"3-Cushion (7)",img:"assets/threecushion.png",ruletype:"threecushion",options:{raceTo:"7"}},{label:"3-Cushion (15)",img:"assets/threecushion.png",ruletype:"threecushion",options:{raceTo:"15"}},{label:"Trickshot",img:"assets/practice.png",url:"https://billiards.tailuge.workers.dev/practice"},{label:"Research",img:"assets/research.png",url:"https://billiards.tailuge.workers.dev/diagrams/three"},{label:"Eight Ball",img:"assets/eightball.png",ruletype:"eightball"}],ve=class extends ${static styles=[Xe,J];#t=[...Pt].sort(()=>Math.random()-.5);render(){let{clientId:e,userName:t}=b;return o`<div class="grid">${this.#t.map(s=>o`
            <button title=${s.label} aria-label="Play ${s.label}"
                @click=${()=>{window.location.href=lt(s,e,t,b.lod)}}>
                <span class="icon-wrap">
                    <img src=${s.img} alt=${s.label} />
                    ${s.options?o`<span class="badge">${Object.values(s.options)[0]}</span>`:""}
                </span>
            </button>`)}
        </div>`}};customElements.define("solo-panel",ve);var ht={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},dt=r=>(...e)=>({_$litDirective$:r,values:e}),V=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,s){this._$Ct=e,this._$AM=t,this._$Ci=s}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}};var pt="important",Mt=" !"+pt,gs=dt(class extends V{constructor(r){if(super(r),r.type!==ht.ATTRIBUTE||r.name!=="style"||r.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(r){return Object.keys(r).reduce((e,t)=>{let s=r[t];return s==null?e:e+`${t=t.includes("-")?t:t.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${s};`},"")}update(r,[e]){let{style:t}=r.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(e)),this.render(e);for(let s of this.ft)e[s]==null&&(this.ft.delete(s),s.includes("-")?t.removeProperty(s):t[s]=null);for(let s in e){let i=e[s];if(i!=null){this.ft.add(s);let n=typeof i=="string"&&i.endsWith(Mt);s.includes("-")||n?t.setProperty(s,n?i.slice(0,-11):i,n?pt:""):t[s]=i}}return _}});var $e=class extends g{static properties={url:{type:String},color:{type:String},label:{type:String},prefix:{type:String}};static styles=p`
        :host {
    ...
    `;render(){let e=this.color?`background-color: ${this.color}`:"";return o`
        ...
        `}};customElements.define("replay-button",$e);var xe=class extends ${static styles=et;connectedCallback(){super.connectedCallback(),fetch(`${T}/api/summary`,{mode:"cors"}).then(e=>e.json()).then(e=>{this._data=e,this.requestUpdate()}).catch(()=>{this._err=!0,this.requestUpdate()})}render(){if(this._err)return o`<span class="loading">Could not load scores.</span>`;if(!this._data)return o`<span class="loading">Loading…</span>`;let{hiscores:e,topPlayers:t,recentMatches:s}=this._data,i=Object.keys(e);return o`
            <div class="group hiscores">
                <div class="group-body">
                    ${i.map(n=>o`
                        <div class="tbl"><table><caption>${A(n)} <a href="${T}/leaderboard" target="_blank" rel="noopener" style="font-weight:200;font-size:0.75rem">Score</a></caption>
                        <tr><th>Name</th><th></th></tr>
                            ${e[n].slice(0,4).map((a,c)=>o`<tr><td>${ye(c)} ${a.name}</td><td><replay-button url="${T}/api/rank/${a.id}?ruletype=${n}&lod=${b.lod}" label="${a.score}"></replay-button></td></tr>`)}
                        </table></div>
                    `)}
                </div>
            </div>
            <div class="bottom-row">
                    ...
                    <div class="group-body">
                        ...
                        <tr><th>Rule</th><th>Match</th><th>Ago</th><th class="city-col">City</th><th></th></tr>
                            ${s.map(n=>o`<tr>
                                ...
                                <td class="replay-col">
                                    ${n.hasReplay?o`<replay-button prefix="${z(n.locationCountry)}" url="${T}/api/match-replay?id=${n.id}&lod=${b.lod}"></replay-button>`:z(n.locationCountry)}
                                </td>
                            </tr>`)}
                        </table></div>
                    </div>
                ...
                <div class="group top-players">
                    <div class="group-body">
                        ${i.map(n=>o`
                            <div class="tbl"><table><caption><a href="${T}/elo" target="_blank" rel="noopener">${A(n)} <span style="font-size:0.75rem;font-weight:200">Best</span></a></caption>
                            <tr><th>Name</th><th>Rating</th><th>W</th><th>L</th></tr>
                                ${[...t[n]].sort((a,c)=>c.rating-a.rating).slice(0,4).map((a,c)=>o`<tr>
                                    <td><a href="${T}/player/${encodeURIComponent(a.name)}?ruleType=${n}">${ye(c)} ${a.name}</a></td>
    ...
    `];constructor(){super(),this._messages=new Map,this._unread=new Map,this._lobbyBound=!1}willUpdate(e){e.has("lobby")&&this.lobby&&!this._lobbyBound&&(this._lobbyBound=!0,this.lobby.onChat(t=>{let s=t.senderId,i=[...this._messages.get(s)??[],t];if(this._messages=new Map(this._messages).set(s,i),s!==this.targetId){let n=(this._unread.get(s)??0)+1;this._unread=new Map(this._unread).set(s,n),te(this,"unread-changed",{userId:s,count:n})}this.requestUpdate()})),e.has("targetId")&&this.targetId&&this._unread.has(this.targetId)&&(this._unread=new Map(this._unread).set(this.targetId,0),te(this,"unread-changed",{userId:this.targetId,count:0}))}_send(e){e.preventDefault();let t=this.shadowRoot.querySelector("input"),s=t.value.trim();if(!s||!this.lobby||!this.targetId)return;this.lobby.sendChat(this.targetId,s);let n={messageType:"chat",senderId:this.lobby.currentUser.userId,recipientId:this.targetId,text:s},a=[...this._messages.get(this.targetId)??[],n];this._messages=new Map(this._messages).set(this.targetId,a),t.value="",this.requestUpdate()}render(){if(!this.targetId)return o``;let e=this.lobby?.currentUser?.userId,t=this._messages.get(this.targetId)??[];return o`
            ...
            </div>`}};customElements.define("message-modal",_e);var kt=[{userId:"bot-clawbreak",userName:"ClawBreak",isBot:!0,meta:{country:"BOT"}},{userId:"bot-thefarjaw",userName:"TheFarJaw",isBot:!0,meta:{country:"BOT"}}],v=(r,e,t)=>r.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0})),we=class extends g{static properties={users:{type:Array},myId:{type:String},myName:{type:String},tableId:{type:String},isChallengePending:{type:Boolean},pendingChats:{type:Object}};static styles=[w,Ve,p`
    ...
    `];render(){let e=(this.users||[]).filter(t=>t.userId!==this.myId);return e.length===0?o`<div class="empty">No other players online yet. Invite a friend!</div>`:o`<ul aria-label="Online players">${e.map(t=>this._row(t))}</ul>`}_row(e){let t=this.pendingChats?.get(e.userId)>0,s=e.isBot||ut(e,this.myId),i=!e.isBot&&gt(e,this.tableId),n=at(e.meta?.origin??"",e.tableId??""),a=t?o`<button class="btn-chat" aria-label="Unread message from ${e.userName}" @click=${()=>v(this,"open-chat",e.userId)}>💬</button>`:i?o`<button class="btn-spectate" aria-label="Spectate ${e.userName}'s game" @click=${()=>v(this,"spectate",e)}>Spectate</button>`:s?o`<button class="btn-challenge" aria-label="Challenge ${e.userName}" ?disabled=${this.isChallengePending} @click=${()=>v(this,"challenge",e.userId)}>Challenge</button>`:o``;return o`
            <li aria-label="${e.userName}">
                <div class="user-info">
                    <span class="user-name">${z(e.meta?.country)} ${e.userName} <span aria-label="${n.title}" role="img">${n.emoji}</span></span>
                </div>
                <div class="actions">${a}</div>
            </li>`}},Se=class extends g{static properties={challenge:{type:Object},sent:{type:Object}};static styles=[w,Ke,Ze];render(){return this.challenge?this._incoming(this.challenge):this.sent?this._sent(this.sent):o``}_incoming(e){let t=Object.entries(e.options??{}).map(([s,i])=>`${s}: ${i}`);return o`
            <div class="banner">
                <strong>Challenge from ${e.challengerName}</strong>
                <div class="details"><span>${A(e.ruleType)} ${e.ruleType}</span>${t.map(s=>o`<span>${s}</span>`)}</div>
                <div class="row">
                    <button class="btn-accept" aria-label="Accept challenge" @click=${()=>v(this,"accept")}>Accept</button>
                    <button class="btn-decline" aria-label="Decline challenge" @click=${()=>v(this,"decline")}>Decline</button>
                </div>
            ...
            <div class="banner ${e.status}">
                <div class="row">
                    ...
                    ${t?o`<button class="btn-leave" @click=${()=>v(this,"cancel")}>Cancel</button>`:o`<button aria-label="Dismiss" @click=${()=>v(this,"dismiss")}>✕</button>`}
                </div>
                <div class="details">${A(e.ruleType)} ${e.ruleType}</div>
            </div>`}},Ee=class r extends g{static properties={userId:{type:String},userName:{type:String}};static styles=[w,M,J];static RULES=[{id:"eightball",label:"Eight Ball",img:"assets/eightball.png"},{id:"nineball",label:"Nine Ball",img:"assets/nineball.png"},{id:"threecushion",label:"Three Cushion (3)",img:"assets/threecushion.png",options:{raceTo:"3"}},{id:"threecushion",label:"Three Cushion (7)",img:"assets/threecushion.png",options:{raceTo:"7"}},{id:"threecushion",label:"Three Cushion (15)",img:"assets/threecushion.png",options:{raceTo:"15"}},{id:"snooker",label:"Snooker (15 reds)",img:"assets/snooker.png"},{id:"snooker",label:"Snooker (6 reds)",img:"assets/snooker.png",options:{reds:"6"}}];render(){return this.userId?o`
            <div class="backdrop" @click=${e=>e.target===e.currentTarget&&v(this,"cancel")}>
                <div class="modal" role="dialog" aria-modal="true" aria-label="Select game type">
                    <h3>Challenge ${this.userName}</h3>
                    <div class="rules">
                        ${r.RULES.map(e=>o`
                            <button class="rule btn-challenge" @click=${()=>v(this,"confirm",{ruleType:e.id,options:e.options})}>
                                <span class="icon-wrap">
                    ...
                    <button @click=${()=>v(this,"message")}>💬 Send message</button>
                    <button class="cancel" @click=${()=>v(this,"cancel")}>Cancel</button>
                </div>
            </div>`:o``}},Ie=class{constructor(e){this.info=e}get opponentId(){return this.info.opponentId}get ruleType(){return this.info.ruleType}get rematchParam(){return encodeURIComponent(JSON.stringify(this.info))}async sendChallenge(e){return e.challenge(this.opponentId,this.ruleType,void 0,this.info)}shouldAutoAccept(e){return e.type==="offer"&&e.challengerId===this.opponentId}},Ce=class extends g{static styles=[w,tt];#t={...rt};#s=null;#b=null;#e;#r;#p;#u;#i=null;#n=null;#a=null;#c=new Map;constructor(){super();let e=new URLSearchParams(location.search);this.#e=e.get("userId")||localStorage.getItem("userId")||"user-"+Math.random().toString(36).slice(2,7),this.#r=e.get("userName")||localStorage.getItem("userName")||"Anonymous";let t=e.get("rematch");this.#i=t?new Ie(JSON.parse(decodeURIComponent(t))):null;let s="https://billiards-network.onrender.com";(location.hostname==="localhost"||location.hostname==="127.0.0.1")&&(s=`${location.protocol==="https:"?"https:":"http:"}//${location.host}`),this.#u=new ee({baseUrl:s})}connectedCallback(){super.connectedCallback(),this._onUserChanged=e=>{this.#e=e.detail.userId,this.#r=e.detail.userName,this.#s?this.#s.updatePresence({userId:this.#e,userName:this.#r}).catch(t=>console.error("Failed to update presence:",t)):this._connect().catch(t=>console.error("Lobby connect failed:",t))},document.addEventListener("user-name-changed",this._onUserChanged),this._connect().catch(e=>console.error("Lobby connect failed:",e))}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("user-name-changed",this._onUserChanged),this.#s?.leave()}dispatch(e){this.#t=nt(this.#t,{...e,myId:this.#e}),this.requestUpdate()}get state(){return this.#t}get#g(){return this.#t.connected}get#f(){return this.#t.users}get#h(){return this.#t.currentMatch?.tableId}get#y(){return this.#t.currentMatch?.ruleType||"standard"}get#v(){return!!this.#t.currentMatch?.isFirst}get#$(){return this.#t.currentMatch?.options}get#d(){return Object.values(this.#t.challenges).find(e=>e.challengeeId===this.#e&&e.status==="pending")}get#l(){return Object.values(this.#t.challenges).find(e=>e.challengerId===this.#e)}get#o(){return[...this.#f,...kt]}async _connect(){if(this.#p=Date.now(),this.#s=await this.#u.joinLobby({messageType:"presence",type:"join",userId:this.#e,userName:this.#r}),this.dispatch({type:"CONNECTED",payload:!0}),this.#i){let e=await this.#i.sendChallenge(this.#s);this.dispatch({type:"CHALLENGE_SENT",payload:{challengerId:this.#e,challengeeId:this.#i.opponentId,recipientName:this.#i.info.opponentName,ruleType:this.#i.ruleType,options:this.#i.info.options,tableId:e}})}this.#s.onUsersChange(e=>this.dispatch({type:"USERS_UPDATE",payload:e})),this.#s.onChallenge(e=>{if(!((e.meta?.ts?new Date(e.meta.ts).getTime():1/0)<this.#p)){if(this.#i?.shouldAutoAccept(e)){this.dispatch({type:"CHALLENGE_MSG",payload:e}),this.#m().catch(s=>console.error("Auto-accept failed:",s));return}this.dispatch({type:"CHALLENGE_MSG",payload:e}),e.type==="offer"&&e.challengeeId===this.#e&&document.hidden&&Notification.permission==="granted"&&new Notification("Challenge received!",{body:`${e.challengerName} challenged you to ${e.ruleType}`,icon:"assets/threecushion.png"})}})}async#x(e,t,s){let i=this.#o.find(a=>a.userId===e);if(i?.isBot){let a="bot-"+Math.random().toString(36).slice(2,8);window.location.href=fe({tableId:a,userId:this.#e,userName:this.#r,ruleType:t,isFirst:!0,options:s,bot:i.userName,lod:b.lod,rematch:this.#i?.rematchParam});return}let n=await this.#s.challenge(e,t,void 0,s);this.dispatch({type:"CHALLENGE_SENT",payload:{challengerId:this.#e,challengeeId:e,recipientName:i?.userName||e,ruleType:t,options:s,tableId:n}})}async#_(){let e=this.#l;e?.status==="pending"&&(await this.#s.cancelChallenge(e.challengeeId,e.ruleType),this.dispatch({type:"CHALLENGE_DISMISS",payload:e.challengeeId}))}async#m(){let e=this.#d;this.#b=await this.#s.acceptChallenge(e.challengerId,e.ruleType,e.tableId,e.options,e.challengerName);let t=this.#i?.rematchParam??(e.options?.opponentId?encodeURIComponent(JSON.stringify(e.options)):void 0);this.dispatch({type:"MATCH_SET",payload:{tableId:e.tableId,ruleType:e.ruleType,options:e.options,isFirst:!1,rematch:t}})}async#w(){let e=this.#d;await this.#s.declineChallenge(e.challengerId,e.ruleType,e.challengerName),this.dispatch({type:"CHALLENGE_DISMISS",payload:e.challengerId})}#S(){let e=this.#l;e&&this.dispatch({type:"CHALLENGE_DISMISS",payload:e.challengeeId})}render(){if(this.#h){let t=fe({tableId:this.#h,userId:this.#e,userName:this.#r,ruleType:this.#y,isFirst:this.#v,options:this.#$,lod:b.lod,rematch:this.#t.currentMatch?.rematch});return window.location.href=t,o``}let e=this.#n;return o`
            <div class="panel-header">
                <span class="dot ${this.#g?"on":""}" role="status" aria-label="${this.#g?"Connected":"Disconnected"}"></span>
                <span class="panel-title">Play Online (${this.#o.filter(t=>t.userId!==this.#e).length})</span>
            </div>
            <challenge-banner
                .challenge=${this.#d}
                .sent=${this.#l}
            ...
            <user-list
                ...
                .pendingChats=${this.#c}
                @challenge=${t=>{let s=this.#o.find(i=>i.userId===t.detail);this.#n={userId:t.detail,userName:s?.userName??t.detail},this.requestUpdate()}}
                @spectate=${t=>{let s=t.detail;window.location.href=ct({tableId:s.tableId,userId:this.#e,userName:this.#r,ruleType:s.ruleType||"nineball"})}}
                @open-chat=${t=>{let s=this.#o.find(i=>i.userId===t.detail);this.#a={userId:t.detail,userName:s?.userName??t.detail},this.requestUpdate()}}>
            </user-list>
            <challenge-modal
                .userId=${e?.userId??null}
                .userName=${e?.userName??""}
                @confirm=${t=>{this.#x(e.userId,t.detail.ruleType,t.detail.options),this.#n=null}}
                @message=${()=>{this.#a={userId:e.userId,userName:e.userName},this.#n=null,this.requestUpdate()}}
                @cancel=${()=>{this.#n=null,this.requestUpdate()}}>
            </challenge-modal>
            <message-modal
                .lobby=${this.#s}
            ...
            </message-modal>`}};customElements.define("user-list",we);customElements.define("challenge-banner",Se);customElements.define("challenge-modal",Ee);customElements.define("online-panel",Ce);var Nt=()=>"id"+Math.random().toString(16).slice(2,8);function Ut(){let r=new URLSearchParams(location.search),e=r.get("userId"),t=r.get("userName");if(e)return{clientId:e,userName:t||"Anonymous",dotColor:"#f5c518"};let s=!!localStorage.getItem("userId"),i=localStorage.getItem("userId")||(()=>{let a=Nt();return localStorage.setItem("userId",a),a})(),n=t||localStorage.getItem("userName")||"Anonymous";return{clientId:i,userName:n,dotColor:s?"#4caf50":"#888"}}var Te=class extends ${static properties={_dotColor:{state:!0}};static styles=Qe;constructor(){super();let{clientId:e,userName:t,dotColor:s}=Ut();this._clientId=e,this._dotColor=s,this._name=t}_commit(e){let t=e.trim().slice(0,12)||"Anonymous";this._name=t,b.set(this._clientId,t),this.dispatchEvent(new CustomEvent("user-name-changed",{bubbles:!0,composed:!0,detail:{userId:this._clientId,userName:t}}))}render(){return o`
            ...
            </div>`}};customElements.define("user-badge",Te);var Ae=class extends ${static properties={_open:{state:!0},_notifEnabled:{state:!0}};static styles=[w,M,p`
    ...
    `];constructor(){super(),this._open=!1,this._theme=document.documentElement.getAttribute("theme")||"light",this._notifEnabled=Notification.permission==="granted"}_toggle(e){e.stopPropagation(),this._open=!this._open}_close(){this._open=!1}_setTheme(e){let t=e.target.checked?"dark":"light";this._theme=t,document.documentElement.setAttribute("theme",t),localStorage.setItem("theme",t),this.dispatchEvent(new CustomEvent("theme-changed",{detail:t,bubbles:!0,composed:!0}))}_share(){navigator.share?navigator.share({title:document.title,url:location.href}):navigator.clipboard.writeText(location.href)}async _toggleNotifications(e){if(e.target.checked){let t=await Notification.requestPermission();this._notifEnabled=t==="granted"}else this._notifEnabled=!1;this.requestUpdate()}render(){return o`
        ...
        `}};customElements.define("lobby-app",Le);})();
