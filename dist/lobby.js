                    ...
                    ${e.map(t=>o`
                        <div class="cabinet-row" title="${t.name}: ${t.count} arena ${t.count===1?"win":"wins"}">
                            ...
                            <span class="cabinet-trophies">
                                ${Ys(t.count).map(s=>{let i=t.arenaIds[s.rank-1],n=`font-size:${s.size};z-index:${s.zIndex};filter:${s.filter};opacity:${s.opacity}`;return i?o`<a
                                            class="trophy"
                                            style="${n}"
